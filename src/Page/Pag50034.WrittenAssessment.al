page 50034 "Written Assessment"
{
    ApplicationArea = All;
    Caption = 'Written Assessment';
    PageType = List;
    SourceTable = "Job Applications";
    SourceTableView = where("Invite Written Assessment" = const(true));
    ...
    actions
    {
        area(Processing)
        {
            action(SendAssessment)
            {
                ...
                ToolTip = 'Executes the SendAssessment action.';
                trigger OnAction()
                var
