...
page 75471 "Posted Purchase Orders List"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Posted Purchase Orders List';
    CardPageID = "Posted Purchase Order Card";
    ...
    SourceTableView = where("Document Type" = const(Order), Status = Const(Released), "Purchase Invoice Created " = const(true));
    UsageCategory = Lists;
    ...
    layout
    {
        ...
        area(factboxes)
        {
            ...
            part("Attached Documents"; "Doc. Attachment List Factbox")
            {
                ...
                ObsoleteReason = 'The "Doc. Attachment List Factbox" has been replaced by "Doc. Attachment List Factbox", which supports multiple files upload.';
                ApplicationArea = All;
                Visible = false;
                Caption = 'Attachments';
            ...
            group(Action9)
            {
                ...
                action(Print)
                {
                    ...
                    begin
                        ...
                        Report.Run(Report::"Local Orders", true, true, PurchaseHeader);
