#pragma warning disable AA0005, AA0008, AA0018, AA0021,AL0432, AA0072, AA0137, AA0201, AA0204, AA0206, AA0218, AA0228, AL0254, AL0424, AS0011, AW0006 // ForNAV settings
Page 60083 "CRM Resource Card"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Resource Capacity"; Rec."Resource Capacity")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Resource Capacity field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Availability Status field.';
                }
        ...
        area(navigation)
        {
            ...
            group(ActionGroupCRM)
            {
                ...
                action(ShowLog)
                {
                    ...
                    Image = Log;
                    ToolTip = 'View integration synchronization Basic for the resource table.';
            ...
            group("Plan&ning")
            {
                ...
                action("Resource A&vailability")
                {
                    ...
                    RunPageLink = "No." = field("No."),
                                  ...
                                  "Chargeable Filter" = field("Chargeable Filter");
                    ToolTip = 'View a summary of resource capacities, the quantity of resource hours allocated to Basic on order, the quantity allocated to service orders, the capacity assigned to Basic on quote, and the resource availability.';
                }
            }
            group(Service)
            {
