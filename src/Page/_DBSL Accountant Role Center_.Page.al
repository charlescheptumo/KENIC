#pragma warning disable AA0005,AL0603, AA0008, AA0018, AA0021, AA0072, AA0137,AL0432, AA0201, AA0206, AA0218, AA0228, AL0254, AL0424, AW0006 // ForNAV settings
/// <summary>
...
page 69999 "DBSL Accountant Role Center"
{
    ...
    actions
    {
        area(reporting)
        {
            ...
            group("Imprest Reports")
            {
                Caption = 'Cost Accounting';

                action("Outstanding Imprest Report")
                {
                    ApplicationArea = CostAccounting;
                    Caption = 'Outstanding Imprest Report';
                    Image = "Report";
                    RunObject = Report "Imprest Report";
                }
        ...
        area(embedding)
        {
            ...
            action(Resources)
            {
                ...
                ToolTip = 'View or edit detailed information for the Resources that you trade with. From each Resource card, you can open related information, such as purchase statistics and ongoing orders, and you can define special prices and line discounts that the vendor grants you if certain conditions are met.';
            }
        ...
        area(sections)
        {
            ...
            group("Imprest Management")
            {
                ...
                ToolTip = 'Process on Imprest Management.';
                ...
                action("Standing Imprest Requisition")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Standing Imprest Requisition';
                    Image = BankAccountRec;
                    RunObject = Page "Standing Imprest Requsitions";
                    ToolTip = 'Standing Imprest Requisition';
                }
                action("Standing Imprest Surrenders")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Standing Imprest Surrenders';
                    Image = BankAccountRec;
                    RunObject = Page "Standing Imprest Surrenders";
                    ToolTip = 'Standing Imprest Surrenders';
                }
            }
            ...
            group("Approved Documents")
            {
                ...
                ToolTip = 'View Approved Documents';
                action(ApprovedPaymentVouchers)
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Approved Payment Vouchers';
                ...
                action("Approved Standing Imprest Requisitions")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Approved Standing Imprest Requisitions ';
                    RunObject = Page "Approved Standing Imprests";
                    ToolTip = 'Approved Standing Imprest Requisitions.';
                }
                action("Approved Standing Imprest Surrenders")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Approved Standing Imprest Surrenders';
                    Image = BankAccountRec;
                    RunObject = Page "Standing Imp Surrenders Appr";
                    ToolTip = 'Approved Standing Imprest Surrenders.';
                }
                action("Approved Petty Cash Surrenders")
                {
                    ApplicationArea = Basic, Suite;
            ...
            group("Posted Documents")
            {
                ...
                //     ToolTip = '.';
                // }
                action(PostedActivityBudget)
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Posted Activity Budget';
                    Image = DepositSlip;
                    RunObject = Page "Posted Imprest Memos";
                    ToolTip = 'Posted Activity Budget.';

                }
                action(PostedPettyCashSurrenders)
                {
                    ApplicationArea = Basic, Suite;
                ...
                action("Posted Standing Imprest Surrenders ")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Posted Standing Imprest Surrenders ';
                    Image = BankAccountRec;
                    RunObject = Page "Standing Imp Surrenders Posted";
                    ToolTip = 'Posted Standing Imprest Surrenders .';
                }
                action("Posted Standing Imprest Requisitions ")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Posted Standing Imprest Requisitions ';
                    Image = BankAccountRec;
                    RunObject = Page "Posted Standing Imprests";
                    ToolTip = 'Posted Standing Imprest Requisitions .';
                }
