...
Page 72628 "Advance Payment Gurantee"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Advance Document No To Revise"; Rec."Advance Document No To Revise")
                {
                    ...
                    ToolTip = 'Specifies the value of the Advance Document No To Revise field.';
                }
                ...
                field("Policy/Guarantee No"; Rec."Policy/Guarantee No")
                {
                    ...
                    ToolTip = 'Specifies the value of the Guarantee No field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Revised Guaranteed Amount field.';
                }
        ...
        area(FactBoxes)
        {
            part(Control1906354007; "Doc. Attachment List Factbox1")
            {
