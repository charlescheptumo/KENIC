page 50164 "Additional Leave Days Memo"
{
    ApplicationArea = All;
    Caption = 'Additional Leave Days Memo';
    PageType = Card;
    ...
    layout
    {
        area(Content)
        {
            group(General)
            {
                ...
                field("Additional Leave Days"; Rec."Additional Leave Days")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Additional Leave Days field.', Comment = '%';
                }
                ...
                action("&Post")
                {
                    ...
                    begin
                        ...
                        if HRLeaveApp.Find('-') then begin
                            HRLeaveApp.AdditionalLeaveDays;
    ...
    begin
        Rec."Document Type" := Rec."Document Type"::"Additional Leave Days Memo";
    end;
