#pragma warning disable AA0005, AA0008, AA0018,AL0603, AA0021, AA0072, AA0137, AA0201, AA0206, AA0218,AL0432, AA0228, AL0254, AL0424, AW0006 // ForNAV settings
...
page 50253 "Loan Item Surrender Lines"
{
    ApplicationArea = All;
    PageType = ListPart;
    ...
    SourceTableView = where("Document Type" = filter("Loan Issue Surrender"));
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Quantity Returned field.';
                }
                ...
                field("Loan Remaining Quantity"; Rec."Loan Remaining Quantity")
                {
                    ToolTip = 'Specifies the value of the Loan Remaining Quantity field.', Comment = '%';
                    ApplicationArea = Basic;
                    Editable = false;
                }
