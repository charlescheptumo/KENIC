#pragma warning disable AA0005, AL0603,AA0008, AA0018, AA0021, AA0072, AA0137, AA0201, AA0206, AA0218, AA0228, AL0424, AW0006 // ForNAV settings
Page 90129 "Disposal Quote1"
{
    Caption = 'Sales Quote';
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                // field("Disposal Invitation No";"Disposal Invitation No")
                // {
