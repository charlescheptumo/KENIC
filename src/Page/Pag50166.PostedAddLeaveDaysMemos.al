page 50166 "Posted Add. Leave Days Memos"
{
    ApplicationArea = All;
    Caption = 'Posted Add. Leave Days Memos';
    PageType = List;
    SourceTable = "HR Leave Applications";
    CardPageID = "Additional Leave Days Memo";
    sourcetableview = where("Document Type" = const("Additional Leave Days Memo"), status = filter(Released), Posted = const(true));
