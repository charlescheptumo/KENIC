...
// page 50100 "BC Role Center"
// {
//     ApplicationArea = All;
//     Caption = 'BC Role Center';
//     PageType = Card;
...
page 99022 "BManager Role Center"
{
...
#pragma warning restore AS0072
        ...
        area(sections)
        {
            ...
            group("CoCCA to ERP Intergration")
            {
                action(Registant)
                {
                    ApplicationArea = Basic, Suite;
                ...
                action("Registant Contact List")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Registant Contact List';
                    Image = BankAccountRec;
                ...
                action("Domain Services")
                {
                    ...
                    Image = BankAccountRec;
                    RunObject = Page "Item List";
                    RunPageLink = type = filter("Service");
                    //ToolTip = 'Reconcile bank accounts in your system with bank statements received from your bank.';
                }
                action("Price List")
                {
                ...
                action("Domain Charges")
                {
                    ApplicationArea = Suite;
                    Caption = 'Domain Charges';
