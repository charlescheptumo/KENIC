page 50161 "Posted Salary Advance Memos"
{
    ApplicationArea = All;
    Caption = 'Posted Salary Advance Memos';
    PageType = List;
    CardPageId = "Salary Advance Memo";
    SourceTable = payments;
    SourceTableView = where(Status = filter(Released), Posted = const(true));
    UsageCategory = Lists;
    ...
    begin
        ...
        if Usersetup1."Payroll View" = false then
            ERROR('You do not have sufficient rights to view Posted Salary Advance Memos Page!Please contact system administrator.');
