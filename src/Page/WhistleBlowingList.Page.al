...
Page 60065 "Whistle Blowing List"
{
    CardPageID = "Ticketing Card";
    PageType = List;
    SourceTable = "Front Office Management";
    SourceTableView = where("Document Type" = const(Whistle));
    ApplicationArea = All;
    ...
    begin
        Rec.SetRange("Document Type", Rec."document type"::Whistle);
    end;

    trigger OnInsertRecord(BelowxRec: Boolean): Boolean
    begin
        Rec."Document Type" := Rec."document type"::Whistle;
    end;
