page 80481 "Dept Performance Con Log Card"
{
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ToolTip = 'Specifies the value of the Organizational No field.';
                    visible = false;
                ...
                begin
                    ...
                    IF PlogLines.FINDFIRST THEN BEGIN
                        REPEAT
                            ...
                            // UNTIL PlogLines.NEXT = 0;
                            if (PlogLines."Activity Type" <> PlogLines."activity type"::"JD Activity") then begin
                                StrategicPlanning.FnInsertPlogEntry(Rec."Organizational No", '', '', '', PlogLines."Initiative No.", Rec.Description, Entrytype::Actual, Rec."Year Reporting Code", rec."Reporting Quater Code", PlogLines."Planned Date", Rec."Directorate Code", Rec."Department Code", PlogLines."Achieved Target", 0, Rec.No, SourceType::"Perfomance Contract"
