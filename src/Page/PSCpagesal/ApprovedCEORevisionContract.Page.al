...
Page 80521 "Approved CEO Revision Contract"
{
    Caption = 'Approved CEO Performance Revision Contracts';
    CardPageID = "Approved CEO Revision Contrac";
    PageType = List;
    SourceTable = 80055;
    SourceTableView = where("Document Type" = const("CEO/Corporate Awp"),
