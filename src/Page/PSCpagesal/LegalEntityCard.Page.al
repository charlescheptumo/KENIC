...
//                 RunPageView = where("Operating Unit Type"=filter(Directorate));
...
//                 PromotedCategory = Category4;
//                 RunObject = Page "Responsibility Center List";
//                 RunPageView = where("Operating Unit Type"=filter("Department/Center"));
//                 ToolTip = 'Set up responsibility centers to administer business operations that cover multiple locations, such as a sales offices or a purchasing departments.';
//             }
//             separator(Action28)
//             {
...
//                 RunObject = Page UnknownPage69015;
//             }
//             separator(Action23)
//             {
//             }
...
//                 Promoted = true;
//                 PromotedCategory = Category6;
//                 RunObject = Page UnknownPage65045;
//                 Visible = false;
//             }
//             separator(Action24)
//             {
...
//                 Promoted = true;
//                 PromotedCategory = Category7;
//                 RunObject = Page UnknownPage65010;
//                 Visible = false;
//             }
//         }
//     }
...
//     begin
//         Rec.GetSystemIndicator(SystemIndicatorText,IndicatorStyle); // IndicatorStyle is not used
//         SystemIndicatorTextEditable := CurrPage.Editable and (Rec."System Indicator" = Rec."system indicator"::"Custom Text");
//     end;
