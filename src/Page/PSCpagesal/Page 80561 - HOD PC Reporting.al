page 80561 "HOD PC Reporting"
{
    ...
    layout
    {
        area(content)
        {
            ...
            // part("Objectives and Intiatives";80562)
            // {
    ...
    actions
    {
        ...
        area(creation)
        {
            ...
            action("Print Individual PC")
            {
                ...
                PromotedCategory = Category6;
                Visible = false;
                ToolTip = 'Executes the Departmental  Performance Contract action.';
            ...
            action("Individual PC-Sub Indicators")
            {
                ...
                Promoted = true;
                PromotedCategory = Category6;
                ToolTip = 'Executes the Departmental PC-Sub Indicators> action.';
