...
// Page 80009 "Organizational Units  List"
// {
//     AdditionalSearchTerms = 'department,office,location,site';
//     ApplicationArea = Location;
//     Caption = 'Organizational Units  List';
//     CardPageID = "Organizational Units  Card";
//     Editable = false;
//     PageType = List;
...
//                             DefaultDimMultiple.SetMultiRecord(RespCenter,Rec.FieldNo(Rec.Code));
