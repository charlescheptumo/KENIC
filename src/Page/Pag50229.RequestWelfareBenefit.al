...
page 50229 "Request Welfare Benefit"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ToolTip = 'Specifies the value of the Welfare Code field.';
                }
                field("Welfare Description"; Rec."Welfare Description")
                {
                    ToolTip = 'Specifies the value of the Welfare Description field.';
                }
        ...
        area(navigation)
        {
            ...
            group(Print)
            {
                ...
                action("Mandatory Attachments")
                {
                    ...
                    RunPageMode = View;
                    ToolTip = 'Executes the Mandatory Attachments action.';
                }
            }
        }
    }
