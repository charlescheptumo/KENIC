page 60017 EvaluationsForPCSumExpensing
{
    ApplicationArea = All;
    Caption = 'Evaluations For PC Sum Expensing';
    PageType = List;
    SourceTable = "Request for PC sum Expensing";
    UsageCategory = Lists;
    CardPageId = "Evaluation ForPCSumExpensing";
    PromotedActionCategories = 'New,Process,Report,Approve,Print,Request Approval,Customer,Navigate,Prices & Discounts';
    SourceTableView = where("Document Type" = const(Evaluation));
    layout
    {
        area(content)
        {
