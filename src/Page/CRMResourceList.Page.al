#pragma warning disable AA0005, AA0008, AA0018,AL0432, AA0021, AA0072, AA0137, AA0201, AA0204, AA0206, AA0218, AA0228, AL0254, AL0424, AS0011, AW0006 // ForNAV settings
Page 60082 "CRM Resource List"
{
    AdditionalSearchTerms = 'capacity,job,project';
    ApplicationArea = Jobs;
    Caption = 'Resources';
    CardPageID = "CRM Resource Card";
    Editable = false;
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,Resource,Navigate';
    SourceTable = Resource;
    SourceTableView = where(Type = filter("Board Room"));
    //UsageCategory = Lists;
