#pragma warning disable AA0005, AA0008, AA0018,AL0603, AA0021, AA0072, AA0137,AL0432, AA0201, AA0206, AA0218, AA0228, AL0254, AL0424, AW0006 // ForNAV settings
...
page 50260 "Item Rejection Lines"
{
    ApplicationArea = All;
    PageType = ListPart;
    ...
    SourceTableView = where("Document Type" = filter("Item Rejection"));
