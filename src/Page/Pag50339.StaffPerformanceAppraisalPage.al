#pragma warning disable AA0005, AA0008, AA0018,AL0482,AL0603, AA0021, AA0072, AA0137, AA0201, AA0206, AA0218, AA0228, AL0254, AL0424, AW0006
#pragma implicitwith disable
Page 50339 "Staff Performance Appraisal"
{
    DeleteAllowed = false;
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Department PC ID"; Rec."Directors PC ID")
                {
                    ApplicationArea = All;
                    Enabled = NoSenior;
                    ...
                    if rec."Senior Officer PC ID" = '' then begin
                        ...
                        if PCHeader.FindSet then begin
                            ...
                            if (SPMGeneralSetup."Allow Loading of  CSP" = true) then begin
                                ...
                                PcLinesN.SetRange("Workplan No.", Rec."Directors PC ID");
