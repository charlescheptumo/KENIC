table 99606 "Leave Recall"
{
    ...
    begin
        ...
        if HRSetup.Get() then begin
            ...
            if "Recall No" = '' then
                "Recall No" := NoSeriesManagement.GetNextNo(HRSetup."Leave Recall Nos", WorkDate(), true);
    ...
    begin
        ...
        HRLEntries."Leave Entry Type" := HRLEntries."leave entry type"::Negative;
        ...
        if HRLEntries.Insert then begin
            EmployeeRec.Reset;
            EmployeeRec.Get(Recall."Employee No");
            EmployeeRec."Total Leave Taken" := EmployeeRec."Total Leave Taken" - Recall."Days Recalled";
            // EmployeeRec."Leave Balance" := EmployeeRec."Leave Balance" + Recall."Days Recalled";
            EmployeeRec.Modify();
