...
Table 50035 "Legal Declarations Lines"
{
    ...
    fields
    {
        ...
        field(3; "PF Number"; Code[30])
        {
            ...
            trigger OnValidate()
            begin
                LegalDeclarationsLines.Reset;
                LegalDeclarationsLines.SetRange(No, No);
                LegalDeclarationsLines.SetRange("PF Number", "PF Number");
                if LegalDeclarationsLines.FindFirst then begin
                    Error('ERROR! Staff No %1 already Exists', "PF Number");
                end;
            end;
        }
        ...
        field(27; "Designation of the officer"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(29; "Gift No"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Legal Gift Register".Code;

            trigger OnValidate()
            begin
                LegalGiftRegister.Reset;
                LegalGiftRegister.SetRange(Code, "Gift No");
                if LegalGiftRegister.FindSet then begin
                    Description := LegalGiftRegister.Description;
                end;
            end;
        }
    }
    ...
    keys
    {
        key(Key1; No, "Institution Code", "Line No", "Memorandum Categories", "Process Type")
        {
            Clustered = true;
        }
    }
    ...
    begin
        ...
        //  ERROR('ERROR! Staff No %1 already Exists',"PF Number");
        //  END;
        LegalDeclarationsRegister.Reset;
        LegalDeclarationsRegister.SetRange("Process Type", LegalDeclarationsRegister."process type"::"Wealth Management");
        LegalDeclarationsRegister.SetRange(No, No);
        if LegalDeclarationsRegister.FindSet then begin
            "Institution Code" := LegalDeclarationsRegister."Institution Code";
            "Institution Name" := LegalDeclarationsRegister."Institution Name";
    ...
    var
        ...
        LegalDeclarationsLines: Record "Legal Declarations Lines";
        LegalGiftRegister: Record "Legal Gift Register";
        LegalDeclarationsRegister: Record "Legal Declarations Register";
}
