...
Table 69003 "Employee Bank AccountX"
{
    ...
    fields
    {
        ...
        field(26; "No.Of Employees"; Integer)
        {
            ...
            CalcFormula = count("Employee Payment Information" where("Employee Bank Code" = field(Code),
                                                "Employee Bank Branch Code" = field("Bank Branch No.")));                                   
            Editable = false;
