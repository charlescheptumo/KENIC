#pragma warning disable AA0005, AA0008, AA0018, AA0021,gAL0432, AA0072, AA0137, AA0201, AA0206, AA0218, AA0228, AL0254, AL0424, AW0006 // ForNAV settings
Table 56024 "Applicant onboarding Table"
{
    ...
    begin
        ...
        if ("Applicant Category" = "applicant category"::Company) and ("Pays tax?" = true) then begin
...
//         ShippingAgentService: Record "Shipping Agent Services";
//         // ItemCrossReference: Record "Item Cross Reference";
//         // ItemCrossReference: Record ItemReference;
//         RMSetup: Record "Marketing Setup";
//         SalesPrice: Record "Sales Price";
//         SalesLineDisc: Record "Sales Line Discount";
//         SalesPrepmtPct: Record "Sales Prepayment %";
