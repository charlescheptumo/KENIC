table 50028 "Vendor Appraisal Voucher"
{
    ...
    fields
    {
        ...
        field(488; "Recommendation(s)"; Text[2048])
        {

        }
        field(489; "Suggested Areas of Improvement"; Text[2048])
        {

        }
        field(490; "Legal Department Remark(s)"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(491; "Complaints to the Supplier"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    begin
        IF "Document No" = '' THEN BEGIN
            ...
            ProcurementSetup.TESTFIELD("Vendor Appraisal Nos");
             "Document No" := NoMgt.GetNextNo(ProcurementSetup."Vendor Appraisal Nos", WorkDate(), true);
