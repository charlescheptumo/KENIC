...
table 99502 "RAM Workplan Header"
{
    ...
    fields
    {
        ...
        field(7; "Financial Year Code"; Code[20])
        {
            ...
            begin
                ...
                IF "Workplan Type" = "Workplan Type"::Consolidated THEN BEGIN
                    ...
                    Description := 'KeRRA CONSOLIDATED ROAD MAINTENANCE WORKPLAN FOR FINANCIAL YEAR' + ' ' + "Financial Year Code";
                END;
        ...
        field(40; "Funding Source Type"; Option)
        {
            ...
            begin
                ...
                RoadWorksCeilingDetailedLine.SETRANGE(RoadWorksCeilingDetailedLine."Financial Year", "Financial Year Code");
                RoadWorksCeilingDetailedLine.SETRANGE(RoadWorksCeilingDetailedLine."Funding Source Code", "Global Dimension 2 Code");
                RoadWorksCeilingDetailedLine.SETRANGE(RoadWorksCeilingDetailedLine."Funding Source Type", "Funding Source Type");
                RoadWorksCeilingDetailedLine.SETRANGE(RoadWorksCeilingDetailedLine."Constituency Code", "Constituency Code");
                RoadWorksCeilingDetailedLine.SETRANGE(RoadWorksCeilingDetailedLine."Region Code", "Global Dimension 1 Code");
    ...
    begin
        ...
        IF UserSetup.GET(USERID) THEN BEGIN
            ...
            "Road Planner No" := UserSetup."Resource No";
