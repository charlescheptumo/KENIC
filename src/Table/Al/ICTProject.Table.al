...
Table 56058 "ICT Project"
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = "IFS Tender Committee"."Document No." where("Previous Appointed Committee" = const());
        }
    ...
    begin
        if "No." = '' then begin
            ...
            rec."No."  := NoSeriesMgt.GetNextNo(ICT."ICT Project Nos", WorkDate(), true);
        end;
    end;
