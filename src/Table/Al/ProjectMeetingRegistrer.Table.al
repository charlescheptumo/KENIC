...
Table 56059 "Project Meeting Registrer"
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = if ("Steering Committee Meeting" = const(true)) "IFS Tender Committee"."Document No." where("Previous Appointed Committee" = const());
        }
    ...
    begin
        if "Meeting ID" = '' then begin
            ...
            ICT.TestField(ICT."Project Meeting Register Nos");
                 rec."Meeting ID"  := NoSeriesMgt.GetNextNo(ICT."Project Meeting Register Nos", WorkDate(), true);
        end;
    end;
