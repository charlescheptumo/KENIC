    ...
    begin
        if RegistrationType = Registrationtype::Document then begin
            if "Entry No" = '' then begin
              ...
              rec."Entry No" := NoSeriesMgt.GetNextNo(NoSetup."Document Registration Nos", WorkDate(), true);
            end;
        end else begin
            if "Entry No" = '' then begin
                NoSetup.Get;
                NoSetup.TestField(NoSetup."Court Attendance Nos");
         rec."Entry No" := NoSeriesMgt.GetNextNo(NoSetup."Court Attendance Nos", WorkDate(), true);
            end;
        end;
