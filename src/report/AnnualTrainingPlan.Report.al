...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Annual Training Plan.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Training Plan Header"; "Training Plan Header")
        {
            ...
            dataitem("Training Plan Lines"; "Training Plan Lines")
            {
                ...
                dataitem("Planning Line Entry"; "Planning Line Entry")
                {
                    DataItemLinkReference = "Training Plan lines";
                    DataItemLink = "Course ID" = field("Course Title"),
                              "Training Plan Id" = field("Training Plan Code");
                    column(Employee_No_; "Employee No.") { }
                    column(Employee_Name; "Employee Name") { }
                    column(Planned_Start_DatePLE; "Planned Start Date") { }
                    column(Planned_End_DatePLE; "Planned End Date") { }
                    column(Planned_Directorate; "Planned Directorate") { }
                    column(Planned_Department; "Planned Department") { }
                    column(Planned_Service_Provider_Name; "Planned Service Provider Name") { }
                    column(Course_ID; "Course ID") { }
                    column(Location; Location) { }
                    column(location_name; "location name") { }
                    column(Training_Plan_Id; "Training Plan Id") { }
                    column(Planned_Region; "Planned Region") { }
                    column(Planned_Budget; "Planned Budget") { }
