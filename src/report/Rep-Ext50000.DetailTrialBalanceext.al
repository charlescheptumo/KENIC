...
report 50130 "General Ledger Listing"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/DetailTrialBalance.rdlc';
    ...
    {
        SaveValues = true;
        AboutTitle = 'About General Ledger Listing';
    ...
    var
        ...
        DetailTrialBalCaptionLbl: Label 'General Ledger Listing';
        ...
        DetailedTrialBalanceReportGeneratedTxt: Label 'General Ledger Listing report generated.', Locked = true;
        GLFilter: Text;
