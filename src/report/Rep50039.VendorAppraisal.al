report 50039 "Vendor Appraisal"
{
    ...
    dataset
    {
        dataitem("Vendor Appraisal Voucher"; "Vendor Appraisal Voucher")
        {
            ...
            column(SuggestedAreasofImprevement_VendorAppraisalVoucher; "Vendor Appraisal Voucher"."Suggested Areas of Improvement")
            {
            }
            column(Recommendations_VendorAppraisalVoucher; "Vendor Appraisal Voucher"."Recommendation(s)")
            {
            }
            column(LegalDepartmentRemarks_VendorAppraisalVoucher; "Vendor Appraisal Voucher"."Legal Department Remark(s)")
            {
            }
