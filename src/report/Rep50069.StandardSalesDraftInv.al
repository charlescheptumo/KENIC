#pragma warning disable AA0005,AL0603, AA0008, AA0018, AA0021,AL0432, AA0072, AA0137, AA0201, AA0206, AA0218, AA0228, AL0254, AL0424, AW0006 // ForNAV settings

report 50069 "Standard Sales - Draft Inv."
{
    Caption = 'Invoice';
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/StandardSalesDraftInvoice.rdlc';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(VerifiedByCaption; VerifiedByLbl)
            {
            }
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(NoOfDays_SalesLine; Line."No. of Days")
                {
                }
                column(NoOfPeople_SalesLine; Line."No. of People")
                {
                }
            ...
            begin
                ...
                ApprovalEntries.SetRange("Table ID", 36);
                ApprovalEntries.SetRange("Document No.", Header."No.");
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(ArchiveDocument; ArchiveDocument)
                    {
                        ...
                        ToolTip = 'Specifies if the document is archived after you print it. Note: This option is going to be discontinued in future releases. Instead, for sales invoice versioning you can use the feature to attach invoice printout as PDF document.';
    ...
    //     {
    //         Type = Word;
    //         LayoutFile = './Layouts/StandardSalesDraftInvoice2.docx';
    ...
    var
        ...
        VerifiedByLbl: Label 'Reviewed By';
        ...
        VATClausesText: Text;
        NextInvoiceNo: Text;
        SalesConfirmationLbl: Label 'Invoice';
        YourDocLbl: Label 'Your %1', Comment = '%1 - Your Invoice or Your Invoice';
