            ...
            area(content)
            {
                group(Control2)
                {
                    ...
                    field("New Employment Terms"; EmploymentTerms)
                    {
                        ...
                        NotBlank = true;
                        ToolTip = 'Specifies the value of the New Employment Terms field.';
                    }
                    field("New Position Code"; NewPosition)
                    {
                        ...
                        ToolTip = 'Specifies the value of the New Position Code field.';
                        trigger OnValidate()
                    ...
                    group(CopyWarning)
                    {
                        ...
                        field("Confirm Copy Warning"; ConfirmToChange)
                        {
                            ...
                            ShowCaption = true;
                            ToolTip = 'Specifies the value of the Confirm To Change field.';
