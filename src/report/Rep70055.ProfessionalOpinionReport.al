...
Report 70055 "Professional Opinion Report"
{
    ...
    dataset
    {
        dataitem("Bid Tabulation Header"; "Bid Tabulation Header")
        {
            ...
            // {
            // }
            column(CompanyAddress1; corec.Name)
            {

            }
            column(CompanyAddress2; corec.Address)
            {

            }
            column(CompanyAddress3; corec."Address 2")
            {

            }
            column(CompanyAddress4; corec."Phone No.")
            {

            }
            column(CompanyAddress5; corec."E-Mail")
            {

            }
            column(CompanyAddress6; corec."Home Page")
            {
            }
