report 50076 "Bank Account Statement 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/BankAccountStatement2.rdlc';
    ...
    begin
        ...
        SetOutstandingFilters(TempBankAccountReconciliation, BankAccountLedgerEntry);
