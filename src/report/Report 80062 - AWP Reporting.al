report 80062 "AWP Reporting"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/AWP Staff Reporting.rdlc';
    Caption = 'performance Contract Grouped';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Perfomance Contract Header"; "Perfomance Contract Header")
        {
            ...
            dataitem("PC Objective"; "PC Objective")
            {
                ...
                column(Q4ActualQty_PCObjectives; "PC Objective"."Q4 Actual Qty")
                {
                }
