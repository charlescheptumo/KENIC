...
report 50113 StandardSalesProInvoice1

{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/StandardSalesProFormaInv1.rdlc';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(CompanyAccountName; CompanyInformation."Bank Name")
            {
            }
            column(CompanyBank; CompanyInformation.Bank)
            {
            }
            column(CompanyBankBranch; CompanyInformation."Bank Branch No.")
            {
            }
            column(CompanyAccountNo; CompanyInformation."Bank Account No.")
            {
            }
            ...
            column(SalesPersonEmail; SalesPersonEmail)
            {
            ...
            begin
                ...
                if SalespersonPurchaser.FindFirst() then
                    SalesPersonPhone := SalespersonPurchaser."Phone No.";
