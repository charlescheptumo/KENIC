...
report 50066 "Purchase Document - Test 2"
{
    // ApplicationArea = All;
    // UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/PurchaseDocumentTest2.rdlc';
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem(CopyLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(Purchase_Line___GL_Account_No_; GLAccountNo)
                        {
                        }
                        column(Purchase_Line___GL_Account_Name_; GLAccountName)
                        {
                        }
                        ...
                        begin
                            ...
                            // Resolve G/L Account for display
                            case "Purchase Line".Type of
                                "Purchase Line".Type::"G/L Account":
                                    begin
                                        GLAccountNo := "Purchase Line"."No.";
                                        if GLAcc.Get(GLAccountNo) then
                                ...
                                "Purchase Line".Type::Item:
                                    begin
                                        ...
                                        if GenPostingSetup.Get(
                                            ...
                                            "Purchase Line"."Gen. Prod. Posting Group") then begin
                                            GLAccountNo := GenPostingSetup."Purch. Account";
                                            if GLAcc.Get(GLAccountNo) then
                                                GLAccountName := GLAcc.Name;
                                        end;
                                    end;
