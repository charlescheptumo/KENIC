...
report 50098 "Customer Summary Aging"
{
    Caption = 'Customer Summary Aging';
     DefaultLayout = RDLC;
    RDLCLayout = './Layouts/AgedAccountsReceivable.rdlc';
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(Agingby; AgingBy)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Aging by';
                        OptionCaption = 'Due Date,Invoice Date,Document Date';
    ...
    var
        ...
        Text006: Label 'Aged as At %1';
        Text007: Label 'Aged by %1';
        NumberOfCurrencies: Integer;
        Text009: Label 'Due Date,Invoice Date,Document Date';
        ...
        AgedAccReceivableCptnLbl: Label 'Aged Debtors';
