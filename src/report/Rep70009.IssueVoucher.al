...
Report 70009 "Issue Voucher"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(PostedBy_PurchaseHeader; "Posted By")
            {
            }
            ...
            column(RequisitionOfficer_Signature; UserSetup6.Picture)
            {
            }
            column(AuthorisingOfficer; UserSetup1."Employee Name")
            {
            }
            column(DateAuthorisingOfficer; ApproverDate[1])
            {
            }
            ...
            column(RequestorDesgination; RequestorDesgination)
            {
            }
            ...
            column(PostedBySignature; UserSetup5.Picture)
            {
            }
            column(PostingDate_PurchaseHeader; "Posting Date")
            {
            }
            column(IssueDesgination; IssueDesgination)
            {
            ...
            begin
                ...
                If Emp.Get("Request-By No.") then
                    RequestorDesgination := Emp."Job Title";
                //    
                if UserSetup6.Get("Requester ID") then
                ...
                //Posted BY- Muraya
                // UserSetup5.Reset;
                // UserSetup5.SetRange("User ID", "Purchase Header"."Posted By");
                // if UserSetup5.Find('-') then begin
                //     UserSetup5.CalcFields(Picture);
                //     PostedByName := UserSetup5."Employee Name";
                //     if Emp.Get(UserSetup5."Employee No.") then
                //     IssueDesgination := Emp."Job Title";
                // end;    
                UserSetup5.Reset;
                UserSetup5.SetRange("User ID", "Purchase Header"."Posted By");
                if UserSetup5.Find('-') then begin
    ...
    var
        ...
        RequestorDesgination: Text[50];
        HODDesignation: Text[50];
        IssueDesgination: Text[50];
        PostedByName: Text;
}
