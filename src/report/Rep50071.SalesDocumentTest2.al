report 50071 "Sales Document - Test 2"
{
    // ApplicationArea = All;
    // UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/SalesDocumentTest2.rdlc';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem(CopyLoop; "Integer")
                {
                    ...
                    dataitem("Sales Line"; "Sales Line")
                    {
                        ...
                        column(NoOfDays_SalesLine; "Sales Line"."No. of Days")
                        {
                        }
                        column(NoOfPeople_SalesLine; "Sales Line"."No. of People")
                        {
                        }
            ...
            begin
                ...
                ApprovalEntries.SetRange("Document No.", "Sales Header"."No.");
