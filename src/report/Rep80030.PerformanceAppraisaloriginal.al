...
Report 80030 "Performance Appraisal-original"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Performance Appraisal-original.rdlc';
    ApplicationArea = All;
    //  WordLayout = './Layouts/Performance Appraisal-original.docx';
