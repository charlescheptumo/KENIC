...
Report 72058 "Site Instructions Letter"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/SiteInstructionsLetter.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Site Instructions Header"; "Site Instructions Header")
        {
            ...
            column(Site_Instruction_Heading; "Site Instruction Heading")
            {
            ...
            column(ReferenceNo_SiteInstructionsHeader; "Site Instructions Header"."Reference No.")
            {
            }
            ...
            column(Vendor_Address_1; VendorAddress1)
            {

            }
            column(Vendor_Address_2; VendorAddress2)
            {
            ...
            begin
                if Vendor.Get("Contract No") then begin
                    VendorAddress1 := Vendor.Address;
