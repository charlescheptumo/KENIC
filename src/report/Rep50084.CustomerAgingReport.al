...
report 50084 "Customer Aging Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/CustomerSummaryAging.rdlc';
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                DataItemLink = "Customer No." = field("No.");
                                                                      ...
                                                                      column(CustomerNo_CUstomerLedgerEntry; "Customer No.")
                                                                      {
                                                                      }
                                                                      column(CustomerName_CUstomerLedgerEntry; "Customer Name")
                                                                      {
                                                                      }
                                                                      column(DocumentNo_CUstomerLedgerEntry; "Document No.")
                                                                      {
                                                                      }
                }
