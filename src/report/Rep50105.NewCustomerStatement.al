...
report 50105 "New Customer Statement"
{
    ApplicationArea = All;
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    begin
                        ...
                        if StatementStyle = StatementStyle::"Open Item" then begin
                            ...
                            CustLedgerEntryBalance.SetRange(Open,true);
                            // CustLedgerEntryBalance.SetRange("Posting Date", 0D, StartDate - 1);
                            CustLedgerEntryBalance.SetRange("Posting Date", 0D, EndDate);
    ...
    rendering
    {
        ...
        {
            Type = Word;
            LayoutFile = './Layouts/StandardStatement.docx';
