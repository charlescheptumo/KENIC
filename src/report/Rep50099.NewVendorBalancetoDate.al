...
report 50099 "New Vendor - Balance to Date"
{
    Caption = 'New Vendor - Balance to Date';
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/VendorBalancetoDate.rdlc';
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            dataitem(VendLedgEntry3; "Vendor Ledger Entry")
            {
                ...
                // ADDED: New column for Bank Name
                ...
                begin
                    ...
                    // ADDED: Populate BankName from VLE field "Bank Name" (field 70013)
                    BankName := VendLedgEntry3."Bank Name";
    ...
    local procedure FilterDetailedVendLedgerEntry(var DetailedVendorLedgEntry: Record "Detailed Vendor Ledg. Entry"; EndingDate: Text)
    begin
        ...
        DetailedVendorLedgEntry.SetFilter("Posting Date", EndingDate);
