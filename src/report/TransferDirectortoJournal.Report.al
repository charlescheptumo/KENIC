...
Report 59103 "Transfer Director to Journal"
{
        ...
        dataitem(Vendor; Vendor)
        {
            ...
            begin
                ...
                if Earnings.FindSet(false, false) then begin
                    ...
                    if Deductions.FindSet(false, false) then begin
    ...
    begin
        if Confirm('Payroll Journal has been created. Do you wish to open it now?', true) = true then begin
    ...
    begin
        ...
        if not JnlTemp.Get(HRSetup."Payroll Journal Template", HRSetup."Payroll Journal Batch") then begin
            JnlTemp.Init();
