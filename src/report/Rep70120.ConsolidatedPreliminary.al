...
Report 70120 "Consolidated Preliminary"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Consolidated Preliminary.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Bid Evaluation Header"; "Bid Evaluation Header")
        {
            ...
            {
                DataItemLink = "IFS Code" = field("IFS Code"), "Last Evaluation Version No." = field("Last Evaluation Version No.");
                DataItemTableView = where("Evaluation Type" = filter("Preliminary Evaluation"), "Preliminary Evaluation Score" = const(Responsive));
            ...
            dataitem(ENTRY; "Bid Evaluation Score Entry")
            {
                ...
                begin
                    ...
                    if BidEvaluationRegister.FindFirst then begin
                        Recommendation := Format(BidEvaluationRegister."Preliminary Evaluation Score");
                    end;
                    PurchaseHeader2.Reset;
            ...
            {
                DataItemLink = "IFS Code" = field("IFS Code"), "Last Evaluation Version No." = field("Last Evaluation Version No.");
                DataItemTableView = where("Evaluation Type" = filter("Preliminary Evaluation"), "Evaluation Results" = const(Fail));
