...
Report 70098 "IFP Evaluation Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/IFP Evaluation Report.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Bid Tabulation Header"; "Bid Tabulation Header")
        {
            ...
            dataitem("Bid Evaluation Criteria Group"; "Bid Evaluation Criteria Group")
            {
                DataItemLink = "Template ID" = field("IFP Code");
                column(ReportForNavId_130; 130)
                {
                }
                column(TemplateID_BidEvaluationCriteriaGroup; "Bid Evaluation Criteria Group"."Template ID")
                {
                }
                column(CriteriaGroupID_BidEvaluationCriteriaGroup; "Bid Evaluation Criteria Group"."Criteria Group ID")
                {
                }
                column(EvaluationType_BidEvaluationCriteriaGroup; "Bid Evaluation Criteria Group"."Evaluation Type")
                {
                }
                column(Description_BidEvaluationCriteriaGroup; "Bid Evaluation Criteria Group".Description)
                {
                }
                column(TotalWeight_BidEvaluationCriteriaGroup; "Bid Evaluation Criteria Group"."Total Weight %")
                {
                }
                column(DocumentNo_BidEvaluationCriteriaGroup; "Bid Evaluation Criteria Group"."Document No")
                {
                }
                column(NoofScoredCriteriaGroups_BidEvaluationCriteriaGroup; "Bid Evaluation Criteria Group"."No of Scored Criteria Groups")
                {
                }
                column(NoofCriteriaCroups_BidEvaluationCriteriaGroup; "Bid Evaluation Criteria Group"."No of Criteria Croups")
                {
                }
            }
