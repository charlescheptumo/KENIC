report 69407 "Temporary Employee Statement"
{
    ...
    begin
        ...
        IF PrintAmountsInLCY THEN BEGIN
            AmountCaption := "Employee Ledger Entry".FIELDCAPTION("Amount (LCY)");
            RemainingAmtCaption := "Employee Ledger Entry".FIELDCAPTION("Remaining Amt. (LCY)");
        END ELSE BEGIN
            AmountCaption := "Employee Ledger Entry".FIELDCAPTION(Amount);
            RemainingAmtCaption := "Employee Ledger Entry".FIELDCAPTION("Remaining Amount");
        END;
    end;
