...
Page 99408 "Approved Board/Executive PCs"
{
    ApplicationArea = Basic;
    CardPageID = "Board/Executive PC";
    DeleteAllowed = false;
    Editable = false;
    Caption = 'Approved Board Annual Workplan';
    PageType = List;
    SourceTable = "Perfomance Contract Header";
    SourceTableView = where("Document Type" = const("Board/Executive PC"), "Approval Status" = filter(Released));
    UsageCategory = Lists;
