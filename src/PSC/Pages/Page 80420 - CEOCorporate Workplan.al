page 80420 "CEO/Corporate Workplan"
{
    PageType = Card;
    SourceTable = 80055;
    ApplicationArea = All;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                // field("Total  Departments";"Total  Departments")
                // {
                //     Caption = 'Total Departments Count';
                //     Editable = false;
                //     Visible = false;
                // }
    ...
    actions
    {
        ...
        area(creation)
        {
            ...
            action("Preview Tagets")
            {
                ...
                ToolTip = 'Executes the Preview Targets action.';

                trigger OnAction()
                begin
                    Rec.SETRANGE(No, Rec.No);
                    //REPORT.RUN(80004,TRUE,TRUE,Rec) 80058
    ...
    // begin
    //     "Document Type":="Document Type"::"CEO/Corporate Awp";
    // end;
