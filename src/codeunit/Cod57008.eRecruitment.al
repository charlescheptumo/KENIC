...
Codeunit 57008 "eRecruitment"
{
    ...
    var
        ...
        FILEPATH5: label 'C:\inetpub\wwwroot\ERecruitment\Files\';
    ...
    begin
        ...
        if DynasoftPortalUser.FindSet then begin
            ...
            // Body := 'Dear, your password for the account: ' + ' <strong>' + DynasoftPortalUser."Authentication Email" + '</strong> has been reset successfully. Kindly use the password below to access your account<br> <strong>Password: ' + '</strong> <br>';
    ...
    procedure FnAcademicQualifications(applicantNumber: Text; educationlevel: Integer; institutionname: Text; country: Text; qualificationtitle: Text; specializationarea: Text; attainedscore: Integer; graduationyear: Text; startdate: Datetime; enddate: Datetime; certNo: Code[20]) status: Text
    var
        ApplicantProfile: Record Contact;
        Contact: Record Contact;
        NoSeriesManagement: Codeunit "No. Series";
    ...
    begin
        ...
        JobApplicantsQualification."Licensing Number" := certNo;
    ...
    procedure FnUpdateAcademicQualifications(applicantNumber: Text; EntryNumber: Integer; educationlevel: Integer; institutionname: Text; country: Text; qualificationtitle: Text; specializationarea: Text; attainedscore: Integer; graduationyear: Text; startdate: DateTime; enddate: DateTime; certNo: Code[20]) status: Text
    var
        ApplicantProfile: Record Contact;
        Contact: Record Contact;
        NoSeriesManagement: Codeunit "No. Series";
    ...
    procedure FnUpdateProffessionalQualifications(EntryNo: Integer; applicantNumber: Text; professionQualification: Text; institutionname: Text; country: Text; qualificationtitle: Text; specializationarea: Text; attainedscore: Integer; graduationyear: Text; startdate: Datetime; enddate: Datetime) status: Text
    var
        ApplicantProfile: Record Contact;
        Contact: Record Contact;
        NoSeriesManagement: Codeunit "No. Series";
    ...
    procedure FnWorkExperience(applicantNumber: Text; employerName: Text; jobdesignation: Text; employmentstartdate: Datetime; employmentenddate: Datetime; termsofservice: Integer; experienceyears: Text; dutiesresponsibilities: Text; specializationArea: Text; employmentType: Integer) status: Text
    var
        ApplicantProfile: Record Contact;
        Contact: Record Contact;
        NoSeriesManagement: Codeunit "No. Series";
    ...
    begin
        ...
        // Only set "To Date" if a valid date is provided (not DateTime.MinValue)
        if employmentenddate <> 0DT then begin
    ...
    procedure FnUpdateWorkExperience(EntryNumber: Integer; applicantNumber: Text; employerName: Text; jobdesignation: Text; employmentstartdate: Datetime; employmentenddate: Datetime; termsofservice: Integer; experienceyears: Text; dutiesresponsibilities: Text; employmentType: Integer) status: Text
    var
        ApplicantProfile: Record Contact;
        Contact: Record Contact;
        NoSeriesManagement: Codeunit "No. Series";
    ...
    begin
        ...
        if JobApplicantsQualification.FindSet then begin
            ...
            // Only set "To Date" if a valid date is provided (not DateTime.MinValue or 0DT)
            if employmentenddate <> 0DT then begin
                JobApplicantsQualification."To Date" := dt2date(employmentenddate);
            end else begin
                // Clear the "To Date" field if no end date is provided (currently employed)
                Clear(JobApplicantsQualification."To Date");
            end;
            ...
            status := 'danger*Record not found';
        end;
    ...
    begin
        ...
        if JobApplications.FindSet then begin
            ...
            //     SMTP.Send();
            Body := 'Dear ' + JobApplications."First Name" + '<br>' + JobApplications."Last Name" + ',<br><br>' +
            'We are pleased to inform you that your application for the post<b>' + ' ' + JobApplications."Job Title/Designation" + '</b> has been Received Successfully.' + ',<br><br>' + ' Your Job Application Number is' + '<BR><b>' + JobAppplicationNumber + '<br>' + '</b>' +
            'You will be contacted shortly and an email sent to you as regards when you will be invited for your interview<br>' +
            'Use the following link to acess the E-Recruitment Portal.' + ' ' + '<b><a href="http://197.248.26.239:8093/">E-Recruitment Portal</a></b><br>'
            + '<br>';
    ...
    begin
        ...
        SenderMessage := 'Thank you for using our e-Recruitment Portal which has been established to provide you with ' +
                            'easy access to our online Recruitment services at KICD.' +
        ...
        emailhdr := 'KICD e-Recruitment Acknowledgment - [' + ApplicantRequest."No." + '])';
    ...
    begin
        ...
        LoginDetails := '<br> We have also created your portal access account with the following login credentials:' +
                          ...
                          'KICD E-Recruitment Portal and complete your Profile';
    ...
    begin
        ...
        if VacancyAdvert.FindSet then begin
            //   if FILE.Exists(FILEPATH5 + VcancyNo + '.pdf') then
            //     FILE.Erase(FILEPATH5 + VcancyNo + '.pdf');
            //   Report.SaveAsPdf(69605, FILEPATH5 + VcancyNo + '.pdf', VacancyAdvert);
    ...
    begin
        ...
        RecordLink.Type := RecordLink.Type::Link;
        RecordLink.Company := CompanyName;
        RecordLink."User ID" := candidateno;
        RecordLink.Created := CreateDatetime(Today, Time);
