            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(YearFilter; YearFilter)
                    {
                        Caption = 'Year';
                        ApplicationArea = All;
                        ToolTip = 'Specifies the year to report domain registration counts for.';
                    }
                    field(HideZeroRegistrars; HideZeroRegistrars)
                    {
                        Caption = 'Hide Registrars With No Activity';
                        ApplicationArea = All;
                        ToolTip = 'Specifies whether registrars with zero domains for the selected year should be excluded from the report.';
                    }
                }
            }
        }
