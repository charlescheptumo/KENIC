...
Page 72687 "Contractor Staff Disengagement"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Appointment Voucher No"; Rec."Appointment Voucher No")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Appointment Voucher No field.';
                }
            ...
            group("Contractor Details")
            {
                ...
                field("Contractor Email Address"; Rec."Contractor Email Address")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Contractor Email Address field.';
                }
                field("Contractor Address"; Rec."Contractor Address")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Contractor Address field.';
                }
                field("Contractor Address 2"; Rec."Contractor Address 2")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Contractor Address 2 field.';
                }
                field("Contractor City"; Rec."Contractor City")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Contractor City field.';
                }
            }
            group(Control16)
            {
    ...
    actions
    {
        area(navigation)
        {
            ...
            action("Notify Contractor")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Notify Contractor action.';
            ...
            action("Contractor Notification Letter")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Contractor Notification Letter action.';
            ...
            action(Post)
            {
                ...
                begin
                    ...
                    ContrStaffDisengagementLine.SetRange(ContrStaffDisengagementLine."Document Type", Rec."Document Type");
    ...
    begin
        Rec."Document Type" := Rec."document type"::"Contractor Staff Disengagement";
    end;
