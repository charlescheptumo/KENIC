    ...
    actions
    {
        area(navigation)
        {
            action("Suggest Staff From Bid Response")
            {
                ...
                PromotedIsBig = true;
                ToolTip = 'Executes the Suggest Staff From Bid Response action.';
            ...
            action("Print Appointment Summary")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Print Appointment Summary action.';
            ...
            action("Attach Docs")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Attach Site Agent CV action.';
