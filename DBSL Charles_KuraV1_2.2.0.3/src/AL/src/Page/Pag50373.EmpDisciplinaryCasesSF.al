...
/// <summary>
/// Page Emp Disciplinary Cases SF (ID 50373).
/// </summary>
page 50373 "Emp Disciplinary Cases SF"
{
                ...
                action("Notify HR")
                {
                    ...
                    begin
                        if confirm(Txt001, true) then begin
                            ...
                            Rec."Current Step" := Rec."Current Step"::FromHRAC;
                            Rec.Modify();
                        end;
                    end;
                }
    ...
    begin
        Rec."Document Attachment Type" := Rec."Document Attachment Type"::ShowCauseReplyFromEmployee;
    end;
