...
page 50323 "Posted Batch Imprest Voucher"
{
    ApplicationArea = All;
    Caption = 'Posted Batch Imprest Voucher';
    PageType = List;
    SourceTable = payments;
    UsageCategory = Lists;
    CardPageId = "Batch Imprest Voucher Card";
    SourceTableView = where("Payment Type" = filter("Batch Imprest Voucher"), Posted = const(true));
    InsertAllowed = false;
    ModifyAllowed=false;
    layout
    {
