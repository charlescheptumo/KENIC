...
Page 72495 "Appro Projec Variation Orders"
{
    Caption = 'Approved Project Variation Orders';
    CardPageID = "Project Variation Order";
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
    PageType = List;
    SourceTable = "Project Variation Header";
    SourceTableView = where("Document Type" = filter("Project Variation Order"),
