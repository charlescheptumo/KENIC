                    ...
                    if PlogLines.FindFirst then begin
                        repeat
                            if (PlogLines."Activity Type" <> PlogLines."activity type"::"JD Activity") then begin
                                StrategicPlanning.FnInsertPlogEntry(Rec."CEO PC ID", '', '', '', PlogLines."Initiative No.", Rec.Description, Entrytype::Actual, Rec."Year Reporting Code", '', PlogLines."Planned Date", Rec."Directorate Code", Rec."Department Code", PlogLines."Achieved Target", 0, Rec.No, SourceType
                            ...
                            if SubPlogLines.FindFirst then begin
                                repeat
                                    ...
                                    StrategicPlanning.FnInsertSubPlogEntry(Rec."CSP ID", '', '', '', SubPlogLines."Initiative No.", Rec.Description, Entrytype::Actual, Rec."Year Reporting Code", '', SubPlogLines."Planned Date", Rec."Directorate Code", Rec."Department Code",
                                    SubPlogLines."Achieved Target", 0, Rec.No, SourceType, Rec."Employee No.", SubPlogLines."Achieved Date", Documenttype::Plog, Rec."Region ID", Rec."Personal Scorecard ID", Rec."AWP ID", Rec."Board PC ID", Rec."CEO PC ID", Rec."Functional PC", SubPlogLines."Unit of Measure",
