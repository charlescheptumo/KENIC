page 50144 "Approved Training Application"
{

    Caption = 'Approved Training Application';
    PageType = Card;
        ...
        area(content)
        {
            group(General)
            {
                ...
                part("Attached Documents1"; "Doc. Attachment List Factbox1")
                {
                    ApplicationArea = All;
                    Caption = 'Attachment';
                    SubPageLink = "Table ID" = CONST(69220), "No." = FIELD(Code);//, "Document Type" = CONST(0);
        ...
        area(creation)
        {
            ...
            action("Close Appraisal")
            {
                ...
                begin
                    ...
                    Message('Training Application No %1 Closed Successfully', Rec.Code);
                end;
            }
            action(Attachments)
            {
