    ...
    actions
    {
        area(navigation)
        {
            action("Materials Deivered To Site")
            {
                ...
                ToolTip = 'Executes the Materials Delivered To Site action.';
            }
            action("Materials Removed From Site")
            {
                ...
                ToolTip = 'Executes the Materials Utilized On Site action.';
            }
            ...
            action("Key Site Staff")
            {
                ...
                RunPageLink = "Document No." = field("Document No.");
                ToolTip = 'Executes the Key Site Staff action.';
            }
            action("Contractor Labour Schedule")
            {
                ...
                RunPageLink = "Document No." = field("Document No.");
                RunPageMode = Edit;
                ToolTip = 'Executes the Contractor Labour Schedule action.';
            }
            ...
            action("Material Testing Records")
            {
                ...
                RunPageMode = View;
                ToolTip = 'Executes the Material Testing Records action.';
            }
            ...
            action(Release)
            {
                ...
                begin
                    ...
                    Rec.Modify;
                    Message('Document %1 has been released successfully', Rec."Document No.");
                end;
            }
            action(Reopen)
            {
                ...
                begin
                    ...
                    Rec.Modify;
                    Message('Document %1 has been reopened successfully', Rec."Document No.");
                end;
            }
            action(Print)
            {
                ...
                PromotedIsBig = true;
                ToolTip = 'Executes the Daily Work Record Summary action.';
            ...
            action(Acknowledge)
            {
                ...
                begin
                    ...
                    Rec.TestField("Representative ID");
                    Rec.TestField("Contract Signing Role");
                    Rec."Acknowledgement DateTime" := CreateDatetime(Today, Time);
