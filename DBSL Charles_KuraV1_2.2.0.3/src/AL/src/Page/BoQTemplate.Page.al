    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the PBRM BoQ field.';
                }
                ...
                {
                    ApplicationArea = basic;
                    ToolTip = 'Specifies the value of the Variation of Price Rate(%) field.';
                }
                ...
                {
                    ApplicationArea = basic;
                    ToolTip = 'Specifies the value of the Total Estimated Bid Sum 1 field.';
                }
    ...
    actions
    {
        area(navigation)
        {
            action("Work Categories")
            {
                ...
                ToolTip = 'Executes the Work Categories action.';
            }
            action("Bill Item Categories")
            {
                ...
                RunPageLink = "BoQ Template Code" = field(Code);
                ToolTip = 'Executes the Bill Item Categories action.';
            }
            action("Copy From Template")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Copy From Template action.';
            ...
            action("Suggest Template Liens")
            {
                ...
                ToolTip = 'Executes the Suggest Template Liens action.';
            ...
            action("Copy To Template")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Copy To Template action.';
            ...
            action("Generate Engineer Estimates")
            {
                ...
                Promoted = true;
                PromotedCategory = Process;
                ToolTip = 'Executes the Generate Engineer Estimates action.';
            ...
            action(AttachDocuments)
            {
                ...
                PromotedOnly = true;
                Visible = true;
                ToolTip = 'Executes the Attach Draft Tender Document action.';
