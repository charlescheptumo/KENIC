    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Requires Survey field.';
                }
            ...
            group(Inspectorate)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Inspectorate Remarks field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Inspected Date Time field.';
                }
            }
            group("Survey Department")
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Survey Remarks field.';
                }
                field("Survey Remarks By"; Rec."Survey Remarks By")
                {
                    ApplicationArea = Basic;
                    Caption = 'Surveyed Remarks By';
                    ToolTip = 'Specifies the value of the Surveyed Remarks By field.';
                }
                field("Survey Remarks Date Time Enter"; Rec."Survey Remarks Date Time Enter")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Survey Remarks Date Time Enter field.';
                }
            }
            group("Lab Section/Department")
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Lab Remarks field.';
                }
                field("Lab Remarks By"; Rec."Lab Remarks By")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Lab Remarks By field.';
                }
                field("Lab Remarks DateTime Entered"; Rec."Lab Remarks DateTime Entered")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Lab Remarks DateTime Entered field.';
                }
            }
            group("Resident Engineer's Remarks")
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the RE Remarks field.';
                }
                field("RE Remarks Datetime Entered"; Rec."RE Remarks Datetime Entered")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the RE Remarks Datetime Entered field.';
                }
                field("RE Remarks By"; Rec."RE Remarks By")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the RE Remarks By field.';
                }
                field(Inspected; Rec.Inspected)
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Inspected field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Measured field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Inspected But Not Approved field.';
                }
            }
        }
        area(FactBoxes)
    ...
    actions
    {
        area(navigation)
        {
            action("Attach Docs")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Attach Survey Quality Checks action.';
            ...
            action("Attach Docs2")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Attach Material Test Records action.';
