#pragma warning disable AA0005, AA0008, AL0603,AA0018, AA0021, AA0072, AA0137, AA0201, AA0206, AA0218, AA0228, AL0424, AW0006 // ForNAV settings
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Actual Unit Cost(LCY)"; Rec."Actual Unit Cost(LCY)")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Actual Unit Cost field.';
                }
                field("Actual Total Cost(LCY)"; Rec."Actual Total Cost(LCY)")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Actual Total Cost(LCY)(LCY) field.';
                }
                field("Trade-in Asset No"; Rec."Trade-in Asset No")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Trade-In Asset No field.';
                }
                field("Trade-in Asset Description"; Rec."Trade-in Asset Description")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Trade-In Asset Description field.';
                }
            }
        }
    }
