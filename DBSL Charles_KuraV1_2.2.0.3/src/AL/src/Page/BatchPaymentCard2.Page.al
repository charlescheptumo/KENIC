        ...
        area(creation)
        {
            group(ActionGroup14)
            {
                action("Generate Payment Lines")
                {
                    ...
                    PromotedIsBig = true;
                    ToolTip = 'Executes the Generate Payment Lines action.';

                    trigger OnAction()
                    begin
                        if Confirm('Do you want to generate Bank Payment Lines for Batch No. %1', false, Rec."Batch No") = false then exit;
                ...
                action("Generate Bank Payment File")
                {
                    ...
                    PromotedCategory = Category4;
                    PromotedIsBig = true;
                    ToolTip = 'Executes the Generate Bank Payment File action.';
