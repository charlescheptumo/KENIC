        ...
        area(navigation)
        {
            group("Function")
            {
                ...
                action("Send Approval Request")
                {
                    ...
                    begin
                        ...
                        if Rec.Status <> Rec.Status::Open then begin
                            ...
                            //if ApprovalsMgmt.CheckCopyRegApprovalsWorkflowEnabled(Rec) then
                            //  ApprovalsMgmt.OnSendCopyRegForApproval(Rec);
                        end
                    end;
                }
                action("Approval Request Entries")
                {
                    ...
                    begin
                        // ApprovalEntries.Setfilters(56022, entries."document type"::"Imprest Memo", "No.");s
                ...
                action("Cancel Approval Request")
                {
                    ...
                    begin
                        ...
                        Rec.TestField(Status, Rec.Status::Pending);//status must be open.
                        Rec.TestField("Captured by", UserId); //control so that only the initiator of the document can send for approval
                ...
                action("Submit Works")
                {
                    ...
                    begin
                        ...
                        if categoriesNoSetup.FindSet then begin
                            worksNo := NoSeriesMgt.GetNextNo(categoriesNoSetup."no series", WorkDate(), true);
