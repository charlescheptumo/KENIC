...
Page 72686 "Contr Staff Disengagements"
{
    ApplicationArea = Basic;
    CardPageID = "Contractor Staff Disengagement";
    DeleteAllowed = false;
    PageType = List;
    SourceTable = "WEP Contractor Submission";
    SourceTableView = where("Document Type" = filter("Contractor Staff Disengagement"));
    UsageCategory = Tasks;
