page 50007 "Administrator Role Center1"
{
    Caption = 'IT OFFICER';
    PageType = RoleCenter;
    ApplicationArea = All;
    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            //         ToolTip = 'Executes the Suggestion Box action.';
            //     }
            //     action("Submitted Suggestion Box")
            //     {
            //         ApplicationArea = Basic;
            //         RunObject = page "Submitted Suggestions Box";
            //         ToolTip = 'Executes the Submitted Suggestion Box action.';
            //     }
            //     action("Project Teams")
            //     {
            //         ApplicationArea = Basic;
            //         RunObject = page "Project Teams";
            //         ToolTip = 'Executes the Project Teams action.';
            //     }
            //     action("CIT Suggestion Reviews")
            //     {
            //         ApplicationArea = Basic;
            //         RunObject = page "CIT Suggestions Reviews";
            //         ToolTip = 'Executes the CIT Suggestion Reviews action.';
            //     }
            //     action("Approved CIT Suggestion Reviews")
            //     {
            //         ApplicationArea = Basic;
            //         RunObject = page "Approved CIT Suggestions Revie";
            //         ToolTip = 'Executes the Approved CIT Suggestion Reviews action.';
            //     }
            //     action("Posted CIT Suggestion Reviews")
            //     {
            //         ApplicationArea = Basic;
            //         RunObject = page "Posted CIT Suggestions Reviews";
            //         ToolTip = 'Executes the Posted CIT Suggestion Reviews action.';
            //     }
            //     action("Rejected Suggestions")
            //     {
            //         ApplicationArea = Basic;
            //         RunObject = page "Rejected Suggestions";
            //         ToolTip = 'Executes the Rejected Suggestions action.';
            //     }
            // }
            group(ICTHELPDESK)
            {
                Caption = 'ICT Help Desk';
                action("ICT Helpdesk Requests")
                {
                    ApplicationArea = Basic, Suite;
                    //  Caption = 'ICT Helpdesk Requests';
                    Image = ApprovalSetup;
                    RunObject = Page "ICT Helpdesk Request List";
                    ToolTip = 'Executes the ICT Helpdesk Requests action.';
                ...
                action("ICT Helpdesk Assign List")
                {
                    ...
                    Image = ApprovalSetup;
                    RunObject = Page
                    "ICT Helpdesk Assign List";
                    ToolTip = 'Executes the ICT Helpdesk Assign List action.';

                }
                action("ICT Delegation List")
                {
                    ApplicationArea = Basic, Suite;
                    // Caption = 'ICT Helpdesk Assign List';
                    Image = ApprovalSetup;
                    RunObject = Page "ICT Delegated List";
                    ToolTip = 'Executes the ICT Delegated List action.';

                }
                action("ICT Helpdesk Escalate List")
                {
                    ApplicationArea = Basic, Suite;
                    // Caption = 'ICT Helpdesk Requests';
                    Image = ApprovalSetup;
                    RunObject = Page "ICT Helpdesk Escalate List";
                    ToolTip = 'Executes the ICT Helpdesk Escalate List action.';

                }
                action("ICT Helpdesk Resolved")
                {
                    ApplicationArea = Basic, Suite;
                    // Caption = 'ICT Helpdesk Requests';
                    Image = ApprovalSetup;
                    RunObject = Page "ICT Helpdesk Resolved";
                    ToolTip = 'Executes the ICT Helpdesk Resolved action.';

                }

                action("ICT Helpdesk Attend List")
                {
                    ApplicationArea = Basic, Suite;
                    // Caption = 'ICT Helpdesk Requests';
                    Image = ApprovalSetup;
                    ...
                    ToolTip = 'Executes the ICT Helpdesk Attend List action.';

                }

                action("ICT HelpdeskAllocation")
                {
                    ApplicationArea = Basic, Suite;
                    Visible = false;
                    // Caption = 'ICT Helpdesk Requests';
                    Image = ApprovalSetup;
                    RunObject = Page "ICT HelpdeskAllocation";
                    ToolTip = 'Executes the ICT HelpdeskAllocation action.';

                }
                action("ICT Helpdesk Office Mapping")
                {
                    ApplicationArea = Basic, Suite;
                    // Caption = 'ICT Helpdesk Requests';
                    Image = ApprovalSetup;
                    RunObject = Page "ICT Helpdesk Office Mapping";
                    ToolTip = 'Executes the ICT Helpdesk Office Mapping action.';
                    Visible = false;

                }

                action("ICT Helpdesk View")
                {
                    ApplicationArea = Basic, Suite;
                    //Caption = 'ICT Helpdesk Requests';
                    Image = ApprovalSetup;
                    RunObject = Page "ICT Helpdesk View";
                    ToolTip = 'Executes the ICT Helpdesk View action.';

                }

                action("ICT Help Allocation Matrix")
                {
                    ApplicationArea = Basic, Suite;
                    // Caption = 'ICT Helpdesk Requests';
                    Image = ApprovalSetup;
                    Visible = false;
                    RunObject = Page "ICT Help Allocation Matrix";
                    ToolTip = 'Executes the ICT Help Allocation Matrix action.';

                }
                action("ICT Category List")
                {
                    ApplicationArea = Basic, Suite;
                    //  Caption = 'ICT Helpdesk Requests';
                    Image = ApprovalSetup;
                    RunObject = Page "ICT Category List";
                    ToolTip = 'Executes the ICT Category List action.';

                }

                action("ICT Helpdesk Setups")
                {
                    ApplicationArea = Basic, Suite;
                    // Caption = 'ICT Helpdesk Requests';
                    Image = ApprovalSetup;
                    RunObject = Page "ICT Helpdesk Setups";
                    ToolTip = 'Executes the ICT Helpdesk Setups action.';

                }

                action("ICT Helpdesk History List")
                {
                    ApplicationArea = Basic, Suite;
                    //  Caption = 'ICT Helpdesk Requests';
                    Image = ApprovalSetup;
                    RunObject = Page "ICT Helpdesk History List";
                    ToolTip = 'Executes the ICT Helpdesk History List action.';

                }
                group("ICT Reports")
                {
                    action("ICT Helpdesk All Issues")
                    {
                        ApplicationArea = Basic, Suite;
                        Image = Document;
                        RunObject = Report "ICT Helpdesk All Issues";
                        ToolTip = 'Executes the ICT Helpdesk All Issues action.';
                    }
                    action("Reopen & Resolved with Comment")
                    {
                        ApplicationArea = Basic, Suite;
                        Image = Document;
                        RunObject = Report "Reopen & Resolved With Comment";
                        ToolTip = 'Executes the Reopen & Resolved with Comment action.';
                    }
                }
            }
            group(ICTINVENTORY)
            {
                ...
                action("ICT Issuance Voucher")
                {
                    ...
                    Image = ApprovalSetup;
                    RunObject = Page
                    "ICT Issuance Vouchers";
                    ToolTip = 'Executes the ICT Issuance Voucher action.';

                }
                action("Permanent Issuance Vouchers")
                {
                    ApplicationArea = Basic, Suite;
                    // Caption = 'ICT Helpdesk Assign List';
                    Image = ApprovalSetup;
                    RunObject = Page
                    "Permanent Issuance Vouchers";
                    Visible = false;
                    ToolTip = 'Executes the Permanent Issuance Vouchers action.';
                }
        ...
        area(processing)
        {
            ...
            group("Con&tacts")
            {
                ...
                action("Task &Activities")
                {
                    ...
                    ToolTip = 'Executes the Task &Activities action.';
                }
            }
            separator(Action47)
            {
...
profile AdministratorRoleCenter1
{
    Caption = 'IT Officer';
    RoleCenter = "Administrator Role Center1";
    ProfileDescription = 'IT Officer';
}