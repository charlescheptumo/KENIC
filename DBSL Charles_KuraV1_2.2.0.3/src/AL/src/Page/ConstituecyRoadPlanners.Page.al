#pragma warning disable AA0005, AA0008, AA0018, AA0021, AA0072, AA0137, AA0201,AL0432, AA0206, AA0218, AA0228, AL0254, AL0424, AW0006 // ForNAV settings
Page 72324 "Constituecy Road Planners"
{
    AdditionalSearchTerms = 'capacity,job,project';
    ApplicationArea = Jobs;
    Caption = 'Constituecy Road Planners';
    CardPageID = "Constituency Road Planner Card";
    Editable = false;
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,Resource,Navigate';
    SourceTable = Resource;
    SourceTableView = where("Road Planner" = filter(true),
                            "Planning Level" = filter(Constituency));
    UsageCategory = Lists;
