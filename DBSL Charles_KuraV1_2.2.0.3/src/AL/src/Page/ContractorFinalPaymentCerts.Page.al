...
Page 72302 "Contractor Final Payment Certs"
{
    ApplicationArea = Basic;
    CardPageID = "Cont Final Payment Certificate";
    PageType = List;
    SourceTable = "Measurement &  Payment Header";
    SourceTableView = where("Document Type" = filter("Contractor Payment Request"),
                            "Payment Certificate Type" = filter("Final Payment"));
    UsageCategory = Tasks;
        ...
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Project ID"; Rec."Project ID")
                {
                    ...
                    trigger OnValidate()
                    begin
                        Rec.Description := 'Final Payment Request' + ' ' + Rec."Project ID";
                    end;
                }
