    ...
    actions
    {
        area(navigation)
        {
            action("Suggest Staff From Bid Response")
            {
                ...
                PromotedIsBig = true;
                ToolTip = 'Executes the Suggest Equipment From Bid Response action.';
            ...
            action("Repairs/Maintenance")
            {
                ...
                ToolTip = 'Executes the Repairs/Maintenance action.';
            }
            action("Contract Equipment Requirements")
            {
                ...
                PromotedCategory = Process;
                PromotedIsBig = true;
                ToolTip = 'Executes the Contract Equipment Requirements action.';
            ...
            action("Print Schedule Summary")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Print Schedule Summary action.';
