...
Page 72706 "Cost Claim"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Cost Claim Reason"; Rec."Cost Claim Reason")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Cost Claim Reason field.';
                }
            ...
            part(Control26; "Cost Claim Lines")
            {
        ...
        area(navigation)
        {
            ...
            action(Post)
            {
                ...
                begin
                    ...
                    //  RMSManagement.FnPostCostClaim(Rec);
                end;
            }
            action(Release)
            {
    ...
    begin
        Rec."Document Type" := Rec."document type"::"Cost Claim";
    end;
