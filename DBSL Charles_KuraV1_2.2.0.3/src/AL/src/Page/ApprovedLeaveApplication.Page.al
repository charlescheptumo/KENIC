            ...
            group("F&unctions")
            {
                ...
                action("&Post Leave Application")
                {
                    ...
                    begin
                        ...
                        // Rec.TestField(Posted, Rec.Posted = false);
                        ...
                        if HRLeaveApp.Find('-') then begin
                            ...
                            LeavePost.CreateLeaveLedgerEntries(Rec);
                        end;
                        //Robert---To notify leave applicant
                        if Confirm('Do you wish to notify the employee') = true then begin
                            ...
                            HREmp.TestField(HREmp."Company E-Mail");
                            EmailMSg.Create(HREmp."Company E-Mail", 'POSTED:LEAVE APPLICATION', 'Dear' + ' ' + HREmp."First Name" + ' ' + HREmp."Last Name" + ',<BR/>' + 'The leave application' + ' ' + HRLeaveApp."Application Code" +
                                                               ' ' + 'has been approved.<BR/>The expected return date is on' + ' ' + Format(HRLeaveApp."Return Date"), true);
