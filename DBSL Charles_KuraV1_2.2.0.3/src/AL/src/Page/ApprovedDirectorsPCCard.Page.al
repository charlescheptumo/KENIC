...
Page 80380 "Approved Directors PC Card"
{
    DeleteAllowed = false;
    InsertAllowed = false;
    ModifyAllowed = false;
        ...
        area(content)
        {
            ...
            group(Statistics)
            {
                field("No. of Departments' PCs"; Rec."No. of Departments' PCs")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    ToolTip = 'Specifies the value of the No. of Departments'' PCs field.';
                }
                field("No. of Principal Officers PCs"; Rec."No. of Principal Officers PCs")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the No. of Principal Officers PCs field.';
                }
                field("No. of Senior Officers PCs"; Rec."No. of Senior Officers PCs")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the No. of Senior Officers PCs field.';
                }
                field("No. of Staff PCs"; Rec."No. of Staff PCs")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    ToolTip = 'Specifies the value of the No. of Staff PCs field.';
                }
            }
            part("Objectives and Intiatives"; "Directors Workplan Initiatives")
            {
