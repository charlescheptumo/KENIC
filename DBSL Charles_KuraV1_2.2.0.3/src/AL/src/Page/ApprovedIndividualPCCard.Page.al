    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    Caption = 'Department/Center PC ID';
            ...
            part("Core Activities"; "Staff Workplan Initiatives")
            {
    ...
    actions
    {
        ...
        area(creation)
        {
            ...
            action("Print PC Report")
            {
                ...
                Visible = false;
                PromotedCategory = Category6;
                ToolTip = 'Executes the Print PC Report action.';

                trigger OnAction()
                begin
                    Rec.SetRange(No, Rec.No);
                    Report.Run(80020, true, true, Rec)
                end;
            }
        }
        area(processing)
