...
Page 72286 "Contractor Notice of Works"
{
    ApplicationArea = Basic;
    CardPageID = "Contractor Notice Of Work";
    PageType = List;
    SourceTable = "Measurement &  Payment Header";
    SourceTableView = where("Document Type" = filter("Contractor Notice of Works"));
    UsageCategory = Tasks;
    ...
    begin
        Rec."Document Type" := Rec."document type"::"Contractor Notice of Works";
    end;
}
