...
Page 95361 "Functional Disposal Plan"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Consolidate Disposal Plan"; Rec."Consolidate Disposal Plan")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Consolidate Disposal Plan field.';
                }
        ...
        area(navigation)
        {
            group("Procurement Plan")
            {
                ...
                action("Suggest Disposal Items")
                {
                    ...
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    ToolTip = 'Executes the Suggest Disposal Items action.';
                    ...
                    begin
                        ...
                        // FixedAsset.SETRANGE("Global Dimension 1 Code", Rec."Global Dimension 1 Code");
                        // FixedAsset.SETRANGE("Global Dimension 2 Code", Rec."Global Dimension 2 Code");
                        ...
                        END;
                        MESSAGE('Assets Suggested Successfully');
                        // Rec.TestField("Global Dimension 1 Code");
                        // Rec.TestField("Global Dimension 2 Code");
                        // FixedAsset.Reset;
                        // //  FixedAsset.SetRange("Suggested For Disposal", false);
                    ...
                    begin
                        ...
                        if DisposalPlanLines.FindSet then begin
                            repeat
                                ...
                                DisposalPlanLinesN."Disposal header" := Rec."Consolidate Disposal Plan";
                ...
                action(Print)
                {
                    ...
                    begin
                        ...
                        Report.Run(50043, true, true, Rec);
                    end;
                }
            }
        }
    ...
    begin
        Rec."Disposal Catetory" := Rec."disposal catetory"::"Functional Disposal";
    end;
