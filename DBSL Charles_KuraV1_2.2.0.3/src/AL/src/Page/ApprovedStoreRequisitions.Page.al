#pragma warning disable AA0005, AA0008, AA0018,AL0603, AA0021, AA0072, AA0137, AA0201, AA0206, AA0218, AA0228, AL0424, AW0006 // ForNAV settings
Page 50053 "Approved Store Requisitions"
{
    ...
    SourceTableView =
                      ...
                      where("Document Type" = filter("Store Requisition"),
                            Status = const(Released), "Fully Issued"
                             = filter(false));
    ApplicationArea = All;
                            ...
                            */
                            ...
                            if RequisitionLine.Find('-') then begin
                                repeat
                                    ...
                                    Rec.Validate(Rec."Budget Item");
                                    ItemGnl."Job Task No." := Rec."Job Task No.";
                                    Rec.Validate(Rec."Job Task No.");
