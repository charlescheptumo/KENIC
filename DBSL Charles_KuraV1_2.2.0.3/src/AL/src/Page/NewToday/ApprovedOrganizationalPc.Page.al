...
Page 80500 "Approved Organizational Pc"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Current Performance Contract"; Rec."Current Performance Contract")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Current Performance Contract field.', Comment = '%';
                }
            }
    ...
    actions
    {
        area(creation)
        {
            ...
            {
                ApplicationArea = Basic;
                Caption = 'Preview Perfomance Contract Report';
                Image = "Report";
                Promoted = true;
                PromotedCategory = "Report";
                PromotedIsBig = true;
                ToolTip = 'Executes the Preview Perfomance Contract Report action.';
                ...
                begin
                    ...
                    if AnnualStrategyWorkplan.FindFirst then
                        ...
                        Report.Run(50060, true, true, AnnualStrategyWorkplan);
                end;
            }
