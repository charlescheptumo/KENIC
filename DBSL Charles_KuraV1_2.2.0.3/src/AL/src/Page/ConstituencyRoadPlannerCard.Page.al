...
Page 72327 "Constituency Road Planner Card"
{
    Caption = 'Constituency Road Planner Card';
    PageType = Card;
    ...
    begin
        ...
        Rec."Road Planner" := true;
        Rec."Planning Level" := Rec."planning level"::Constituency;
    end;
