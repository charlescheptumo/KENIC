...
page 99993 "Doc. Attachment List Factbox1"
{
                ...
                field(Documents; NumberOfRecords)
                {
                    ...
                    begin
                        case Rec."Table ID" of
                            ...
                            DATABASE::"ICT Helpdesk":
                                begin
                                    RecRef.Open(DATABASE::"ICT Helpdesk");
                                    if ICT.Get(Rec."No.") then
                                        RecRef.GetTable(ICT);
                                end;
