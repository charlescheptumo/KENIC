...
Page 72621 "Checklist Status Report"
{
    // `
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Mobilization Checklist No"; Rec."Mobilization Checklist No")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Mobilization Checklist No field.';
                }
            ...
            part(Control16; "Checklist Status Report SubPag")
            {
        ...
        area(navigation)
        {
            ...
            action(Post)
            {
                ...
                begin
                    ...
                    //Update The Checklist from the Mobilization Table

                    // RMSManagement.FnUpdateMobilizationChecklist(Rec);
                    //
    ...
    begin
        Rec."Document Type" := Rec."document type"::"Mobilization Checklist Status Report";
    end;
