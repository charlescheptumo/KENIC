...
Page 75284 "Contract Card"
{
    ...
    DeleteAllowed = false;
    PromotedActionCategories = 'New,Process,Report,Contract,Request Approval,Print,Release,Navigate';
    ApplicationArea = All;
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Contract Description"; Rec.Description)
                {
                    ApplicationArea = Basic;
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Proffesion Opinion No field.';
                }
                ...
                field("Award Tender Sum Inc Taxes"; Rec."Award Tender Sum Inc Taxes")
                {
                    ...
                    Visible = false;
                    ToolTip = 'Specifies the value of the Award Tender Sum Inc Taxes (KES) field.';
                }
                field("Award Tender Sum Incl Taxes(FC"; Rec."Award Tender Sum Incl Taxes(FC")
                {
                    ...
                    Visible = false;
                    ToolTip = 'Specifies the value of the Award Tender Sum Incl Taxes(FCY) field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Total Invoiced field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Acceptance Letter Ref field.';
                }
                field("Acceptance Letter Date"; Rec."Acceptance Letter Date")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Acceptance Letter Date field.';
                }
            }
            ...
            group("Project Details")
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Variation of Price % field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Advance Payment Rate field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Upgrading Works Contract Sum field.';
                }
                field("PBRM Works Contract Sum"; Rec."PBRM Works Contract Sum")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the PBRM Works Contract Sum field.';
                }
                ...
                field("Max Works Kickoff Duration"; Rec."Max Works Kickoff Duration")
                {
                    ...
                    Editable = false;
                    Visible = false;
                    ToolTip = 'Specifies the value of the Works Commencement Order (After Contract/Order) field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Variation of Works % field.';
                }
                field("Variation of Works Amount"; Rec."Variation of Works Amount")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Variation of Works Amount field.';
                }
                field("Engineer Commencement Date"; Rec."Engineer Commencement Date")
                {
                    ApplicationArea = Basic;
                    Caption = 'Date of Engineer''s Order to Commence';
                    ToolTip = 'Specifies the value of the Date of Engineer''s Order to Commence field.';
                }
                ...
                field("Max Works Completion Duration"; Rec."Max Works Completion Duration")
                {
                    ...
                    Editable = true;
                    Visible = true;
                    ToolTip = 'Specifies the value of the Works Duration field.';
                }
        ...
        area(processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action("Contract Payment Terms")
                {
                    ...
                    RunPageLink = "No." = field("No.");
                    ToolTip = 'Executes the Contract Payments action.';
                }
                ...
                action("Contract Securities")
                {
                    ...
                    RunPageLink = "No." = field("No."),
                                  "Vendor No." = field("Buy-from Vendor No."),
                                  "IFS No" = field("IFS Code");
                    ToolTip = 'Executes the Guarantees action.';
                }
                ...
                action("Contract Signatories")
                {
                    ...
                    RunPageLink = "Document Type" = field("Document Type"),
                                  No = field("No.");
                    ToolTip = 'Executes the Contract Signatories action.';
                }
                action("Contract Circulation Team")
                {
                    ...
                    RunPageLink = "Document Type" = field("Document Type"),
                                  No = field("No.");
                    ToolTip = 'Executes the Contract Circulation Team action.';
                }
                ...
                action("Contract Renewal History")
                {
                    ApplicationArea = Basic;
                    Image = ContactReference;
                    Promoted = true;
                    PromotedCategory = Category4;
                    PromotedIsBig = true;
                    RunObject = Page "Contract Renewal History";
                    RunPageLink = "Contract No." = field("No.");
                    ToolTip = 'Executes the Contract Renewal History action.';
                }
                action("Notice of Award")
                {
                    ...
                    ToolTip = 'Executes the Notice of Award action.';
                }
                ...
                action("Evaluation Report")
                {
                    ...
                    ToolTip = 'Executes the Evaluation Report action.';
                }
                ...
                action("Renew Contract")
                {
                    ...
                    begin
                        ...
                        ContractRenewal.SetRange("Contract No.", Rec."No.");
                        ContractRenewal.SetRange("Current Contract Start Date", Rec."Contract Start Date");
                        ContractRenewal.SetRange("Current Contract End Date", Rec."Contract End Date");
                        if ContractRenewal.FindFirst() then
                            Page.Run(Page::"Contract Renewal", ContractRenewal)
                        else begin
                            ContractRenewal.init();
                            ContractRenewal.Validate("Contract No.", Rec."No.");
                            if ContractRenewal.insert(true) then
                                Page.Run(Page::"Contract Renewal", ContractRenewal);
                        end;
                    end;
                }
            ...
            action("Notify Contract Team")
            {
                ...
                PromotedCategory = Process;
                PromotedIsBig = true;
                ToolTip = 'Executes the Notify Contract Team action.';
            ...
            action("Generate Contract Document")
            {
                ...
                ToolTip = 'Executes the Generate Contract Document action.';
            ...
            action("Merge Contract Document")
            {
                ...
                Promoted = true;
                PromotedCategory = "Report";
                ToolTip = 'Executes the Merge Contract Document action.';
    ...
    local procedure SetSourceDocNoVisible()
    var
