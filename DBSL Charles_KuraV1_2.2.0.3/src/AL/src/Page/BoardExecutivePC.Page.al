    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Organizational PC"; Rec."Organizational PC")
                {
                    ToolTip = 'Specifies the value of the Organizational PC field.';
    ...
    actions
    {
        ...
        area(creation)
        {
            ...
            action("Performance Perspectives")
            {
                ...
                Visible = false;
                ToolTip = 'Executes the Performance Perspectives action.';
            }
            action("Suggest Objective Lines")
            {
                ...
                begin
                    ...
                    Rec.TestField("Organizational PC");
                    ...
                    BoardActivities.SetRange("AWP No", Rec."Organizational PC");
                    if BoardActivities.Find('-') then begin
                        repeat
                            ...
                            BoardSubActivities.SetRange("Workplan No.", Rec."Organizational PC");
                            ...
                            if BoardSubActivities.FindSet then begin
                                repeat
                                    ...
                                    PCSubActivities."Imported Annual Target Qty" := BoardSubActivities."Imported Annual Target Qty";
            ...
            action("Print Board PC")
            {
                ...
                Visible = false;
                ToolTip = 'Executes the Print Board PC action.';
            ...
            action("Individual PC-Sub Indicators")
            {
                ...
                Promoted = true;
                PromotedCategory = Category6;
                ToolTip = 'Executes the  PC-Sub Indicators action.';
