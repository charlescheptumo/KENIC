tableextension 50077 StandardSalesLineExt extends "Standard Sales Line"
{
    fields
    {
        ...
        field(50023; "Disposal Plan"; Code[250])
        {
            DataClassification = ToBeClassified;
        }
        field(50024; "Disposal Requisition No"; Code[250])
        {
            DataClassification = ToBeClassified;
        }
        field(50025; "Disposal Methods"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
        field(50026; "Disposal Item No"; Integer)
        {
            DataClassification = ToBeClassified;
        }
        field(50027; "Estimated current value"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
    }
