#pragma warning disable AA0005, AA0008, AA0018, AA0021, AA0072,AL0432, AA0137, AA0201, AA0206, AA0218, AA0228, AL0254, AL0424, AW0006 // ForNAV settings
#pragma implicitwith disable
Page 75468 "Bid Response Purch Lines"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Escalaleted Amount"; Rec."Escalaleted Amount")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Escalaleted Amount field.';
                }
    ...
    var
        ...
        Escalation: Record "Escalation Percentage";
