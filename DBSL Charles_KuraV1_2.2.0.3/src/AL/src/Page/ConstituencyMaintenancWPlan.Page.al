...
Page 72344 "Constituency Maintenanc W_Plan"
{
            ...
            group(ActionGroup5)
            {
                ...
                action("Suggest Lines")
                {
                    ...
                    begin
                        ...
                        NewRoadWorkProgramPackage.SetRange(NewRoadWorkProgramPackage."Region ID", Rec."Region ID");
                        if NewRoadWorkProgramPackage.FindSet then begin
                            repeat
                                ...
                                RoadPackage."VAT Bus. Posting Group" := Rec."VAT Bus. Posting Group";
                                RoadPackage.Validate("VAT Bus. Posting Group");
                                RoadPackage."VAT Prod. Posting Group" := Rec."VAT Prod. Posting Group";
                ...
                action("Post(+F9)")
                {
                    ...
                    PromotedIsBig = true;
                    PromotedOnly = true;
                    ToolTip = 'Executes the Post(+F9) action.';
    ...
    begin
        ...
        if Rec."Planning Level" = Rec."planning level"::Regional then begin
