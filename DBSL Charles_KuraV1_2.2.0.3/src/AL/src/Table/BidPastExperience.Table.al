...
Table 70162 "Bid Past Experience"
{
    ...
    fields
    {
        ...
        field(39; "Type of Engagement"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ',Main Contractor,Assignee,Sub Contractor';
            OptionMembers = ,"Main Contractor",Assignee,"Sub Contractor";
        }
        field(40; "Primary Contractor"; Code[150])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    // fieldgroups
    // {
    //     // fieldgroup(DropDown;"Document Type","No.",Field5050,City,Field91,"Phone No.")
    //     // {
    //     // }
    //     // fieldgroup(Brick;"Document Type","No.",Field5050,City,"Phone No.",Field140)
    //     // {
    //     // }
    // }
