#pragma warning disable AA0005, AA0008,AL0603, AA0018, AA0021, AA0072, AA0137,AL0432, AA0201, AA0206, AA0218, AA0228, AL0254, AL0424, AW0006 // ForNAV settings
Table 72269 "Contractor Request Plan Line"
{
    Caption = 'Contractor Payment Request Planning Line';
    DrillDownPageID = "Contractor Request Plan Lines";
    LookupPageID = "Contractor Request Plan Lines";
    ...
    fields
    {
        ...
        {
            Caption = 'Line No.';
            Description = '"Job Planning Line"."Line No." WHERE (Job No.=FIELD(Job No.),Job Task No.=FIELD(Job Task No.))';
            Editable = true;
            ...
            begin
                ...
                if JobPlanningLine.FindSet then begin
                    "Line Type" := JobPlanningLine."Line Type";
                    ...
                    Validate("Unit Cost");
                    "Direct Unit Cost (LCY)" := JobPlanningLine."Direct Unit Cost (LCY)";
        ...
        field(1000; "Job Task No."; Code[20])
        {
            Caption = 'Job Task No.';
            NotBlank = true;
            TableRelation = "Contractor Request Task"."Job Task No.";
        }
        ...
        field(1002; "Unit Cost"; Decimal)
        {
            ...
            begin
                ...
                UpdateAllAmounts;
                //if "Qty. to Order" <> 0 then
                // Validate("Qty. to Order");
            end;
        }
        ...
        field(1042; "Description 2"; Text[400])
        {
        ...
        field(56029; "Qty. to Order"; Decimal)
        {
            ...
            begin
                ...
                if "Qty. to Order" > 0 then
                    // "Total Cost Incl. VAT" := "Unit Cost" * "Qty. to Order";
                    "Total Cost Excl. VAT" := "Unit Cost" * "Qty. to Order";
                UpdateAllAmounts();
        ...
        field(72009; "Total Cost Excl. VAT"; Decimal)
        {
            DecimalPlaces = 0 : 15;
            Editable = false;
        }
        field(72010; "Qty Certified To Date"; Decimal)
        {

        }
        field(72011; "Total Cost Including VAT"; Decimal)
        {
    ...
    begin
        ...
        MeasurementPaymentHeader.Reset;
        MeasurementPaymentHeader.SetRange("Document No.", "Document No.");
    ...
    begin
        ...
        Rec.Validate("VAT Bus. Posting Group");
        "Total Cost Including VAT" := "Total Cost Incl. VAT" * "Qty. to Order";
        if Type = Type::Text then
            FieldError(Type);
    end;
    ...
    begin
        Page.RunModal(page::"Order Tracking", JobPlanningLine);
    end;
