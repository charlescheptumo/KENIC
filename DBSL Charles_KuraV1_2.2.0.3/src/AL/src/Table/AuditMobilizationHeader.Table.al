...
Table 95209 "Audit Mobilization Header"
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = "Audit Mobilization Header"."Document No." where("Document Type" = filter("Auditee Notice Response"));
        }
        field(6; "Entrace Meeting No."; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Audit Mobilization Header"."Document No." where("Document Type" = filter("Audit Entrace Meeting"));
        }
        ...
        if "Document No." = '' then begin
            if "Document Type" = "document type"::"Audit Commencement Notice" then begin
                ...
                AuditAssuranceSetup.TestField("Audit Commencement Notice Nos.");
                  "Document No." := NoSeriesManagement.GetNextNo(AuditAssuranceSetup."Audit Commencement Notice Nos.", WorkDate(), true);
        ...
        if "Document No." = '' then begin
            if "Document Type" = "document type"::"Audit Entrace Meeting" then begin
                ...
                AuditAssuranceSetup.TestField("Audit Entrace Meeting Nos.");
                  "Document No." := NoSeriesManagement.GetNextNo(AuditAssuranceSetup."Audit Entrace Meeting Nos.", WorkDate(), true);
        ...
        if "Document No." = '' then begin
            if "Document Type" = "document type"::"Auditee Notice Response" then begin
                ...
                AuditAssuranceSetup.TestField("Auditee Notice Response Nos.");
                  "Document No." := NoSeriesManagement.GetNextNo(AuditAssuranceSetup."Auditee Notice Response Nos.", WorkDate(), true);
        ...
        if "Document No." = '' then begin
            if "Document Type" = "document type"::"Pre-Audit Survey Responses" then begin
                ...
                AuditAssuranceSetup.TestField("PreAudit Survey Response Nos.");
                  "Document No." := NoSeriesManagement.GetNextNo(AuditAssuranceSetup."PreAudit Survey Response Nos.", WorkDate(), true);
        ...
        if "Document No." = '' then begin
            if "Document Type" = "document type"::"Pre-Audit Survey Invitations" then begin
                ...
                AuditAssuranceSetup.TestField("PreAudit Survey InvitationNos.");
                  "Document No." := NoSeriesManagement.GetNextNo(AuditAssuranceSetup."PreAudit Survey InvitationNos.", WorkDate(), true);
