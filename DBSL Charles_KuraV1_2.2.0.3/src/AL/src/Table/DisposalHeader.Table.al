        ...
        field(18; "Disposal Plan"; Code[20])
        {
            ...
            begin
                ...
                if DisposalLines.FindSet then begin
                    ...
                    DisposalPlanLines.SetRange("Disposal header", "Disposal Plan");
                    if DisposalPlanLines.FindSet then begin
                        repeat
                            DisposalLines.Type := DisposalPlanLines.Type;
                            // DisposalLines."Disposal Item No" := DisposalPlanLines."Line No.";
                            DisposalLines."Fixed Asset/Item No." := DisposalPlanLines."Item No.";
                            DisposalLines."Unit of Issue" := DisposalPlanLines."Item No.";
                            DisposalLines.Quantity := DisposalPlanLines.Quantity;
                            DisposalLines."Estimated current value" := DisposalPlanLines."Estimated current value";
                            DisposalLines."Description of Item" := DisposalPlanLines."Description of Item";
                            DisposalLines."Disposal Type" := DisposalPlanLines."Disposal Type";
                            DisposalLines."Disposal Methods" := DisposalPlanLines."Disposal Methods";
                            DisposalLines.Modify;
                        // DisposalLines.Location := DisposalPlanLines.Location;
    ...
    begin
        if No = '' then begin
            ...
            ProcurementSetup.TestField("Disposal Requisition Nos");
             No:= NoMgt.GetNextNo(ProcurementSetup."Disposal Requisition Nos", WorkDate(), true);
