    ...
    fields
    {
        ...
        field(3; "Vacancy ID"; Code[30])
        {
            ...
            begin
                ...
                //     repeat
                //         "Application No." := JobApplications."Application No.";
        ...
        {
            DataClassification = ToBeClassified;
            OptionCaption = ' ,Non-Responsive,Invite for Interview';
        ...
        field(30; "Highest Academic Qualification"; Code[30])
        {
            ...
            trigger OnValidate()
            var
                Qualifc: Record Qualification;
            begin
                if Qualifc.Get("Highest Academic Qualification") then begin
                    "Qualification Name" := Qualifc.Description;
                end;
            end;
        }
