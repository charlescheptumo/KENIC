    ...
    begin
        ...
        if "Document No." = '' then begin
            if "Document Type" = "document type"::"Implementation Status Report" then begin
                ...
                "Document No." := NoSeriesManagement.GetNextNo(AuditAssuranceSetup."Audit Implementation Log Nos", WorkDate(), true);
        ...
        if "Document No." = '' then begin
            if "Document Type" = "document type"::"Followup Audit Voucher" then begin
                ...
                "Document No." := NoSeriesManagement.GetNextNo(AuditAssuranceSetup."Follow-up Audit Voucher  Nos", WorkDate(), true);
