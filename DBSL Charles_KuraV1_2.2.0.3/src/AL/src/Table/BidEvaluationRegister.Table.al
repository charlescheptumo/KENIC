...
Table 70178 "Bid Evaluation Register"
{
    ...
    fields
    {
        ...
        field(4; "Evaluation Lead"; Code[20])
        {
            ...
            begin
                Resource.Reset();
                Resource.SetRange("No.", "Evaluation Lead");
                if Resource.Find('-') then begin
                    "Evaluation Lead Name" := Resource.Name;
                end
            end;
        }
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = "Standard Purchase Code".Code;//where ("Requesting Region"=field("Primary Region"));
    ...
    begin
        if Code = '' then begin
            ...
            ProcurementSetup.TestField("Bid Opening Nos");
                code:= NoMgt.GetNextNo(ProcurementSetup."Bid Opening Nos", WorkDate(), true);
