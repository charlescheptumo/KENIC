    ...
    fields
    {
        ...
        field(20; "Corrective Order No"; Code[20])
        {
            ...
            begin
                ...
                if CorrectiveOrderLine.FindSet then begin
                    repeat
    ...
    begin
        if "Order No" = '' then begin
            if "Document Type" = "document type"::"Corrective Order" then begin
                ...
                "Order No":= NoSeriesManagement.GetNextNo(RoadManagementSetup."Corrective Order Nos", WorkDate(), true);
        ...
        if "Order No" = '' then begin
            if "Document Type" = "document type"::"Corrective Order Action" then begin
                ...
                RoadManagementSetup.TestField("Corrective Order Response Nos");
                  "Order No":= NoSeriesManagement.GetNextNo(RoadManagementSetup."Corrective Order Response Nos", WorkDate(), true);
