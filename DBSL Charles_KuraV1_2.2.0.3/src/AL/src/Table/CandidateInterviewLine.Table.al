...
{
    LookupPageId = "Interview Lines";
    DrillDownPageId = "Interview Lines";
    ...
    fields
    {
        ...
        field(48; "Average Interview Score"; Decimal)
        {
            CalcFormula = average("Candidate Interview Line"."Interview Panel Score %" where("Document No." = field("Document No.")));
            FieldClass = FlowField;
            Editable = false;
        }
        field(49; "Panel Member No."; Code[50])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    keys
    {
        key(Key1; "Document Type", "Document No.", "Application No.", "Source Document No.", "Assigned Panel ID", "Line No", "Panel Member No.")
        {
            Clustered = true;
        }
    }
