...
Table 57004 "Cash Management Setup"
{
    ...
    fields
    {
        ...
        field(57051; "Petty Cash Limit"; Decimal)
        {
        }
        field(57052; "PV File Numbering"; Code[20])
        {
            TableRelation = "No. Series";

        }
        field(57053; "Recommendation No."; code[20])
        {
            TableRelation = "No. Series";

        }
        field(57054; "Meeting Nos."; code[20])
        {
            TableRelation = "No. Series";

            DataClassification = ToBeClassified;
        }
        field(57055; "Salary Advance Memo No"; Code[250])
        {
            TableRelation = "No. Series";
        }
        field(57056; "Cheque Nos"; Code[50])
        {
            TableRelation = "No. Series";
        }
        field(57057; "Batch Imprest Voucher Nos"; Code[20])
        {
        ...
        field(57061; "StandingImprest Posting Group"; Code[20])
        {
