...
Table 57011 "Casuals"
{
    ...
    begin
        ...
        if ImprestMemo.findfirst() then begin
            ...
            "Budgeted Amount" := CustomFunction.GetBudgtedAmount("G/L Account", ImprestMemo."Shortcut Dimension 1 Code", ImprestMemo."Shortcut Dimension 1 Code", ImprestMemo."Shortcut Dimension 3 Code");
            "Account Actual Spent" := CustomFunction.GetActualSpent("G/L Account", ImprestMemo."Shortcut Dimension 1 Code", ImprestMemo."Shortcut Dimension 1 Code", ImprestMemo."Shortcut Dimension 3 Code");
            "Committed Amount" := CustomFunction.GetCommittedAmount("G/L Account", CustomFunction.GetBudgetYear(ImprestMemo.Date), ImprestMemo."Shortcut Dimension 1 Code", ImprestMemo."Shortcut Dimension 1 Code", ImprestMemo."Shortcut Dimension 3 Code");
