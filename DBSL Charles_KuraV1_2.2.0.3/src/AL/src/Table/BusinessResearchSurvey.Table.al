...
Table 80217 "Business Research Survey"
{
    ...
    fields
    {
        ...
        field(20; "Published By"; Code[100])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    begin
        if "Business Research Category" = "business research category"::"Employee Experience" then begin
            if "Document No." = '' then begin
                ...
                rec."Document No." := NoSeriesMgt.GetNextNo(BRInnovationSetup."Employee Survey No. Series", WorkDate(), true);
            end;
        end;
        ...
        if "Business Research Category" = "business research category"::"Customer Experience" then begin
            if "Document No." = '' then begin
                ...
                rec."Document No." := NoSeriesMgt.GetNextNo(BRInnovationSetup."Customer Survey No. Series", WorkDate(), true);
            end;
        end;
        ...
        if "Business Research Category" = "business research category"::"Post-Project Survey" then begin
            if "Document No." = '' then begin
                ...
                rec."Document No." := NoSeriesMgt.GetNextNo(BRInnovationSetup."Post-Project Survey No. Series", WorkDate(), true);
            end;
        end;
        ...
        if "Business Research Category" = "business research category"::"Custom Survey" then begin
            if "Document No." = '' then begin
                ...
                rec."Document No." := NoSeriesMgt.GetNextNo(BRInnovationSetup."Custom Surveys No. Series", WorkDate(), true);
            end;
        end;
