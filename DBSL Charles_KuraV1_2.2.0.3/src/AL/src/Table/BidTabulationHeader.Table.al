...
{
    DrillDownPageID = "Proffesion Opinion Card";
    LookupPageID = "Proffesion Opinion Card";
    ...
    fields
    {
        ...
        field(46; "General Procurement Remarks"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        ...
        {
            CalcFormula = count("Standard Vendor Purchase Code" where("IFS Code" = field("IFS Code"),
        ...
        field(57; "Procurement Method"; Code[50])
        {
            DataClassification = ToBeClassified;
        ...
        field(68; "Bid Evaluation Criteria"; Code[50])
        {
            DataClassification = ToBeClassified;
        }
        field(69; "No of Responsive(Preliminary)"; Integer)
        {
            CalcFormula = count("Standard Vendor Purchase Code" where("IFS Code" = field("IFS Code"),
                                                                       "Passed Preliminary  Evaluation" = const(true)));
            FieldClass = FlowField;
            Editable = false;
        }
        field(70; "No of non- Responsive(Prelim)"; Integer)
        {
            CalcFormula = count("Standard Vendor Purchase Code" where("IFS Code" = field("IFS Code"),
                                                                       "Passed Preliminary  Evaluation" = const(false)));
            Editable = false;
            FieldClass = FlowField;
        }
        field(71; "Appeal Date"; DateTime)
        {
            DataClassification = ToBeClassified;
        }
        field(72; "Last Evaluation Version No."; Integer)
        {
            Editable = false;
        }
        field(73; "Head Of Procurement Remarks"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(74; "New Venue"; Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(75; "New Evaluation Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(76; "New Evaluation Time"; Time)
        {
            DataClassification = ToBeClassified;
        }
        field(77; "Program Title"; Text[1000])
        {
            DataClassification = ToBeClassified;
        }
        field(78; "Executive Summary"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(79; "Location of Project"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(80; "Extent of Contract"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(81; "Invitation to Tender"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(82; "Prebid Site Visit & Meeting"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(83; "Bid Notices"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(84; "Notify Chairman"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(85; "Chairmans Comments"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(86; "Directorate ID"; Code[10])
        {
            CalcFormula = lookup("Standard Purchase Code"."Directorate Code" where(Code = field("IFS Code")));
            FieldClass = FlowField;
            Editable = false;
        }
    }
    ...
    begin
        if Code = '' then begin
            ...
            if "Document Type" = "document type"::"Evaluation Report" then begin
                ProcurementSetup.TestField("Final Evaluation Report Nos");
                   Code := NoMgt.GetNextNo(ProcurementSetup."Final Evaluation Report Nos", WorkDate(), true);
              //  NoMgt.InitSeries(ProcurementSetup."Final Evaluation Report Nos", xRec."No. Series", 0D, Code, "No. Series");
            end;
            if "Document Type" = "document type"::"Professional Opinion" then begin
                ProcurementSetup.TestField("Proffesional Opinion Nos");
                 Code := NoMgt.GetNextNo(ProcurementSetup."Proffesional Opinion Nos", WorkDate(), true);
             //   NoMgt.InitSeries(ProcurementSetup."Proffesional Opinion Nos", xRec."No. Series", 0D, Code, "No. Series");
            end;
            if "Document Type" = "document type"::"Notice of Award" then begin
                ProcurementSetup.TestField("Notice of Award");
                        Code := NoMgt.GetNextNo(ProcurementSetup."Notice of Award", WorkDate(), true);
        ...
        if UserSetup.FindFirst() then
            "Primary Region" := UserSetup."Responsibility Center";
    end;
