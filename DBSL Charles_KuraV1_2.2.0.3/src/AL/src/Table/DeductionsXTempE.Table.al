...
Table 69073 "DeductionsX Temp-E"
{
    DataCaptionFields = "Code", Description;
    DrillDownPageID = "Deductions Temp";
    LookupPageID = "Deductions Temp";
    ...
    fields
    {
        ...
        {
            CalcFormula = sum("Assignment Matrix-X Temp-E".Amount where(Type = const(Deduction),
                                                                         Code = field(Code),
        ...
        {
            FieldClass = FlowFilter;
            TableRelation = "Payroll PeriodXT";
        }
        ...
        {
            CalcFormula = sum("Assignment Matrix-X Temp-E"."Employer Amount" where(Type = const(Deduction),
                                                                                    Code = field(Code),
                                                                                    "Payroll Period" = field("Pay Period Filter"),
                                                                                    "Posting Group Filter" = field("Posting Group Filter"),
                                                                                    "Department Code" = field("Department Filter"),
        ...
        field(73; "ResponsibilityCtr Filter"; Code[20])
        {
            FieldClass = FlowFilter;
        ...
        {
            CalcFormula = sum("Assignment Matrix-X Temp-E"."Closing Balance" where(Type = const(Deduction),
                                                                                    Code = field(Code),
                                                                                    "Posting Group Filter" = field("Posting Group Filter"),
                                                                                    "Payroll Period" = field("Pay Period Filter"),
                                                                                    "Employee No" = field("Employee Filter"),
        ...
        {
            CalcFormula = sum("Assignment Matrix-X Temp-E"."Closing Balance Company" where(Type = const(Deduction),
                                                                                            Code = field(Code),
                                                                                            "Payroll Period" = field("Pay Period Filter"),
                                                                                            "Posting Group Filter" = field("Posting Group Filter"),
                                                                                            "Department Code" = field("Department Filter"),
