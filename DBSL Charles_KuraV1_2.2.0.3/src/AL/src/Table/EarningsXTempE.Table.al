...
Table 69072 "EarningsX Temp-E"
{
    DataCaptionFields = "Code", Description;
    DrillDownPageID = "Earnings Temp";
    LookupPageID = "Earnings Temp";
    ...
    fields
    {
        ...
        field(53; "Payroll Grouping Filter"; Code[10])
        {
            Editable = false;
            FieldClass = FlowFilter;
        ...
        field(56; "ResponsibilityCtr Filter"; Code[20])
        {
            FieldClass = FlowFilter;
            TableRelation = "Responsibility Center";
        }
    ...
    var
        AssignmentMat: Record "Assignment Matrix-X Temp-E";
}
