...
Table 70158 "Bid Business Owner"
{
    ...
    fieldgroups
    {
        // fieldgroup(DropDown;"Document Type","Entry No.",Field5050,City,Field91,"Phone No.")
        // {
        // }
        // fieldgroup(Brick;"Document Type","Entry No.",Field5050,City,"Phone No.",Field140)
        // {
        // }
    }
