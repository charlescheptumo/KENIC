        ...
        field(14; "Score %"; Decimal)
        {
            ...
            begin
                if "Score %" > 0 then begin
                    ...
                    BidRegister.Reset();
                    BidRegister.SetRange(Code, Rec.Code);
                    if BidRegister.FindFirst() then begin
                        BidRegister."Technical Evaluation  Decision" := BidRegister."Technical Evaluation  Decision"::Pass;
                        BidRegister.Modify();
                    end;
                end else begin
                    ...
                    BidRegister.SetRange(Code, Rec.Code);
                    if BidRegister.FindFirst() then begin
                        BidRegister."Technical Evaluation  Decision" := BidRegister."Technical Evaluation  Decision"::Fail;
                        BidRegister.Modify();
                    end;
                end;
            end;
