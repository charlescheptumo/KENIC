...
Table 72376 "Custom Approval Entry"
{
    Caption = 'Custom Approval Entry';
    //DrillDownPageID = "Project Requests to Approve";
    // LookupPageID = "Project Requests to Approve";
    ...
    fields
    {
        ...
        field(9; Status; Option)
        {
            ...
            begin
                ...
                if "Document Type" = "document type"::"Driver Out Of Office Req" then begin
        ...
        field(41; "Project Name"; Text[2048])
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(42; "Project Document Type"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
    }
