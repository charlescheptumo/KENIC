codeunit 50019 EnumAssignMentManagementCustom
{
    trigger OnRun()
    begin
    end;
    ...
    begin
        case SalesDocumentType of
            ...
            SalesDocumentType::"Purchase Requisition":
                exit(ApprovalDocumentType::"Purchase Requisition");
            SalesDocumentType::"Store Requisition":
                exit(ApprovalDocumentType::"Store Requisition");
            else begin
                IsHandled := false;
    ...
    procedure GetPurchApprovalDocumentType1(PurchDocumentType: Enum "Purchase Document Type") ApprovalDocumentType: Enum "Approval Document Type"
    var
        IsHandled: Boolean;
    begin
        case PurchDocumentType of
            ...
            PurchDocumentType::"Store Requisition":
                exit(ApprovalDocumentType::"Store Requisition");
            PurchDocumentType::"Meals Requisition":
                exit(ApprovalDocumentType::"Meals Requisition");
            else begin
                IsHandled := false;
