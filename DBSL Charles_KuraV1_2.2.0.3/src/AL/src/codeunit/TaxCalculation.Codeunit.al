...
Codeunit 57004 "Tax Calculation"
{
    ...
    procedure CalculateTax(Rec: Record "PV Lines"; CalculationType: Option VAT,"W/Tax",Retention,PAYE,PPRA) Amount: Decimal
    begin
        ...
        case CalculationType of
            ...
            Calculationtype::PPRA:
                begin
                    Amount := ((Rec.Amount - Rec."VAT Amount") * (Rec."PPRA Percentage Amount" / 100));
                    Amount := RoundUpToAmount(Amount);
                end;
    ...
    procedure RoundUpToAmount(RoundedAmount: Decimal): Decimal
    var
    begin
        exit(ROUND(RoundedAmount, 1, '>'));
    end;
}
