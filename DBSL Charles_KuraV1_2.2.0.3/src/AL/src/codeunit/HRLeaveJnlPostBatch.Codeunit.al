...
Codeunit 69012 "HR Leave Jnl.-Post Batch"
{
    ...
    begin
        ...
        // Save primary number series
        if InsuranceJnlBatch."No. Series" <> '' then
            NoSeriesMgt.GetNextNo(InsuranceJnlBatch."No. Series", WorkDate(), true);

        // Save additional posting series if any
        ...
        // Commit if posting transaction finalized
        Commit();
