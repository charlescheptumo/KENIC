...

{
    ...
    begin
        ...
        if userSetup."Portal User" then
            ...
            if GuiAllowed then begin
                if not Confirm('Are you Sure you want to Reject this Document?', true) then
                    exit;
            end;
        end;
    end;
        ...
        CASE RecRef.NUMBER OF
                    ...
                    Case payments."Payment Type" of
                        payments."Payment Type"::"Imprest Surrender":
                            begin
                                ...
                                IF Payments.currency <> '' then begin
                                    ...
                                    ApprovalEntryArgument."Employee No." := payments."Account No.";
                                    ApprovalEntryArgument."Employee Name" := payments."Account Name";
                        ...
                        payments."Payment Type"::Imprest:
                            begin
                                ...
                                ApprovalEntryArgument.Amount := payments."Imprest Amount";
                                IF Payments.currency <> '' then begin
                                    ApprovalEntryArgument."Document Type" := ApprovalEntryArgument."Document Type"::"Imprest Requisition";
                                    ApprovalEntryArgument."Employee No." := payments."Account No.";
                                    ApprovalEntryArgument."Employee Name" := payments."Account Name";
                                    ApprovalEntryArgument."Amount (LCY)" := CurrExchRate.ExchangeAmtFCYToLCY(payments.Date, payments.Currency, payments."Imprest Amount", CurrExchRate.ExchangeRate(payments.Date, payments.Currency))
                                end
            ...
            DATABASE::"Purchase Header":
                BEGIN
                    ...
                    ApprovalEntryArgument."Employee No." := PurchaseHeader."Request-By No.";
                    ApprovalEntryArgument."Employee Name" := PurchaseHeader."Request-By Name";
                    ApprovalEntryArgument.Amount := PurchaseHeader."Amount Including VAT";
                END;
            //sales headear
            ...
            Database::"Staff Exit":
                begin
                    ...
                    ApprovalEntryArgument."Document No." := StaffExit."No.";
                end;
            Database::"Staff Exit Clearance Header":
                begin
                    RecRef.SetTable(ExitClearanceHeader);
                    ApprovalEntryArgument."Document No." := ExitClearanceHeader."Document No.";
                end;
            Database::"Fuel & Maintenance Requisition":
                begin
                    RecRef.SetTable(FuelMaintenanceRequisition);
                    ApprovalEntryArgument."Document No." := FuelMaintenanceRequisition."Requisition No";

                    case FuelMaintenanceRequisition.Type of
                        FuelMaintenanceRequisition.Type::Fuel:
                            ApprovalEntryArgument."Document Type" := ApprovalEntryArgument."Document Type"::FuelReq;
                        FuelMaintenanceRequisition.Type::Maintenance:
                            ApprovalEntryArgument."Document Type" := ApprovalEntryArgument."Document Type"::"Maintenance Requisition";
                    end;
                end;
        END;
    ...
    local procedure "Approvals Mgmt._OnBeforeMakeApprovalEntry"(var ApprovalEntry: Record "Approval Entry"; ApprovalEntryArgument: Record "Approval Entry"; WorkflowStepArgument: Record "Workflow Step Argument"; ApproverId: Code[50]; var IsHandled: Boolean)
    begin
