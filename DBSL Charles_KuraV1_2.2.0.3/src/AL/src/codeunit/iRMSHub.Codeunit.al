    ...
    begin
        ...
        if tbl_portalUser.findset(true) then begin
            ...
            if tbl_portalUser.modify(true) then begin
                ...
                status := 'danger*System error when modifying your password. Kindly try again! Contact ADAK IT administrator if this error persists.'
            end;
        end else begin
    ...
    begin
        ...
        if PortalUsers.FindSet() then begin
            repeat
                ...
                VarAll.AddText('::::' + PortalUsers."Full Name" + '* ' + Format(PortalUsers."User Name") + '* ' + PortalUsers."Mobile Phone No." + '* ' +
                Format(PortalUsers.State) + '* ' + PortalUsers."Authentication Email" + '* ' + '* ' + PortalUsers."Record ID");
        ...
        if purchaseheader.FindSet() then begin
            repeat
               ...
               purchaseheader."Contract Description" + '* ' + Format(purchaseheader."Works Length (Km)") + '* ' + Format(purchaseheader."Contract Start Date") + '* ' +
                ...
                Format(purchaseheader."Upgrading Works Contract Sum") + '* ' + Format(purchaseheader."Contract Sum") + '* ' + Format(purchaseheader."Advance Payment Rate"));
