...
Table 69435 "Safety Equipment Register"
{
    ...
    fields
    {
        field(1; "Equipment ID"; Code[20])
        {
            ...
            trigger OnValidate()
            var
                SafetyEquimentRegisterLines: Record "Safety Equiment Register Lines";
            begin
                SafetyEquimentRegisterLines.Reset();
                SafetyEquimentRegisterLines.SetRange("Equipment ID", "Equipment ID");
                if not SafetyEquimentRegisterLines.find('-') then begin
                    SafetyEquimentRegisterLines."Equipment ID" := "Equipment ID";
                end
            end;
        }
        ...
        field(3; "SubType No."; Code[20])
        {
            ...
            begin
                if SubType = Subtype::"Fixed Asset" then begin
                    ...
                    "Maintenance Date" := FixedAssets."Warranty Date";
        ...
        field(13; "Maintenance Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(15; "Maintenance Type"; Option)
        {
