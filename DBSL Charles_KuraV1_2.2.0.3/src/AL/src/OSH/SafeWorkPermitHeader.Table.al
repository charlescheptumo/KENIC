...
Table 69441 "Safe Work Permit Header"
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = "Responsibility Center".Code where("Operating Unit Type" = filter(Region), "Blocked" = const(false));
        }
        ...
        if "Document Type" = "document type"::"Safe Work Permit Application" then begin
            if "Document No." = '' then begin
                ...
                HealthSafetySetup.TestField("Safe Work Permit Apps Nos.");
                      "Document No." := NoSeriesManagement.GetNextNo(HealthSafetySetup."Safe Work Permit Apps Nos.",WorkDate(),true);
        ...
        if "Document Type" = "document type"::"Safe Work Completion Report" then begin
            if "Document No." = '' then begin
                ...
                HealthSafetySetup.TestField("Safe Work Compln Report Nos.");
                   "Document No." := NoSeriesManagement.GetNextNo(HealthSafetySetup."Safe Work Compln Report Nos.",WorkDate(),true);
