...
Table 69436 "Emergency Drill Log"
{
    ...
    fields
    {
        ...
        field(11; "Overall Drill Manager ID"; Code[20])
        {
            ...
            begin
                Resource.Reset();
                Resource.SetRange("No.", "Overall Drill Manager ID");
                if Resource.find('-') then begin
                    "Overall Drill Manager Name" := Resource.Name;
                    "Overall Drill Manager Email" := Resource.Email;
                end
            end;
        }
        ...
        field(39; "Overall Drill Manager Name"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
        field(40; "Overall Drill Manager Email"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
        field(41; "Areas of Improvement"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    begin
        if "Drill ID" = '' then begin
            ...
            "Drill ID" := NoSeriesManagement.GetNextNo(HealthSafetySetup."Emergency Drill Report Nos.",WorkDate(),true);
