...
#pragma warning restore AL0254
            ...
            dataitem("Payroll PeriodX"; "Payroll PeriodX")
            {
                ...
                column(AffordableHousing; AffordableHousing)
                {
                }
                column(SHIF; SHIF)
                {
                ...
                begin
                   ...
                   QuartersVar
                    ...
                    AssMatrix.SetRange("Employee No", Employee."No.");
                    AssMatrix.SetRange("Payroll Period", "Starting Date");
                    AssMatrix.SetRange("Code", 'AHL');
                    if AssMatrix.Findfirst() then
                        AffordableHousing := Abs(AssMatrix.Amount);
                    ...
                    AssMatrix.SetRange("Employee No", Employee."No.");
                    AssMatrix.SetRange("Payroll Period", "Starting Date");
                    AssMatrix.SetRange("Code", 'SHIF');
                    if AssMatrix.Findfirst() then
                        SHIF := Abs(AssMatrix.Amount);
                end;
                //  end;
