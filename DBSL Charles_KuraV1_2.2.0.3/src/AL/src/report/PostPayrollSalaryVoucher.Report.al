...
Report 69423 "Post Payroll Salary Voucher"
{
    ...
    dataset
    {
        ...
        dataitem("Employee Posting GroupX"; "Employee Posting GroupX")
        {
            ...
            dataitem(EarningsX; EarningsX)
            {
                ...
                begin
                    ...
                    AssignmentMatrix.SetRange("Posting Group Filter", PostingGroupFilter);
                ...
                begin
                    ...
                    EarningsX.SetRange(EarningsX."Posting Group Filter", PostingGroupFilter);
                end;
            }
            dataitem(Employer; DeductionsX)
            {
                ...
                begin
                    ...
                    Employer.SetRange(Employer."Posting Group Filter", PostingGroupFilter);
        ...
        dataitem(DeductionsX; DeductionsX)
        {
            ...
            begin
                ...
                if (DeductionsX."Total Amount" <> 0) then begin
                    ...
                    GenJnline.Amount := Round(DeductionsX."Total Amount", 0.01);
                    GenJnline.Validate(Amount);
                    // GenJnline.Validate("Shortcut Dimension 1 Code", 'R11');
                    // GenJnline.Validate("Shortcut Dimension 2 Code", '15% OPS');
                    // Constituency := 'DPT019';
                ...
                if DeductionsX."Total Amount Employer" <> 0 then begin
                    ...
                    //PGMapping.SETRANGE(PGMapping.Code,"Employee Posting GroupX".Code);
                    PGMapping.SetRange(PGMapping.Code, DeductionsX.Code);
                    PGMapping.SetRange(PGMapping."Posting Group", PostingGroupFilter);
                    //PGMapping.SETRANGE("Responsibility Center",RC);
                    if PGMapping.FindSet then begin
                        GenJnline."Account Type" := GenJnline."account type"::"G/L Account";
                        GenJnline."Account No." := PGMapping."GL Account Employer";
            ...
            begin
                ...
                DeductionsX.SetRange(DeductionsX."Posting Group Filter", PostingGroupFilter);
            end;
        }
        dataitem(LoansRec; DeductionsX)
        {
                        ...
                        if LoanApp.Find('+') then
                            if Loanproduct.Get(LoanApp."Loan Product Type") then
                                if Loanproduct.Internal then begin
                                    ...
                                    GenJnline."Document No." := Payperiodtext;
                                    GenJnline.Amount := Round(AssignmentMat.Amount + AssignmentMat."Interest Amount", 0.01);
                                    GenJnline.Validate(Amount);
                                    // GenJnline.Validate("Shortcut Dimension 1 Code", 'R11');
                                    // GenJnline.Validate("Shortcut Dimension 2 Code", '15% OPS');
                                    // Constituency := 'DPT019';
            ...
            begin
                ...
                LoansRec.SetRange(LoansRec."Posting Group Filter", PostingGroupFilter);
            end;
        }
        dataitem(ExternalLoans; DeductionsX)
        {
            ...
            begin
                ...
                ExternalLoans.SetRange(ExternalLoans."Posting Group Filter", PostingGroupFilter);
            end;
        }
        dataitem(Summary; "Integer")
        {
            ...
            begin
                ...
                GenJnline.Amount := -Round(TotalNetPay, 0.01);
                GenJnline.Validate(Amount);
                // GenJnline.Validate("Shortcut Dimension 1 Code", 'R11');
                // GenJnline.Validate("Shortcut Dimension 2 Code", '15% OPS');
                // Constituency := 'DPT019';
            ...
            begin
                ...
                if Confirm('Would you like to preview the journals?', true) then begin
                    if GenJnlBatch.Get(CompRec."Payroll Journal Template", CompRec."Payroll Journal Batch") then begin
    ...
    begin
        ...
        PostingGroupFilter := "Employee Posting GroupX".GetRangeMin("Employee Posting GroupX".Code);
