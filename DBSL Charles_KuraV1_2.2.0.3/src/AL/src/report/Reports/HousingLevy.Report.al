...
#pragma warning restore AL0254
            ...
            column(Empkra; Emp."P.I.N")
            {
            }
            column(EmployerAmount_AssignmentMatrixX; "Employer Amount")
            {
            }
            ...
            begin
                if Emp.Get("Assignment Matrix-X"."Employee No") then begin
                    ...
                    EMP.CalcFields("Total Allowances");
                    GrossPay2 := EMP."Total Allowances";
                END;
                // //gross pay
                // if EarnRec.get("Assignment Matrix-X"."Employee No") then begin
                //     EarnRec.SetRange(EarnRec."Earning Type", EarnRec."earning type"::"Normal Earning");
                //     EarnRec.SetRange(EarnRec."Non-Cash Benefit", false);
                //     EarnRec.SetRange(EarnRec."Pay Period Filter", "Assignment Matrix-X"."Payroll Period");
                //     //EarnRec.SETRANGE(EarnRec."Payroll Grouping Filter",EarnRec."Payroll Grouping Filter"::Management);

                //     if EarnRec.FindSet then begin
    ...
    begin
        ...
        ExcelBuf.AddColumn('ANTI-DOPING AGENCY OF KENYA', false, '', true, false, false, '@', ExcelBuf."cell type"::Text);
        ExcelBuf.NewRow;
