        ...
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Extent Of Agrrement Measure"; Rec."Extent Of Agrrement Measure")
                {
                    ...
                    ToolTip = 'Specifies the value of the Extent Of Agrrement Measure Code field.';
                }
                field("Extent Description"; Rec."Extent Description")
                {
                    ApplicationArea = Basic;
                    Caption = 'Extent Of Agrrement Measure Description';
                    ToolTip = 'Specifies the value of the Extent Of Agrrement Measure Description field.';
                }
