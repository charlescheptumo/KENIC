...
Table 99456 "Impact OF Road Intervention"
{
    ...
    fields
    {
        ...
        field(30; "Extent Of Agrrement Measure"; code[95])
        {
            DataClassification = ToBeClassified;
            ...
            TableRelation = ExtentOfAgreementOnImpactSetup.Code;
            trigger OnValidate()
            begin
                if extent.get("Extent Of Agrrement Measure") then
                    rec."Extent Description" := extent.ExtentOfAgreeMeasureSetupOI;
            end;
        }
        ...
        field(34; "Extent Of Agrrement Measure2"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = 'Reduced accident rates,Improve road safety as a result of better road design,Installation of road signs and road marking,Reduced vehicle operating costs (maintenance & fuel Usage),Reduced cost of travel and transport,Improved comfort in using the roads,Reduced travel time by reducing traffic jam,Improved network integration with other roads (Specify the Road),Improved pedestrian safety with the construction of the walkways,Reduced dust and ensured clean environment in the project area,Improved access to social services (to Schools, Hospital, Markets, Government Offices),Improved drainage in the area e.g. due to reduced water ponding, cleaning of drains removal of siltation etc.,mproved security due to improved access and installation of streetlights,Increased land value,Increased revenue for County and National Government,Creation of employment,Improved Aesthetic';
            OptionMembers = "Reduced accident rates","Improve road safety as a result of better road design","Installation of road signs and road marking","Reduced vehicle operating costs (maintenance & fuel Usage)","Reduced cost of travel and transport","Improved comfort in using the roads","Reduced travel time by reducing traffic jam","Improved network integration with other roads (Specify the Road)","Improved pedestrian safety with the construction of the walkways","Reduced dust and ensured clean environment in the project area","Improved access to social services (to Schools"," Hospital"," Markets"," Government Offices)","Improved drainage in the area e.g. due to reduced water ponding"," cleaning of drains removal of siltation etc.","mproved security due to improved access and installation of streetlights","Increased land value","Increased revenue for County and National Government","Creation of employment","Improved Aesthetic";
        }
        ...
        field(38; "Extent Description"; Text[350])
        {
            //  AutoIncrement = true;
            DataClassification = ToBeClassified;
        }
    ...
    var
        ...
        inter: Record 99453;
        extent: Record ExtentOfAgreementOnImpactSetup;
}
