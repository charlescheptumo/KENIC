...
Table 99451 "Monitoring Card Header"
{
    ...
    fields
    {
        field(1; "Document No."; Code[20])
        {
            ...
            begin
                if "Document No." <> xRec."Document No." then begin
                    SPMSetup.Get;
                    NoSeriesMgt.TestManual(SPMSetup."Monitoring Nos");
                    "No. Series" := '';
                end;
            end;
        }
        ...
        field(27; "Intervention Type"; Option)
        {
            DataClassification = ToBeClassified;
        ...
        field(29; "Respondent Category"; code[50])
        {
            DataClassification = ToBeClassified;
            ...
            TableRelation = "Respondent Category Setup".Code;
            trigger OnValidate()
            begin
                if respondant.get("Respondent Category") then
                    rec."Res Description" := respondant."Respondent Category";
            end;
        }
        field(30; "Extent Of Agrrement Measure"; code[100])
        {
            DataClassification = ToBeClassified;
        ...
        field(36; Region; Code[100])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Responsibility Center".Code where("Operating Unit Type" = filter('Region'));
        }
        field(37; Comments1; Text[1000])
        {
            DataClassification = ToBeClassified;
        }
        field(38; "Road Cordinates"; Text[1000])
        {
            DataClassification = ToBeClassified;
        }
        field(39; "Res Description"; text[250]) { DataClassification = ToBeClassified; }
    ...
    begin
        ...
        if "Document No." = '' then begin
            ...
            "Document No." := NoSeriesMgt.GetNextNo(SPMSetup."Monitoring Nos", WorkDate(), true);
        end;
