...
Table 95134 "Risk Incident Log"
{
    ...
    begin
        ...
        if "Incident ID" = '' then begin
            HealthAndSafetySetup.Get;
            HealthAndSafetySetup.TestField("Incident Log Nos.");
         "Incident ID":= NoSeriesManagement.GetNextNo(HealthAndSafetySetup."Incident Log Nos.",WorkDate(),true);
          //  NoSeriesManagement.InitSeries(HealthAndSafetySetup."Incident Log Nos.", xRec."No. Series", Today, "Incident ID", "No. Series");
        end;
    end;
    ...
    var
        ...
        Job: Record Job;
        HealthAndSafetySetup: Record "Health & Safety Setup";
}
