...
Page 75018 "Local Vendors"
{
    ...
    // SourceTable = Vendor;
    // SourceTableView = where("Supplier Ty = e"=const(" Local"),
    //                         Bloc = ed=const(" "));
    // UsageCategory = Lists;
    ...
    //             }
    //             field("Location Cod e";"Location Code")
    //             {
    //                 ApplicationArea = Location;
    //                 ToolTip = 'Specifies the warehouse location where items from the vendor must be received by default.';
    //             }
    //             field("Post Cod e";"Post Code")
    //             {
    //                 ApplicationArea = Bas ic,Suite;
    //                 ToolTip = 'Specifies the postal code.';
    //                 Visible = false;
    //             }
    //             field("Country/Region Cod e";"Country/Region Code")
    //             {
    //                 ApplicationArea = Bas ic,Suite;
    ...
    //                 Visible = false;
    //             }
    //             field("IC Partner Cod e";"IC Partner Code")
    //             {
    //                 ApplicationArea = Intercompany;
    //                 ToolTip = 'Specifies the vendor''s intercompany partner code.';
    //                 Visible = false;
    //             }
    //             field(Conta ct;Contact)
    //             {
    //                 ApplicationArea = Bas ic,Suite;
    //                 ToolTip = 'Specifies the name of the person you regularly contact when you do business with this vendor.';
    //             }
    //             field("Purchaser Cod e";"Purchaser Code")
    //             {
    //                 ApplicationArea = Suite;
    //                 ToolTip = 'Specifies which purchaser is assigned to the vendor.';
    //                 Visible = false;
    //             }
    //             field("Vendor Posting Grou p";"Vendor Posting Group")
    //             {
    //                 ApplicationArea = Bas ic,Suite;
    //                 ToolTip = 'Specifies the vendor''s market type to link business transactions made for the vendor with the appropriate account in the general ledger.';
    //                 Visible = false;
    //             }
    //             field("Gen. Bus. Posting Grou p";"Gen. Bus. Posting Group")
    //             {
    //                 ApplicationArea = Bas ic,Suite;
    //                 ToolTip = 'Specifies the vendor''s trade type to link transactions made for this vendor with the appropriate general ledger account according to the general posting setup.';
    //                 Visible = false;
    //             }
    //             field("VAT Bus. Posting Grou p";"VAT Bus. Posting Group")
    //             {
    //                 ApplicationArea = Bas ic,Suite;
    //                 ToolTip = 'Specifies the VAT specification of the involved customer or vendor to link transactions made for this record with the appropriate general ledger account according to the VAT posting setup.';
    //                 Visible = false;
    //             }
    //             field("Payment Terms Cod e";"Payment Terms Code")
    //             {
    //                 ApplicationArea = Bas ic,Suite;
    //                 ToolTip = 'Specifies a formula that calculates the payment due date, payment discount date, and payment discount amount.';
    //                 Visible = false;
    //             }
    //             field("Fin. Charge Terms Cod e";"Fin. Charge Terms Code")
    //             {
    //                 ApplicationArea = Suite;
    //                 ToolTip = 'Specifies the code for the involved finance charges in case of late payment.';
    //                 Visible = false;
    //             }
    //             field("Currency Cod e";"Currency Code")
    //             {
    //                 ApplicationArea = Suite;
    ...
    //                 Visible = false;
    //             }
    //             field("Language Cod e";"Language Code")
    //             {
    //                 ApplicationArea = Bas ic,Suite;
    //                 ToolTip = 'Specifies the language that is used when translating specified text on documents to foreign business partner, such as an item description on an order confirmation.';
    //                 Visible = false;
    //             }
    //             field("Search Nam e";"Search Name")
    //             {
    //                 ApplicationArea = Bas ic,Suite;
    ...
    //                 Visible = false;
    //             }
    //             field("Privacy Blocke d";"Privacy Blocked")
    //             {
    //                 ApplicationArea = Bas ic,Suite;
    //                 ToolTip = 'Specifies whether to limit access to data for the data subject during daily operations. This is useful, for example, when protecting data from changes while it is under privacy review.';
    //                 Visible = false;
    //             }
    //             field("Last Date Modifie d";"Last Date Modified")
    //             {
    //                 ApplicationArea = Bas ic,Suite;
    //                 ToolTip = 'Specifies when the vendor card was last modified.';
    //                 Visible = false;
    //             }
    //             field("Application Metho d";"Application Method")
    //             {
    //                 ApplicationArea = Bas ic,Suite;
    ...
    //                 Visible = false;
    //             }
    //             field("Shipment Method Cod e";"Shipment Method Code")
    //             {
    //                 ApplicationArea = Bas ic,Suite;
    //                 ToolTip = 'Specifies the delivery conditions of the related shipment, such as free on board (FOB).';
    //                 Visible = false;
    //             }
    //             field("Lead Time Calculatio n";"Lead Time Calculation")
    //             {
    //                 ApplicationArea = Bas ic,Suite;
    //                 ToolTip = 'Specifies a date formula for the amount of time it takes to replenish the item.';
    //                 Visible = false;
    //             }
    //             field("Base Calendar Cod e";"Base Calendar Code")
    //             {
    //                 ApplicationArea = Bas ic,Suite;
    ...
    //     area(factboxes)
    //     {
    //         part("Power BI Report FactBo x";"Power BI Report FactBox")
    //         {
    //             ApplicationArea = Bas ic,Suite;
    //             Caption = 'Power BI Reports';
    //             Visible = PowerBIVisible;
    //         }
    //         part(Control 14;"Social Listening FactBox")
    //         {
    //             ApplicationArea = All;
    //             SubPageLink = "Source Ty = e"=const(Vendor),
    //                           "Source N = ."=field("No.");
    //             Visible = SocialListeningVisible;
    //         }
    //         part(Control 15;"Social Listening Setup FactBox")
    //         {
    //             ApplicationArea = All;
    //             SubPageLink = "Source Ty = e"=const(Vendor),
    //                           "Source N = ."=field("No.");
    ...
    //         }
    //         part(VendorDetailsFactB ox;"Vendor Details FactBox")
    //         {
    //             ApplicationArea = Bas ic,Suite;
    //             SubPageLink = "N = ."=field("No."),
    //                           "Currency Filt = r"=field("Currency Filter"),
    ...
    //             Visible = false;
    //         }
    //         part(VendorStatisticsFactB ox;"Vendor Statistics FactBox")
    //         {
    //             ApplicationArea = Bas ic,Suite;
    //             SubPageLink = "N = ."=field("No."),
    //                           "Currency Filt = r"=field("Currency Filter"),
    ...
    //                           "Global Dimension 2 Filt = r"=field("Global Dimension 2 Filter");
    //         }
    //         part(VendorHistBuyFromFactB ox;"Vendor Hist. Buy-from FactBox")
    //         {
    //             ApplicationArea = Bas ic,Suite;
    //             SubPageLink = "N = ."=field("No."),
    //                           "Currency Filt = r"=field("Currency Filter"),
    ...
    //                           "Global Dimension 2 Filt = r"=field("Global Dimension 2 Filter");
    //         }
    //         part(VendorHistPayToFactB ox;"Vendor Hist. Pay-to FactBox")
    //         {
    //             ApplicationArea = All;
    //             SubPageLink = "N = ."=field("No."),
    //                           "Currency Filt = r"=field("Currency Filter"),
    ...
    //                         DefaultDimMultiple.SetMultiRecord(Ve nd,FieldNo("No."));
    ...
    //                 RunPageLink = "Vendor N = ."=field("No.");
    //                 ToolTip = 'Open the list of the vendor''s bank accounts';
    //             }
    //             action("C&ontact")
    //             {
    //                 AccessByPermission = TableData Cont = ct=R;
    //                 ApplicationArea = Bas ic,Suite;
    //                 Caption = 'C&ontact';
    //                 Image = ContactPerson;
    //                 Promoted = true;
    ...
    //                 RunPageLink = "Table Na = e"=const(Vendor),
    //                               "N = ."=field("No.");
    ...
    //                 RunPageLink = "Cross-Reference Ty = e"=const(Vendor),
    ...
    //                 RunPageLink = C = de=field("Invoice Disc. Code");
    ...
    //                 RunPageLink = "Buy-from Vendor N = ."=field("No.");
    //                 RunPageView = sorting("Document Typ e","Buy-from Vendor No.");
    ...
    //                 RunPageLink = "Vendor Filt = r"=field("No."),
    //                               "Global Dimension 1 Filt = r"=field("Global Dimension 1 Filter"),
    //                               "Global Dimension 2 Filt = r"=field("Global Dimension 2 Filter"),
    //                               "Date Filt = r"=field("Date Filter");
    ...
    //             RunObject = Page "Vendor Ledger Entries";
    //             RunPageLink = "Vendor N = ."=field("No."),
    //                           "Remaining Amou = t"=filte r(<0),
    //                           "Applies-to  = D"=filter(''),
    //                           "Document Ty = e"=filter(Payment);
    ...
    //                 trigger OnAction()
    //                 begin
    //                     ReadSoftOCRMasterDataSync.SyncMasterData(tr ue,false);
    //                 end;
    //             }
    //         }
    //     }
    ...
    //         SocialListeningMgt.GetVendFactboxVisibility(R SocialListeningSetupVisible, le,SocialListeningVisible);

    //     OpenApprovalEntriesExist := ApprovalsMgmt.HasOpenApprovalEntries(RecordId);

    //     CanCancelApprovalForRecord := ApprovalsMgmt.CanCancelApprovalForRecord(RecordId);

    //     WorkflowWebhookManagement.GetCanRequestAndCanCancel(Record CanRequestApprovalForFlow, ow,CanCancelApprovalForFlow);

    //     // Contextual Power BI FactBox: send data to filter the report in the FactBox
    //     CurrPage."Power BI Report FactBox".Page.SetCurrentListSelection("No false, se,PowerBIVisible);
    // end;

    // trigger OnInit()
    // begin
    //     SetVendorNoVisibilityOnFactBoxes;
    //     CurrPage."Power BI Report FactBox".Page.InitFactBox(CurrPage.ObjectId(fals e),CurrPage.Capti on,PowerBIVisible);
    // end;
    ...
    // begin
    //     SetFilter("Date Filte '..%1', 1',WorkDate);
