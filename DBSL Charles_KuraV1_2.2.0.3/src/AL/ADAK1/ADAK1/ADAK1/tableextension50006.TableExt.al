...
TableExtension 50006 "tableextension50006" extends Vendor
{
    fields
    {
        ...
        */
        ...
        // field(70111; "First Name"; Text[50])
        // {
        //     trigger OnValidate()
        //     begin
        //         IF Rec."Vendor Type" = Rec."Vendor Type"::"Medical Practitioner" then begin
        ...
        //     end;
        // }
        // field(70112; "Middle Name"; Text[50])
        // {
        //     trigger OnValidate()
        //     begin
        //         IF Rec."Vendor Type" = Rec."Vendor Type"::"Medical Practitioner" then begin
        ...
        //     SubType = Bitmap;
        // }
        field(70120; Gender; Enum "Employee Gender")
        {
        }
        field(70121; "AGPO Certificate"; Text[200])
        {
        }
    }
    ...
    begin
        ...
        //     Error('KRA PIN must have a value.');
    end;
    ...
    */
    ...
    //     if "No." = '' then begin
    //         case "Vendor Type" of
    //             Rec."Vendor Type"::"Medical Practitioner":
    //                 begin
    //                     TUESetup.Get();
    //                     TUESetup.TestField("Medical Practitioner's Nos");
    //                     //TUESetup.TestField(MedicalPractitonerPostingGroup);
    //                     NoSeriesMgmt.InitSeries(TUESetup."Medical Practitioner's Nos", xRec."No. Series", 0D, "No.", "No. Series");
