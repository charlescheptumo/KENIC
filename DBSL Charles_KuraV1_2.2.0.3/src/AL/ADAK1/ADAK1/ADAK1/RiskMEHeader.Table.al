    ...
    begin
        ...
        if "Document No" = '' then begin
            if "Document Type" = "document type"::"New Risk Voucher" then begin
                ...
                "Document No" := NoSeriesManagement.GetNextNo(RiskManagementFramework."New Risk Voucher Nos",WorkDate(),true);
        ...
        if "Document No" = '' then begin
            if "Document Type" = "document type"::"Risk Status Report" then begin
                ...
                RiskManagementFramework.TestField("Status Report Nos");
                  "Document No" := NoSeriesManagement.GetNextNo(RiskManagementFramework."Status Report Nos",WorkDate(),true);
