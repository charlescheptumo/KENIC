...
Table 69423 "HSE Plan"
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            OptionMembers = " ",Corporate,"Functional (Directorate)","Functional (Department)","Functional (Region)";
        }
        ...
        field(6; "Safety Rules&Regulations Temp"; Code[20])
        {
            ...
            trigger OnValidate()
            var
                OSHRuleTemplateLine: Record "OSH Rule Template Line";
                HSEPlanSafetyRule: Record "HSE Plan Safety Rule";
                OSHRuleTemplateCategory: Record "OSH Rule Template Category";
                HSEPlanSafetyRuleCategory: Record "HSE Plan Safety Rule Category";
            begin
