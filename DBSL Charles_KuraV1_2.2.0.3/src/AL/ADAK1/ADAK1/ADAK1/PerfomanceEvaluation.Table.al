...
Table 80079 "Perfomance Evaluation"
{
    ...
    fields
    {
        ...
        field(56; "Managerial Template ID"; Code[100])
        {
            Editable = true;
            TableRelation = "Managerial Attributes".Code;
        }
        field(57; "Core Values Template ID"; Code[100])
        {
            Editable = true;
            TableRelation = "Core Values & Attributes".Code;
        }
        field(58; "First Supervisor Comment"; Text[500])
        {
        }
        field(59; "Second Supervisor Comment"; Text[500])
        {
        ...
        if "Document Type" = "document type"::"Performance Appraisal" then begin
            if "Evaluation Type" = "evaluation type"::"Standard Appraisal/Supervisor Score Only" then begin
                if No = '' then begin
                   ...
                   "No" := NoSeriesMgt.GetNextNo(SPMSetup."Performance Evaluation Nos", WorkDate(), true);
                end;
            end;
            if "Evaluation Type" = "evaluation type"::"Self-Appraisal with Supervisor Score" then begin
                if No = '' then begin
