#pragma warning disable AA0005, AA0008, AA0018, AA0021, AA0072, AA0137,AL0432, AA0201, AA0206, AA0218, AA0228, AL0254, AL0424, AW0006 // ForNAV settings
Page 90027 "Accountant Role Center1"
{
    ...
    actions
    {
        area(reporting)
        {
            ...
            group("Cash Flow")
            {
                ...
                action("Update Employee Bank Details")
                {
                    ...
                    Ellipsis = true;
                    Image = Confirm;
                    ToolTip = 'Executes the Update Employee Bank Details action.';
                    // RunObject = Report 69420;
                }
        ...
        area(embedding)
        {
            ...
            action("Approved Purchase Invoices")
            {
                ApplicationArea = Intercompany;
                Caption = 'Approved Purchase Invoices';
                // RunObject = Page 57007;
            ...
            action("Advance Payment Request")
            {
                ApplicationArea = Basic;
                RunObject = Page 72296;
                ToolTip = 'Executes the Advance Payment Request action.';
            }
            action("Archived Imprest Memos")
            {
                ApplicationArea = Basic;
                RunObject = Page 57166;
                ToolTip = 'Executes the Archived Imprest Memos action.';
            }
        }
        area(sections)
        {
            group(ActionGroup172)
            {
                ...
                action("Finance employee list1")
                {
                    ApplicationArea = Basic;
                    Caption = 'Finance employee list';
                    Image = Currency;
                    RunObject = Page 57206;
                ...
                action("G/L Entries")
                {
                    ApplicationArea = Basic;
                    RunObject = Page "General Ledger Entries";
                    ToolTip = 'Executes the G/L Entries action.';
                }
            }
            group(Journals)
            {
            ...
            group(SetupAndExtensions)
            {
                ...
                action(Finance)
                {
                    ...
                    Caption = 'Finance';
                    RunObject = Page "Manual Setup";
                    ToolTip = 'Executes the Finance action.';
                    // RunPageView = sorting(Name)
                ...
                action(Service)
                {
                    ...
                    Caption = 'Service';
                    RunObject = Page "Manual Setup";
                    ToolTip = 'Executes the Service action.';
                    // RunPageView = sorting(Name)
        ...
        area(processing)
        {
            ...
            group(Tasks)
            {
                ...
                action("Analysis by Dimension")
                {
                    ApplicationArea = Basic;
                    RunObject = Page "Analysis View Card";
                    ToolTip = 'Executes the Analysis by Dimension action.';
                }
            }
            group(Create)
            {
            ...
            group(Reports)
            {
                ...
                group("Financial Statements")
                {
                    ...
                    action("Detailed E/D")
                    {
                        ...
                        ToolTip = 'Executes the Detailed E/D action.';
                        // RunObject = ReporT 69012;
                    }
                    action("NHIF Report")
                    {
                        ApplicationArea = Basic;
                    ...
                    action("HELB Report")
                    {
                        ...
                        // RunObject = Report 69042;
                    }
                    action("Pension Contribution Report")
                    {
                        ApplicationArea = Basic;
                        Image = EmployeeAgreement;
                        ToolTip = 'Executes the Pension Contribution Report action.';
                        // RunObject = Report 69060;
                    }
                    action("Rent (Min. Of Housing) Report")
                    {
                        ApplicationArea = Basic;
                        Image = EmployeeAgreement;
                        ToolTip = 'Executes the Rent (Min. Of Housing) Report action.';
                        //  RunObject = Report 69045;
                    }
                    action("SACCO Report")
                    {
                        ApplicationArea = Basic;
                        ...
                        //  RunObject = Report 69147;
                    }
                    action("Register of High Court Report")
                    {
                        ApplicationArea = Basic;
                        Caption = 'Child Support';
                        Image = EmployeeAgreement;
                        ToolTip = 'Executes the Child Support action.';
                        // RunObject = Report 69038;
                    }
                    action("Employee Pay Details")
                    {
                        ...
                        // RunObject = Report 89030;
                    }
                    action("Employee Pay Details Casual")
                    {
                        ApplicationArea = Basic;
                        Image = Employee;
                        ToolTip = 'Executes the Employee Pay Details Casual action.';
                        // RunObject = Report 89039;
                    }
                    action("KCB Pesonal Loan")
                    {
                        ApplicationArea = Basic;
                        Caption = 'KCB Pesonal Loan';
                        Image = EmployeeAgreement;
                        ToolTip = 'Executes the KCB Pesonal Loan action.';
                        // RunObject = Report 69071;
                    }
                    action(NITA)
                    {
                        ApplicationArea = Basic;
                        Image = EmployeeAgreement;
                        ToolTip = 'Executes the NITA action.';
                        //  RunObject = Report 69044;
                    }
                    action("Mortgage Loan Schedule")
                    {
                        ApplicationArea = Basic;
                        Image = EmployeeAgreement;
                        ToolTip = 'Executes the Mortgage Loan Schedule action.';
                        //  RunObject = Report 69043;
                    }
                    action("Payroll Recon Summary KeRRA")
                    {
                        ApplicationArea = Basic;
                        Image = EmployeeAgreement;
                        ToolTip = 'Executes the Payroll Recon Summary KeRRA action.';
                        //  RunObject = Report 69070;
                    }
                    action("Advance Payment Summary  Report")
                    {
                        ApplicationArea = Basic;
                        Image = "Report";
                        ToolTip = 'Executes the Advance Payment Summary  Report action.';
                        // RunObject = Report 75004;
                    }
                    action("Bill Discounting Request")
                    {
                        ApplicationArea = Basic;
                        RunObject = Page 57214;
                        ToolTip = 'Executes the Bill Discounting Request action.';
                    }
                    action("Agency Notice Report")
                    {
                        ApplicationArea = Basic;
                        Image = Agreement;
                        ToolTip = 'Executes the Agency Notice Report action.';
                        // RunObject = Report 57095;
                    }
                }
                group("Excel Reports")
                {
            ...
            group(Setup)
            {
                ...
                action("Page Archived Payment documents")
                {
                    ApplicationArea = Basic;
                    Caption = 'Page Archived Payment documents';
                    ToolTip = 'Executes the Page Archived Payment documents action.';
                }
            }
            group(History)
            {
