...
Table 69030 "Payroll Header"
{
    ...
    fields
    {
        ...
        field(3; "Payroll Period"; Date)
        {
            ...
            trigger OnValidate()
            begin
                // Removed in order to allow posting of other employees of different Employee Posting Group
                // PayrollHeader.Reset;
        ...
        field(495; "Reasons to Reopen"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    begin
        if "Payroll Type" = "payroll type"::Normal then begin
            if "No." = '' then begin
                ...
                "No." := NoSeriesMgt.GetNextNo(NoSetup."Salary Voucher Nos", WorkDate(), true);
            end;
        end;
        ...
        if "Payroll Type" = "payroll type"::Director then begin
            if "No." = '' then begin
                ...
                NoSetup.TestField(NoSetup."Director Payroll Nos");
                 "No." := NoSeriesMgt.GetNextNo(NoSetup."Director Payroll Nos", WorkDate(), true);
            end;
        end;
