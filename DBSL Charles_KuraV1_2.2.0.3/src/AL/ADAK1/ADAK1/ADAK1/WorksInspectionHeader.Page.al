    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Measurement Sheet No"; Rec."Measurement Sheet No")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Measurement Sheet No field.';
                }
                field("Inspection Committee No."; Rec."Inspection Committee No.")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Inspection Committee No. field.';
                }
        ...
        area(navigation)
        {
            action("Suggest Lines")
            {
                ...
                begin
                    ...
                    InspectionPaymentLine.Reset;
                    InspectionPaymentLine.SetRange(InspectionPaymentLine."Document No", Rec."Measurement Sheet No");
