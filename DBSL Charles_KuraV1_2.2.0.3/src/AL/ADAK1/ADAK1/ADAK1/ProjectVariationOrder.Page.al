...
Page 72488 "Project Variation Order"
{
    DeleteAllowed = false;
    PageType = Card;
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Value of Work Added"; Rec."Value of Work Added")
                {
                    ...
                    ToolTip = 'Specifies the value of the Value of Work (Cost Overrun) field.';
                }
                field("Value of Work Omitted"; Rec."Value of Work Omitted")
                {
                    ApplicationArea = Basic;
                    Caption = 'Value of Work (Savings)';
                    ToolTip = 'Specifies the value of the Value of Work (Savings) field.';
                }
            ...
            part(Control9; "Project Variation Order Subpag")
            {
    ...
    actions
    {
        area(navigation)
        {
            ...
            action("Review Committee")
            {
                ...
                PromotedCategory = Process;
                PromotedIsBig = true;
                RunObject = Page "Project Variation Committees";
                RunPageLink = "Document Type" = field("Document Type"),
                              "Document No." = field("Document No.");
            ...
            action(Post)
            {
                ...
                begin
                    ...
                    //   RMSManagement.FnPostVariationOrder(ProjectVariationLine,Rec);
                    Rec.Posted := true;
                    Rec.Modify(true);

                    Message(Format(Rec."Document Type") + '  ' + Rec."Document No." + ' ' + 'posted sucessfuly.');
                    CurrPage.Close();
                end;
            }
            action(Release)
    ...
    begin
        Rec."Document Type" := Rec."document type"::"Project Variation Order";
    end;
