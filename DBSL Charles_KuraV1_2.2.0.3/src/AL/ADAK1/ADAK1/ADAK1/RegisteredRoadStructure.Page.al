...
Page 72352 "Registered Road Structure"
{
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Road Facility SubType"; Rec."Road Facility SubType")
                {
                    ...
                    ToolTip = 'Specifies the value of the Road Facility Details field.';
                }
                ...
                field("Facility Label"; Rec."Facility Label")
                {
                    ...
                    ToolTip = 'Specifies the value of the Facility Local Name field.';
                }
                ...
                field(River; Rec.River)
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the River field.';
                }
                field("River Name"; Rec."River Name")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the River Name field.';
                }
        ...
        area(navigation)
        {
            action(AttachDocuments)
            {
                ...
                begin
                    ...
                    DMSManagement.UploadRoadLinkDocuments(Rec."Facility  No.", 'Road Structure', Rec.RecordId, Rec."Region ID");
                end;
            }
        }
    }
    ...
    begin
        Rec."Road Facility Category" := Rec."road facility category"::Structure;
    end;
