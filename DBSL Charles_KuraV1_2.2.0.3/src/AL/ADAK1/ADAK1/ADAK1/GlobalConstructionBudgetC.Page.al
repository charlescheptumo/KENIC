...
Page 72333 "Global Construction Budget C"
{
    ApplicationArea = All;
    //     Caption = 'Global Construction  Budget Book';
    //     DeleteAllowed = false;
    //     PageType = Card;
    ...
    //                 }
    //             }
    //             part("Construction Budget Ceilings";"Construction  Budget Lines")
    //             {
    //                 Caption = 'Construction  Budget Lines';
    //                 SubPageLink = "Road Work Program ID"=field(Code);
    //                 ToolTip = 'Construction  Budget Lines';
    //             }
    //         }
    //     }
