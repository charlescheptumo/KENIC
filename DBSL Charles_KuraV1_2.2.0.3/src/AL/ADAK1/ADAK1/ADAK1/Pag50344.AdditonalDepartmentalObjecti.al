...
Page 50344 "Additional DP Objectives"
{
    Caption = 'Additional Departmental Objectives';
    PageType = ListPart;
    SourceTable = "Additional PC Objective";
    ApplicationArea = All;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field(YearReportingCode;Rec."Year Reporting Code")
                {
                    ApplicationArea = Basic;
                ...
                field("PC Achieved Target"; Rec."PC Achieved Target")
                {
                    ToolTip = 'Specifies the value of the PC Achieved Target field.';
                    visible = false;
