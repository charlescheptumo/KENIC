#pragma warning disable AA0005, AA0008, AA0018, AA0021, AA0072, AA0137, AA0201, AA0206,AL0432, AA0218, AA0228, AL0254, AL0424, AW0006 // ForNAV settings
Page 72233 "Planned Construction Projects"
{
    AdditionalSearchTerms = 'projects';
    ApplicationArea = Jobs;
    Caption = 'Planned Construction Projects';
    CardPageID = "Development Project";
    DeleteAllowed = false;
    Editable = false;
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,Navigate,Job';
    SourceTable = Job;
    // SourceTableView = where("Type of Project"=filter("Road Construction"),
        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Project Budget"; Rec."Project Budget")
                {
                    ...
                    ToolTip = 'Specifies the value of the Total Contract Amount field.';
                }
