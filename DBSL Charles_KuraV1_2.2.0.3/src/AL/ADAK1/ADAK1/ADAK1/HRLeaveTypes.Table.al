...
Table 69206 "HR Leave Types"
{
    ...
    fields
    {
        ...
        field(19; "Attachments Required"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(20; "Posting Type"; Enum "Leave Posting Types")
        {
            DataClassification = ToBeClassified;
            //OptionCaption = 'Annual,Compassionate,Marternity,Parternity,Sick Leave,Study Leave,Sports Leave,Unpaid Leave,Terminal Leave,Off Days,Selfcare';
            //OptionMembers = Annual,Compassionate,Marternity,Parternity,"Sick Leave","Study Leave","Sports Leave","Unpaid Leave","Terminal Leave","Off Days","Selfcare";
        }
    }
