...
Page 92531 "REs Office Temp SuperV L"
{
    Caption = 'RE''s Office Temporary Supervision Requirements';
    CardPageID = "REs Office Temporary SuperV C";
    DeleteAllowed = false;
    PageType = List;
    SourceTable = "Temporary Supervision Requirem";
    SourceTableView = where("Document Type" = filter("RE's Office"));
    ApplicationArea = All;
