...
Page 75278 "Proffesion Opinion Card"
{
    ...
    Caption = 'Professional Opinion Card';
    ApplicationArea = All;
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Raised By"; Rec."Raised By")
                {
                    ...
                    // TO BE                     ToolTip = 'Specifies the value of the Evaluation Lead field.';
                ...
                field(Name; Rec.Name)
                {
                    ...
                    //CC TO BE EDITED                    ToolTip = 'Specifies the value of the Evaluation Lead Name field.';
                ...
                field("<General Procurement Remarks>"; ObjText)
                {
                    ...
                    ShowMandatory = true;
                    Visible = false;
                    ToolTip = 'Specifies the value of the Professional Opinion Remarks field.';
                ...
                field("Reason for Tender Termination"; Rec."Reason for Tender Termination")
                {
                    ...
                    Editable = NOA1;
                    MultiLine = true;
                    ToolTip = 'Specifies the value of the Reason for Tender Termination field.';
                }
                field("Head Of Procurement Remarks"; Rec."Head Of Procurement Remarks")
                {
                    ApplicationArea = Basic;
                    MultiLine = true;
                    ToolTip = 'Specifies the value of the Head Of Procurement Remarks field.';
                }
        ...
        area(processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action("Submit Opinion")
                {
                    ...
                    // Visible = noa;
                    Visible = true;
                    ToolTip = 'Executes the Submit Opinion action.';
                ...
                action("Notify The Secretary/Chairperson")
                {
                    ...
                    PromotedCategory = Category5;
                    PromotedIsBig = true;
                    ToolTip = 'Executes the Notify The Secretary/Chairperson action.';
                    // Visible = true;
                ...
                action("Proceed To Notice Of Termination")
                {
                    ApplicationArea = Suite;
                    Caption = 'Proceed To Notice Of Termnation';
                    Ellipsis = true;
                    Image = PostDocument;
                    Promoted = true;
                    PromotedCategory = Process;
