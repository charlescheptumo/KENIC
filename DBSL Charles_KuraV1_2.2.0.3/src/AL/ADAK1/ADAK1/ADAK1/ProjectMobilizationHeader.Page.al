...
Page 72272 "Project Mobilization Header"
{
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control66; "Mobilized Internal Resource")
            {
    ...
    actions
    {
        area(navigation)
        {
            action("Mobilized Project Objective")
            {
                ApplicationArea = Basic;
                Ellipsis = true;
                Image = AssemblyBOM;
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                RunObject = Page "Mobilized Project Objectivex";
                RunPageLink = "Document No" = field("Document No."),
                              "Document Type" = field("Document Type");
                ToolTip = 'Executes the Mobilized Project Objective action.';
            }
        }
    }
}
