...
Table 70073 "Vendor Litigation History"
{
    ...
    fields
    {
        ...
        field(4; "Category of Matter"; Option)
        {
            ...
            OptionCaption = ',Litigation,Arbitration,Mediation,N/A';
            OptionMembers = ,Litigation,Arbitration,Mediation,"N/A";
        }
    ...
    // fieldgroups
    // {
    //     fieldgroup(DropDown;"Entry No.","Vendor No.",Field5050,"3rd Party Entity",Field91,"Award Type")
    //     {
    //     }
    //     fieldgroup(Brick;"Entry No.","Vendor No.",Field5050,"3rd Party Entity","Award Type",Field140)
    //     {
    //     }
    // }
