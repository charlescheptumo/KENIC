...
TableExtension 50008 "tableextension50008" extends Item
{
    fields
    {
        ...
        */
        ...
        field(70053; "Item Brand Code"; Code[200])
        {
            TableRelation = "Item Brand".Code;

            trigger OnValidate()
            var
                ItmBrand: Record "Item Brand";
            begin
                ItmBrand.Reset();
                ItmBrand.SetRange(Code, "Item Brand Code");
                if ItmBrand.find('-') then begin
                    "Item Brand Description" := ItmBrand.Brand;
                end;
            end;
        }
        field(70054; "Item Brand Description"; Text[2048])
        {
        }
        field(70055; "Responsible Employee"; Code[50])
        {
            TableRelation = Employee."No.";
        }
        field(70056; "Responsible Employee Name"; Text[2000])
        {
            DataClassification = ToBeClassified;
        }
        field(70057; "Serial No"; Text[50])
        {
            DataClassification = ToBeClassified;
        }
        field(70058; Model; Text[50])
        {
            DataClassification = ToBeClassified;
        }
    }
