...
Page 72480 "EOT Request"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Evaluation Committee No field.';
                }
            ...
            part(Control46; "EOT  Reason SubPage")
            {
                Caption = 'Grounds For EOT';
                SubPageLink = "Document Type" = field("Document Type"),
                              "Document No." = field("Document No.");
            }
            part(Control9; "Extension of Time Subpage")
            {
                Caption = 'Revised Activity Schedule';
                SubPageLink = "Document Type" = field("Document Type"),
                              "Document No." = field("Document No.");
                Visible = JobTasksVisible;
            }
        ...
        area(navigation)
        {
            ...
            action(Post)
            {
                ...
                begin
                    ...
                    RMSManagement.FnPostEOTIME(Rec);
    ...
    begin
        Rec."Document Type" := Rec."document type"::"Extension of Time Request";
    end;
