...
Table 59001 "Vehicle Fuel Card Lines"
{
    ...
    fields
    {
        field(1; "No."; Code[20])
        {
            ...
            begin
                ...
                if "No." = '' then begin
                    ...
                    "No." := NoSeriesMgt.GetNextNo(FltMgtSetup."Fuel Expense No", WorkDate(), true);
                end;
            end;
        }
        ...
        field(3; "Amount in Shillings"; Decimal)
        {
        }
        ...
        field(14; "Amount in Litres"; Decimal)
        {
        }
    }
    ...
    begin
        ...
        DetailedFD."Amount in Litres" := FuelCardLines."Amount in Litres";
        DetailedFD."Amount in Shillings" := FuelCardLines."Amount in Shillings";
        ...
        if (DetailedFD."Amount in Litres" <> 0) and (DetailedFD."Amount in Shillings" <> 0) then
            DetailedFD.Insert;
