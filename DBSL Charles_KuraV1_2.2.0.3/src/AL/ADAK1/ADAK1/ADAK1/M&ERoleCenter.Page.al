        ...
        area(Sections)
        {
            ...
            group("planning setup1")
            {
                ...
                action("Organization Hierachy")
                {
                    ...
                    ToolTip = 'Executes the Organization Hierachy action.';
                }
                ...
                action("Strategy General Setup")
                {
                    ...
                    ToolTip = 'Executes the Strategy General Setup action.';
                }
            ...
            group(Documents)
            {
                ...
                //     ToolTip = 'Combine various financial data sources to find out when a cash surplus or deficit might happen or whether you should pay down debt, or borrow to meet upcoming expenses.';
                // }
                action("HODs Annual Workplan")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'HODs Annual Workplan';
                    RunObject = Page 50341;
                    ToolTip = 'Combine various financial data sources to find out when a cash surplus or deficit might happen or whether you should pay down debt, or borrow to meet upcoming expenses.';
                }
                ...
                //     ToolTip = 'Executes the Senior Officer Annual Workplan action.';
                ...
                //     ToolTip = 'Executes the Department/Region Annual Workplan action.';
                ...
                //     ToolTip = 'Executes the Principal Officer Annual Workplan action.';
                // }
            ...
            //     }
            // }
            group("Approved Annual WorkPlan Documents")
            {
                action("Approved Strategic Plan")
                {
                    ...
                    ToolTip = 'Executes the Approved Strategic Plan action.';

                }
                action("Approved Organizational Plan")
                {
                    ApplicationArea = Basic, Suite;
                    // Caption ='Functional Objective Template';
                    RunObject = Page 99450;
                    ToolTip = 'Executes the Approved Organizational Plan action.';
                ...
                action("Approved Departmental Workplans")
                {
                    ...
                    ToolTip = 'Executes the Approved Departmental Workplans action.';
                }
                ...
                action("Approved Annual Work Plans")
                {
                    ...
                    Visible = false;
                    ToolTip = 'Executes the Approved Annual Work Plans action.';
                ...
                action("Approved Board Annual Work Plans")
                {
                    ...
                    Visible = false;
                    ToolTip = 'Executes the Approved Board Annual Work Plans action.';
                ...
                action("Approved Functional Objective Templates")
                {
                    ...
                    ToolTip = 'Executes the Approved Functional Objective Templates action.';
                ...
                action("Appoved Directors Annual Workplans")
                {
                    ...
                    ToolTip = 'Executes the Appoved Directors Annual Workplans action.';
                ...
                //     ToolTip = 'Executes the Approved Departmental/Region Annual Workplans action.';
                ...
                action("Approved  Strategic Plans")
                {
                    ...
                    RunObject = Page 80193;
                    Visible = false;
                    ToolTip = 'Executes the Approved  Strategic Plans action.';
                ...
                action("Approved Staff Annual Workplan")
                {
                    ...
                    ToolTip = 'Executes the Approved Staff Annual Workplan action.';
            ...
            group("PerfomanceMonitoring")
            {
                ...
                action("Perfomance Daily Logs")
                {
                    ...
                    ToolTip = 'Executes the Perfomance Quaterly Logs action.';
                ...
                action("Approved Performance Updates")
                {
                    ...
                    ToolTip = 'Executes the Approved Performance Updates action.';
                ...
                action("Posted Performance Updat nes")
                {
                    ...
                    ToolTip = 'Executes the Posted Performance Updates action.';
            ...
            group("PerfomanceReporting")
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    Caption = ' Perfomance Contract Reporting';
                    RunObject = Page 80480;
                    ToolTip = 'Executes the  Perfomance Contract Reporting action.';

                }
                action("Approved Perfomance Reporting List")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Approved Perfomance Contract Reporting';
                    RunObject = Page 80482;
                    ToolTip = 'Executes the Approved Perfomance Contract Reporting action.';

                }
                action("Posted Perfomance Reporting List")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Posted Perfomance Contract Reporting';
                    RunObject = Page 80483;
                    ToolTip = 'Executes the Posted Perfomance Contract Reporting action.';
            ...
            group("Performance Contract")
            {
...

                {
                    ...
                    action("Department Performance Contract")
                    {
                        ApplicationArea = Basic, Suite;
