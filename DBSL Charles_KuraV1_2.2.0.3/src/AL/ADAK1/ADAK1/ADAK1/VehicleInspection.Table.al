...
Table 59030 "Vehicle Inspection"
{
    ...
    fields
    {
        ...
        field(4; "Last Inspection No."; Code[100])
        {
            DataClassification = ToBeClassified;
        }
        field(5; Type; Option)
        ...
        field(8; "Registration No."; Code[100])
        {
            DataClassification = ToBeClassified;
            NotBlank = true;
        ...
        field(17; "Inspection Type"; Option)
        {
            OptionMembers = "",NTSA,GVCU;
            OptionCaption = ',NTSA,GVCU';
        }
        field(18; "External Inspection No."; Code[10])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    begin
        ...
        if "Inspection No." = '' then
              "Inspection No." := NoSeriesMgt.GetNextNo(FleetManagementSetup."Vehicle Inspection  No", WorkDate(), true);
    end;
