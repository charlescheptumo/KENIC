...
Page 80412 "Senior Officer PC"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Principal Officer PC ID"; Rec."Principal Officer PC ID")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Principal Officer PC ID field.';
                }
        ...
        area(creation)
        {
            action("Suggest Objective Lines")
            {
                ...
                begin
                    ...
                    Message('Departments CSP Populated Successfully');
    ...
    begin
        ...
        Rec."Score Card Type" := Rec."score card type"::Senior;
    end;
