    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the PRN Type field.';
                }
                ...
                field("PP Solicitation Type"; Rec."PP Solicitation Type")
                {
                    ApplicationArea = Basic;
                    Editable = true;
                    ToolTip = 'Specifies the value of the PP Solicitation Type field.';
                ...
                field("PP Bid Selection Method"; Rec."PP Bid Selection Method")
                {
                    ApplicationArea = Basic;
                    Visible = false;
                    ToolTip = 'Specifies the value of the PP Bid Selection Method field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the PRN Conversion Procedure field.';
                }
                ...
                field("Survey/Study/Design Done?"; Rec."Survey/Study/Design Done?")
                {
                    ...
                    ToolTip = 'Specifies the value of the ESIA Study Done? field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Multiple IFS field.';
                }
                field("Ordered PRN"; Rec."Ordered PRN")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Ordered PRN field.';
                }
                field("First Approver ID"; Rec."First Approver ID")
                {
                    ApplicationArea = Basic;
                    Visible = FALSE;
                    ToolTip = 'Specifies the value of the First Approver ID field.';
                }
                field("Second Approver ID"; Rec."Second Approver ID")
                {
                    ApplicationArea = Basic;
                    Visible = FALSE;
                    ToolTip = 'Specifies the value of the Second Approver ID field.';
                }
                field("Third Approver ID"; Rec."Third Approver ID")
                {
                    ApplicationArea = Basic;
                    Visible = FALSE;
                    ToolTip = 'Specifies the value of the Third Approver ID field.';
                }
                field("Fourth Approver ID"; Rec."Fourth Approver ID")
                {
                    ApplicationArea = Basic;
                    Visible = FALSE;
                    ToolTip = 'Specifies the value of the Fourth Approver ID field.';
                }
                field("Fifth Approver ID"; Rec."Fifth Approver ID")
                {
                    ApplicationArea = Basic;
                    Visible = FALSE;
                    ToolTip = 'Specifies the value of the Fifth Approver ID field.';
                }
                field("Sixth Approver ID"; Rec."Sixth Approver ID")
                {
                    ApplicationArea = Basic;
                    Visible = FALSE;
                    ToolTip = 'Specifies the value of the Sixth Approver ID field.';
                }
                field("Approval Approve Remarks"; Rec."Approval Approve Remarks")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Approval Approve Remarks field.';
                }
                field("Approval Rejection Remarks"; Rec."Approval Rejection Remarks")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Approval Rejection Remarks field.';
                }
            }
            group("Project Details")
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Project Staffing Template ID field.';
                }
                field("Works Equipment Template ID"; Rec."Works Equipment Template ID")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Works Equipment Template ID field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Works Length (Km) field.';
                }
            ...
            group("Purchase Requisition")
            {
                ...
                action(Approvals)
                {
                    ...
                    begin
                        ...
                        // ApprovalsMgmt.OpenApprovalEntriesPage(Rec.RecordId);(Database::"Purchase Header", 14, Rec."No.");
        ...
        area(processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action("Contract  Required Documents")
                {
                    ...
                    RunPageLink = "Document ID" = field("No."),
                                  ...
                                  "PRN No" = field("No.");
                    ToolTip = 'Executes the Contract  Required Documents action.';
                }
                action("Variation Of Price Indices")
                {
                    ...
                    ToolTip = 'Executes the Variation Of Price Indices action.';
                }
            ...
            group("Request Approval")
            {
                ...
                action("Required Personnel")
                {
                    ...
                    ToolTip = 'Executes the Required Personnel action.';
                }
                action("Required Equipment")
                {
                    ...
                    ToolTip = 'Executes the Required Equipment action.';
                }
            }
            group(Print)
            {
                ...
                action("&Print")
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    ToolTip = 'Executes the &Detailed Print Works PRN action.';
                ...
                action("&Print Works PRN")
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    ToolTip = 'Executes the &Print Works PRN action.';
