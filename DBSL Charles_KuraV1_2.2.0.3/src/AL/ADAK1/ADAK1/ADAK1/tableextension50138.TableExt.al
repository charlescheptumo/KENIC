...
TableExtension 50138 "tableextension50138" extends "Service Header"
{
    fields
    {
        ...
        field(50023; "Procurement Type"; Code[20])
        {
            TableRelation = "Procurement Types1";
        }
        field(50024; "Contract Number"; Code[30])
        {
        }
    }
}
