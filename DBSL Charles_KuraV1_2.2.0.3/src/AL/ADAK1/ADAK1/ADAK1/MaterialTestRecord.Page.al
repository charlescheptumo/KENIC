...
Page 72457 "Material Test Record"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Material Certificate No"; Rec."Material Certificate No")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Material Certificate No field.';
                }
                field("Material Template ID"; Rec."Material Template ID")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Material Template ID field.';
                }
        ...
        area(navigation)
        {
            ...
            action("Send Approval Request")
            {
                ...
                begin
                    ...
                    RecVariant := Rec;
                    RMSManagement.FnPopulateApprovalEntryCustomeWorkflow(RecVariant, Rec."Project ID", Rec."Document Type", Rec."Project ID", CustApprovalEntry."document type"::PCO, 0, Rec.RecordId, FnGetTableNo());
    ...
    begin
        Rec."Document Type" := Rec."document type"::"Material Test Record";
    end;
