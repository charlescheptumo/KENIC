    ...
    layout
    {
        area(content)
        {
            ...
            group("Project Control Plans")
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Communication Plan ID field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Quality Management Plan ID field.';
                }
            }
    ...
    actions
    {
        area(navigation)
        {
            ...
            action("WEP Key Milestone")
            {
                ...
                Visible = false;
                ToolTip = 'Executes the WEP Key Milestone action.';
            }
            action("Methods of Work")
            {
                ...
                RunPageLink = "Document No" = field("Document No."),
                                  "Document Type" = field("Document Type");
                Visible = false;
                ToolTip = 'Executes the Methods of Work action.';
            }
            action("Contractor Staff")
            {
                ...
                Visible = false;
                ToolTip = 'Executes the Contractor Staff action.';
            }
            action("Contractor Equipment")
            {
                ...
                RunPageLink = "Document No." = field("Document No."),
                                  ...
                                  "Contractor No." = field("Contractor No.");
                Visible = false;
                ToolTip = 'Executes the Contractor Equipment action.';
            }
            action("Equipment Repair Plan")
            {
                ...
                RunPageLink = "Document No." = field("Document No."),
                                  "Document Type" = field("Document Type");
                Visible = false;
                ToolTip = 'Executes the Equipment Repair Plan action.';
            }
            action(Print)
            {
                ApplicationArea = Basic;
