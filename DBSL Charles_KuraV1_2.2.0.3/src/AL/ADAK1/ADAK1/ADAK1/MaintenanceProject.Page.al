...
Page 72234 "Maintenance Project"
{
    Caption = 'Job Card';
    DeleteAllowed = false;
    PageType = Document;
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Bill-to Customer No."; Rec."Bill-to Customer No.")
                {
                    ...
                    ToolTip = 'Specifies the value of the Contractor Number field.';
                }
            ...
            group(Posting)
            {
                ...
                field(Status; Rec.Status)
                {
                    ...
                    trigger OnValidate()
                    begin
                        if (Rec.Status = Rec.Status::"Under PBRM") and Rec.Complete then begin
