        ...
        area(navigation)
        {
            group("Request for Quotation")
            {
                ...
                action("Attach Agenda/Minutes")
                {
                    ...
                    //        minutesafterproceedtoaward:= payablesetuprec."RFP Documents Path"+filecu.GetFileName(FileName);
                    //     end;
                    // end;
                }
                action("Open Attached Agenda/Minutes")
                {
                    ...
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    ToolTip = 'Executes the Open Attached Agenda/Minutes action.';
