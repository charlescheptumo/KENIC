...
Table 69200 "HR Disciplinary Cases"
{
    ...
    fields
    {
        ...
        {
            Editable = false;
            OptionCaption = 'Open,Ongoing,Court Case,Closed,Appeal,Reinstated';
            OptionMembers = Open,Ongoing,"Court Case",Closed,Appeal,Reinstated;
        }
        ...
        field(3973; "Disciplinary Hearing Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        ...
        {
            DataClassification = ToBeClassified;
            Caption = 'Appeal/Review Date';
        }
        field(3977; "Response to Show Cause"; Text[50])
        {
            DataClassification = ToBeClassified;
        }
        field(3978; "Financial Year"; Integer)
        {
            DataClassification = ToBeClassified;
            TableRelation = "HR Leave Periods";
        }
        field(3979; "Date to Respond"; Date)
        {
            DataClassification = ToBeClassified;
            Caption = 'Date to Respond';
        }
        field(3980; "Current Step"; Option)
        {
         ...
         field(3981; "Hearing Venue"; text[250])
        {
            DataClassification = ToBeClassified;
            Caption = 'Date to Respond';
        }
    ...
    begin
        ...
        if "Case Number" = '' then begin
            ...
            HRSetup.TestField(HRSetup."Disciplinary Cases Nos.");
             rec. "Case Number":= NoSeriesMgt.GetNextNo(HRSetup."Disciplinary Cases Nos.", WorkDate(), true);
        end;
    end;
