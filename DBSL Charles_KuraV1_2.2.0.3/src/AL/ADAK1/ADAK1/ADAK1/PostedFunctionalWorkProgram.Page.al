...
Page 72294 "Posted Functional Work Program"
{
    Editable = false;
    PageType = Card;
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Total Budget Ceiling"; Rec."Total Budget Ceiling")
                {
                    ...
                    ToolTip = 'Specifies the value of the Total Work Plan Amount field.';
                }
                ...
                begin
                    ...
                    if NewRoadWorkProgramPackage.FindSet then begin
                        repeat
                            ...
                            ConsRoadWorkProgramPackage."Road Work Program ID" := Rec."Gloabal Budget Book ID";
                    ...
                    if NewRoadWorkProgramTask.FindSet then begin
                        repeat
                            ...
                            ConsRoadWorkProgramTask."Road Work Program ID" := Rec."Gloabal Budget Book ID";
                    ...
                    if NewRoadWorkProgramActivity.FindSet then begin
                        repeat
                            ...
                            ConRoadWorkProgramActivity."Road Work Program ID" := Rec."Gloabal Budget Book ID";
