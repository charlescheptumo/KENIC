...
Table 56008 "Receipt Lines1"
{
    ...
    fields
    {
                ...
                case "Account Type" of
                    "account type"::Customer:
                        begin
                            ...
                            //CustLedger.SetFilter(CustLedger."Document Type",'%1',CustLedger."Document Type"::Invoice);
                            CustLedger.SetRange(Open, true);
                            CustLedger.CalcFields(CustLedger.Amount);
                            CustLedger.SetFilter(CustLedger.Amount, '>%1', 0);//25
                    ...
                    "account type"::Customer:
                        begin
                            if VATCode <> '' then begin
                                VATAmount := ROUND(("Gross Amount" / (1 + "VAT Rate" / 100) * "VAT Rate" / 100), CSetup."Rounding Precision", Direction);
        ...
        field(69030; "Receipt Type"; Code[20])
        {
            TableRelation = "Receipts and Payment Types1".Code where(Type = const(Receipt));
            ...
            begin
                ...
                if RecPayTypes.Find('-') then begin
                    ...
                    if RecPayTypes."VAT Chargeable" = RecPayTypes."vat chargeable"::Yes then begin
                        "VATCode" := RecPayTypes."VAT Code";
                        if TarrifCode.Get("VATCode") then
        ...
        field(69031; "VAT Rate"; Decimal)
        {

        }
        field(69032; "VATCode"; Code[20])
        {
