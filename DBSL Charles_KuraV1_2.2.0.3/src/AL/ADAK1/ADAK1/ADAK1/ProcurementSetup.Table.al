...
Table 70060 "Procurement Setup"
{
    ...
    fields
    {
        ...
        field(129; "Vendor Appraisal Nos"; Code[100])
        {
            TableRelation = "No. Series".Code;
        }
        field(130; "Disposal Invitation Nos"; Code[1250])
        {
            TableRelation = "No. Series".Code;
        }
        field(131; "Item Journal Template Name"; Code[250])
        {
            TableRelation = "Item Journal Template";
        }
        field(132; "Item Journal Batch Name"; Code[250])
        {
            TableRelation = "Item Journal Batch".Name where("Journal Template Name" = field("Item Journal Template Name"));
            
        }
        field(133; "Procurement Officer License No"; Code[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(134; "Procurement Plan Notification"; DateFormula)
        {
            DataClassification = ToBeClassified;
        }
        field(135; "Return to Store Nos"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
        field(136; "Loan Issue Req. Nos"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
        field(137; "Loan Issue Surrender Nos"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
        field(138; "Item Rejection Nos"; Code[50])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
        field(139; "Meals Req. Nos"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
