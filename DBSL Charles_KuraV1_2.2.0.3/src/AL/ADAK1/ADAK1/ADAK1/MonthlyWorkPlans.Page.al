...
Page 72641 "Monthly Work Plans"
{
    ApplicationArea = Basic;
    CardPageID = "Monthly Work Plan";
    PageType = List;
    SourceTable = "Work Plan Header";
    SourceTableView = where("Document Type" = filter(Monthly),
    ...
    begin
        Rec."Document Type" := Rec."document type"::Monthly;
    end;
}
