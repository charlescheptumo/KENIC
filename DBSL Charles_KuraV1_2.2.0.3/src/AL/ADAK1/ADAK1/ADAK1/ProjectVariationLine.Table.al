...
Table 72262 "Project Variation Line"
{
    ...
    fields
    {
        ...
        field(7; "No."; Code[20])
        {
            ...
            TableRelation = "Purchase Line"."No." where("Document No." = field("Contract ID"));
            // trigger OnValidate()
            // var purchaseline: Record "Purchase Line";
            // begin
            //     purchaseline.Reset();
            //     purchaseline.SetRange("Document No.", "Contract ID");
            //     purchaseline.SetRange("No.", "No.");
            //     if purchaseline.FindFirst() then
            //     begin
            //         Description:= purchaseline.Description;
            //         "Original Quantity":= purchaseline.Quantity;
            //         "Original Total Cost (LCY)":= purchaseline."Amount";
            //         validate("Original Quantity"); 
            //     end;
            // end;
            trigger OnLookup()
            ...
            begin
                PurchaseLine.Reset();
                PurchaseLine.SetRange("Document No.", Rec."Contract ID");
        ...
        field(10; "Unit Cost (LCY)"; Decimal)
        {
            ...
            trigger OnValidate()
            begin
                Validate("Original Quantity","New Quantity");
            end;
        }
    ...
    begin
        ...
        if ProjectVariationHeader.FindSet then begin
            "Contract ID" := ProjectVariationHeader."Project ID";
