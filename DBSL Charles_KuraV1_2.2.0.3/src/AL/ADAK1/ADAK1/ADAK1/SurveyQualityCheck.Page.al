...
Page 72681 "Survey Quality Check"
{
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control19; "Survey Quality Check Lines")
            {
        ...
        area(FactBoxes)
        {
            part(Control1906354007; "Doc. Attachment List Factbox")
            {
                ...
                SubPageLink = "Table ID" = const(72336),
        ...
        area(navigation)
        {
            ...
            action("Print Summary")
            {
                ...
                begin
                    ...
                    if Rec.FindSet then
                        Report.Run(72056, true, true, Rec);
                end;
            }
            ...
            //                 RecVariant := Rec;
            //               //  RMSManagement.FnPopulateApprovalEntryCustomeWorkflow(RecVariant, Rec."Project Name", Documenttype::"HSE Plan", "Document No", ApprovalEntry."document type"::PCO, 0, RecordId, FnGetTableNo());
