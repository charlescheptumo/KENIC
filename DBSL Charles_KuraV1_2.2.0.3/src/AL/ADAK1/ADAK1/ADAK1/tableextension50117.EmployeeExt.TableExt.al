...
TableExtension 50117 "Employee Ext" extends Employee
{
    fields
    {
        ...
        */
        ...
        field(50083; "Working_Hours"; Decimal)
        {

            trigger OnValidate()
            begin
                "Hourly Rate" := "Daily Rate" / "Working_Hours";
            end;
        }
        ...
        {
            TableRelation = "Salary Scales".Scale where(Temporary = const(false));
        ...
        field(69072; "Allocated Leave Days"; Decimal)
        {
            ...
            begin
                ...
                "Leave Outstanding Bal" := "Total (Leave Days)" + "Total Leave Taken";
        ...
        field(70008; "Department Name"; Code[100])
        {
        ...
        field(70049; "Employee Category"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ' ,Permanent,Temporary,Casual';
            OptionMembers = " ",Permanent,"Temporary",Casual;
        }
        ...
        field(70066; "Staff Exit Code"; Code[50])
        {
            ...
            // begin
            //     StaffExitSetup.Reset();
            //     StaffExitSetup.SetRange("Exit Code", Rec."Staff Exit Code");
            //     if StaffExitSetup.FindFirst then begin
        ...
        field(70076; "Separation Type"; Enum "Separation Type")
        {
        }
        field(70077; "Chief Executive Officer"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70078; "Document Type"; Enum "Employee Doc Type")
        {
            DataClassification = ToBeClassified;
        }
        field(70079; CEO; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70080; "Date of Reinstatement"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(70081; "Reinstatement By"; Code[200])
        {
            DataClassification = ToBeClassified;
            TableRelation = User."User Name";
        }
        field(70082; "Reinstatement Reason"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(70083; Closed; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70084; "Use Leave Plan"; Boolean)
        {

        }
        field(70085; "Use Leave Days"; Boolean)
        {

        }
        field(70086; "No of Leave Days to Use"; Decimal)
        {

        }
        field(70087; "Committee Member"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70088; "Section Code"; Code[250])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Responsibility Center" where("Operating Unit Type" = const(Section));
        }
        field(70089; "Welfare Member"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70090; "Birth Certificate Number"; Code[30])
        {
        }
        field(70091; "Special Duty Days"; Decimal)
        {

        }
        field(70092; "Terminal Leave Acc."; Decimal)
        {
            CalcFormula = sum("HR Leave Ledger Entries"."No. of days" where("Leave Type" = const('TERMINAL'),
                                                                             "Staff No." = field("No.")));
            FieldClass = FlowField;
            Editable = false;
        }
        field(70093; "Terminal Leave Days"; Decimal)
        {
            CalcFormula = sum("Employee Leaves"."No. Of Days" where("Employee No" = field("No."),
                                                                     "Posting  Date" = field("Date Filter"),
                                                                     "Leave Code" = const('TERMINAL'),
                                                                     Posted = const(true)));
            FieldClass = FlowField;
            Editable = false;
        }
        field(70094; "Employee No Sort Key"; Text[50])
        {
    ...
    keys
    {
        ...
        // 
        // //Unsupported feature: Deletion (KeyCollection) on ""Last Name","First Name","Middle Name"(Key)".
        // 
        // key(Key1;"First Name","Last Name","Middle Name")
        // {
        // }
    }
    ...
    */
    ...
    trigger OnInsert()
    begin
        "Employee No Sort Key" := GenerateSortKey();
    end;
    ...
    procedure GenerateSortKey(): Text[50]
    var
        EmpNo: Text[50];
        i: Integer;
        CurrentChar: Char;
    ...
    begin
        ...
        for i := 1 to StrLen(EmpNo) do begin
            CurrentChar := EmpNo[i];

            if CurrentChar in ['0' .. '9'] then begin
                NumericPart += Format(CurrentChar);
                IsInNumber := true;
            end else begin
                if IsInNumber and (NumericPart <> '') then begin
                    TextPart += PadStr('', 10 - StrLen(NumericPart), '0') + NumericPart;
                    NumericPart := '';
                    IsInNumber := false;
                end;
                TextPart += UpperCase(Format(CurrentChar));
            end;
        end;
