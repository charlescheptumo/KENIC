...
Table 80111 "Policy"
{
   ...
   Code := NoSeriesMgt.GetNextNo(SPMSetup."External Policy No. Series", WorkDate(), true);
            end;
        end;
        ...
        if (Type = Type::Internal) then begin
            if Code = '' then begin
                ...
                SPMSetup.TestField("Internal Policy No. Series");
                  Code := NoSeriesMgt.GetNextNo(SPMSetup."Internal Policy No. Series", WorkDate(), true);
            end;
        end;
    end;
