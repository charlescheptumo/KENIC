report 50013 "Trial Balance KICD"
{
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            RequestFilterFields = "No.", "Account Type", "Date Filter", "Budget Filter", "Global Dimension 1 Filter", "Global Dimension 2 Filter", "Global Dimension 3 Filter";
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(G_L_Account___Net_Change_; +"G/L Account"."Net Change1")
                {
                    DecimalPlaces = 0 : 0;
                }
                column(G_L_Account___Net_Change__Control28; -"G/L Account"."Net Change1")
                {
                    DecimalPlaces = 0 : 0;
                }
                ...
                column(G_L_Account___Budgeted_Amount_; +"G/L Account"."Budgeted Amount1")
                {
                    DecimalPlaces = 0 : 0;
                }
                ...
                column(GLAcc2__Budget_at_Date_; +GLAcc2."Budget at Date1")
                {
                    DecimalPlaces = 0 : 0;
                }
                ...
                column(G_L_Account___Net_Change__Control37; +"G/L Account"."Net Change1")
                {
                    DecimalPlaces = 0 : 0;
                }
                column(G_L_Account___Net_Change__Control38; -"G/L Account"."Net Change1")
                {
                    DecimalPlaces = 0 : 0;
                }
                ...
                column(G_L_Account___Budgeted_Amount__Control40; +"G/L Account"."Budgeted Amount1")
                {
                    DecimalPlaces = 0 : 0;
                }
                ...
                column(GLAcc2__Budget_at_Date__Control44; +GLAcc2."Budget at Date1")
                {
                    DecimalPlaces = 0 : 0;
                }
            }
            ...
            begin
                CalcFields("Net Change1", "Budgeted Amount1", "Balance at Date");
                GLAcc2 := "G/L Account";
                GLAcc2.CalcFields("Budget at Date1");
                if "Budgeted Amount1" = 0 then
                    DiffPct := 0
                else
                    DiffPct := "Net Change1" / "Budgeted Amount1" * 100;
                if GLAcc2."Budget at Date1" = 0 then
                    DiffAtDatePct := 0
                else
                    DiffAtDatePct := "Balance at Date" / GLAcc2."Budget at Date1" * 100;
    ...
    begin
        ...
        GLBudgetFilter := "G/L Account".GetFilter("Global Dimension 3 Filter");
    end;
