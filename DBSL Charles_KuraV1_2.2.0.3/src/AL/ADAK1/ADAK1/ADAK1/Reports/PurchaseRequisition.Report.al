...
Report 50097 "Purchase Requisition"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            RequestFilterFields = "No.", "Buy-from Vendor No.", "No. Printed", "PP Planning Category";
            ...
            column(Phone1; CompanyInfo1."Phone No.")
            {
            }
            column(PhoneNo; CompanyInfo1."Phone No. 2")
            {
            }
            column(CompanyFax; CompanyInfo."Fax No.")
            {
            }
            column(CompanyEmail; CompanyInfo1."E-Mail")
            {
            }
            ...
            column(PreparedBy; "Purchase Header"."Request-By Name")
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Purchase Line"; "Purchase Line")
                    {
                        ...
                        // column(Road_Code_; "Purchase Line"."Road Code.")
                        // {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        // column(Road_Code_2; "Purchase Line"."Road Code.")
                        // {
