...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Receipt1.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Receipt Header"; "Receipts Header1")
        {
            ...
            column(ShortcutDimension1Code_ReceiptHeader; "Shortcut Dimension 1 Code")
            {
            }
            column(ShortcutDimension2Code_ReceiptHeader; "Shortcut Dimension 2 Code")
            {
            }
            dataitem("Receipt Line"; "Receipt Lines1")
            {
                ...
                column(AccountNo_ReceiptLine; "Account No.")
                {
                }
                ...
                begin
                    if CurrReport.Preview = false then begin
                        "Receipt Header"."No. Printed" := "Receipt Header"."No. Printed" + 1;
                        "Receipt Header".Modify;
                        Message('%1', "Receipt Header"."No. Printed");
                    end;
                end;
            ...
            begin
                ...
                //No. Printed
                if "Receipt Header"."No. Printed" = 0 then
