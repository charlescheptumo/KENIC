...
Page 75279 "Proffesion Opinion Lines"
{
    ...
    ApplicationArea = All;
    Caption = 'Professional Opinion Lines';
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Procurement Head Comments field.';
                }
                ...
                field("Final Evaluation Remarks"; Rec."Final Evaluation Remarks")
                {
                    ApplicationArea = Basic;
                    MultiLine = true;
                    ToolTip = 'Specifies the value of the Final Evaluation Remarks field.';
                }
