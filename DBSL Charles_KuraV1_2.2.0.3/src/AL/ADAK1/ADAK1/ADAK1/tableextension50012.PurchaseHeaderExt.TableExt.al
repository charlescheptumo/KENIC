...
TableExtension 50012 "Purchase Header Ext" extends "Purchase Header"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = 'Quote,Order,Invoice,Credit Memo,Blanket Order,Return Order,Store Requisition,Purchase Requisition,,,,,,IEC Materials,Meal Requisition';
        ...
        */
        ...
        field(50012; "Requisition Type"; Option)
        {
            ...
            OptionCaption = ' ,Internal Use,Project,Stock Replenishment,Technical Installation,Technical Maintenance,Stock Return,Loan,Loan Surrender';
            OptionMembers = " ","Internal Use",Project,"Stock Replenishment","Technical Installation","Technical Maintenance","Stock Return",Loan,"Loan Surrender";
        ...
        field(70046; "Procurement Plan ID"; Code[10])
        {
            ...
            TableRelation = "Procurement Plan".Code where("Approval Status" = const(Released));
        }
...
"Entry Used" = const(false),
        ...
        {
            CalcFormula = sum("Purchase Line".Amount where("Document Type" = field("Document Type"), "Document No." = field("No."), "Contract Type" = const(Construction)));
            // Editable = false;
            FieldClass = FlowField;
            Editable = false;
        }
        ...
        field(70234; Test; Code[5])
        {

        }
        field(70235; "Procurement Plan Item Descript"; Text[250])
        {
        ...
        field(70236; "Item Category Description"; Text[250])
        {

        }
        field(70237; "WorkPlan No"; Code[20])
        {
        ...
        field(70238; "Work Execution Plan No"; Code[20])
        {

        }
        field(70239; "Engineer Commencement Date"; Date)
        {
        ...
        field(70240; "Contractor Signature"; Blob)
        {

        }
        field(70241; "Variation of Price %"; Decimal)
        {

        }
        field(70242; "Contingency Rate"; Decimal)
        {

        }
        field(70243; "Advance Payment Rate"; Decimal)
        {

        }
        field(70244; "Variation of Works %"; Decimal)
        {
        ...
        field(70245; "Variation of Works Amount"; Decimal)
        {

            Editable = false;
        }
        field(70246; "Assigded Procument Officer"; Code[100])
        {
        ...
        field(70247; "Payment Type"; Option)
        {
        ...
        field(70248; "Bid Scoring Template"; Code[30])
        {

            TableRelation = "Bid Scoring Template".Code;
        }
        field(70249; "Estimated Cost"; decimal)
        {


        }
        field(70250; "Entry Used"; boolean)
        {

        }
        field(70251; "Directorate Name"; Text[1080])
        {

        }
        field(70252; "Department Name2"; Text[1080])
        {

        }
        //IanCasper
        field(70253; PRN; Code[20])
        {
        ...
        field(70254; "End Of Contract Date"; Date)
        {

        }
        field(70255; "PBRM Period"; Duration)
        {

        }
        field(70256; "Contract Period"; Duration)
        {

        }
        field(70257; Rejected; Boolean)
        {
        }
        field(70258; "Shortcut Dimension 1 filter"; Code[20])
        {
            FieldClass = FlowFilter;
        }
        field(70259; "Reasons for Termination"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(70260; "Is Terminated"; Boolean)
        {

        }
        field(70261; "Customer No."; Code[20])
        {
            ...
            begin
                ...
                if Cust.FindFirst() then begin
                    ...
                    Rec."Customer Phone" := Cust."Phone No.";
                    Rec."Customer Phone2" := Cust."Mobile Phone No.";
                    Rec."Customer EMail" := Cust."E-Mail";
                    Rec."Customer Address" := Cust.Address;
                    Rec."Customer Address2" := Cust."Address 2";
                    Rec."Customer City" := Cust.City;
                    Rec."Customer Country" := Cust."Country/Region Code";
                    Rec."Customer Post Code" := Cust."Post Code";
                end;
            end;
        }
        field(70262; "Customer Name"; Text[100])
        {
            TableRelation = Customer.Name;
            ValidateTableRelation = false;
        }
        field(70263; "Customer Phone"; Text[100])
        {
        }
        field(70264; "Customer EMail"; Text[100])
        {
        }
        field(70265; "Customer Address"; Text[100])
        {
        }
        field(70266; "Customer Address2"; Text[100])
        {
        }
        field(70267; "Customer City"; Text[100])
        {
        }
        field(70268; "Customer Country"; Text[100])
        {
        }
        field(70269; "Customer Post Code"; Text[100])
        {
        }
        field(70270; "Customer Phone2"; Text[100])
        {
        }
        field(70271; Duration; Code[10])
        {
            trigger OnValidate()
            begin
        ...
        field(70272; "Start Date"; Date)
        {
            trigger OnValidate()
            begin
                if Rec.Duration <> '' then begin
                    Rec."End Date" := CalcDate(Rec.Duration, Rec."Start Date");
                end;
            end;
        }
        field(70273; "End Date"; Date)
        {
            Editable = false;
            trigger OnValidate()
            begin
                "No_of_Days" := CalculateNoOfDays("Date", "End Date");
            end;
        }
        field(70274; "Issue Date"; Date)
        {
        }
        field(70275; "Loan Amount"; Decimal)
        {
            CalcFormula = sum("Purchase Line"."Line Amount" where("Document Type" = field("Document Type"),
                                                                   "Document No." = field("No.")));
            Editable = false;
        ...
        field(70276; "Loan Issue No."; Code[20])
        {
            TableRelation = "Purchase Header"."No." /*where("Document Type" = filter("Loan Issue Requisition"),Status = filter(Released),"Fully Issued" = const(true))*/;
            ...
            var
                ...
                LineNo: Integer;
            begin
                if Rec."Loan Issue No." <> '' then begin
                    PHeader.Reset();
                    PHeader.SetRange("No.", Rec."Loan Issue No.");
                    PHeader.SetRange("Document Type", PHeader."Document Type"::"Loan Issue Requisition");
                    if PHeader.FindFirst() then begin
                        Rec."Customer No." := PHeader."Customer No.";
                        Rec.Validate("Customer No.");
                        Rec."Start Date" := PHeader."Start Date";
                        Rec."End Date" := PHeader."End Date";
                        Rec.Duration := PHeader.Duration;
                        Rec."Issue Date" := PHeader."Issue Date";
                        Rec."Return Date" := PHeader."End Date";
                        ...
                        PLines.Reset;
                        PLines.SetRange("Document No.", Rec."Loan Issue No.");
                        PLines.SetRange("Document Type", PHeader."Document Type");
                        if PLines.FindSet() then begin
                            repeat
                                PLines2.Init;
                                LineNo := LineNo + 1000;
                                PLines2."Document No." := Rec."No.";
                                PLines2."Document Type" := Rec."Document Type";
                                PLines2.Type := PLines.Type;
                                PLines2."No." := PLines."No.";
                                PLines2."Line No." := LineNo;
                                PLines2.Description := PLines.Description;
                                PLines2."Item Category Code" := PLines."Item Category Code";
                                PLines2."Location Code" := PLines."Location Code";
                                PLInes2.Quantity := PLines.Quantity;
                                PLines2."Unit of Measure Code" := PLines."Unit of Measure Code";
                                PLines2."Qty. Requested" := PLines."Qty. Requested";
                                PLines2."Qty Approved" := PLines."Qty Approved";
                                PLines2."Quantity To  Issue" := PLines."Quantity To  Issue";
                                PLines2."Direct Unit Cost" := PLines."Direct Unit Cost";
                                PLines2."Line Amount" := PLines."Line Amount";
                                PLines2."Gen. Bus. Posting Group" := PLines."Gen. Bus. Posting Group";
                                PLines2."Gen. Prod. Posting Group" := PLines."Gen. Prod. Posting Group";
                                PLines2."VAT Prod. Posting Group" := PLines."VAT Prod. Posting Group";
                                PLines2."Requisition Status" := PLines."Requisition Status";
                                PLines2."Quantity  issued" := PLines."Quantity  issued";
                                PLines2.Insert(true);
                            until PLines.Next() = 0;
                        end;
                    end;
        ...
        field(70277; "Return Date"; Date)
        {
        }
        field(70278; "Termination Date"; Date)
        {
        }
        //IanCasper
        field(70279; "Commitee Appointment No"; Code[20])
        {
            TableRelation = "IFS Tender Committee"."Document No.";//where (Inspection=const(true));
        }
        field(70280; "Expected No. of People"; Integer)
        {

        }
        field(70281; "Actual No. of People"; Integer)
        {
        }
        field(70282; "Name of the Conference"; Text[250])
        {
        }
        field(70283; Date; Date)
        {
        }
        field(70284; Time; TIme)
        {
        }
        field(70285; "Total Cost"; Decimal)
        {
            FieldClass = FlowField;
            CalcFormula = sum("Meals Subform".Amount where("Document No." = field("No.")));
        }
        field(70286; Issued; Boolean)
        {
            Editable = false;
        }
        field(70287; "Posted By"; Code[50])
        {
            Editable = false;
        }
        field(70288; "Customer Name2"; Text[250])
        {

        }
        field(70289; Surrendered; Boolean)
        {

        }
        field(70290; "Surrender Date"; Date)
        {

        }
        field(70291; "No_of_Days"; Integer)
        {


        }
        field(70292; "Purchase Invoice Created "; Boolean)
        {

        }
        Field(70293; "Purchase Invoice Created By"; Text[100])
        {
    ...
    */
    ...
    begin
        ...
        IF ("Document Type" = "Document Type"::"Loan Issue Surrender") AND (Rec."Loan Issue No." <> '') THEN BEGIN
            if Rec."Loan Issue No." = xRec."Loan Issue No." then
                exit;
            Rec.Validate("Loan Issue No.");
        END;
    end;
    ...
    */
    ...
    trigger OnBeforeDelete()
    begin
        if Rec."Document Type" in [Rec."Document Type"::Order,
                                    Rec."Document Type"::"Blanket Order",
                                    Rec."Document Type"::Invoice,
                                    Rec."Document Type"::Quote,
                                    Rec."Document Type"::"Credit Memo",
                                    Rec."Document Type"::"Return Order"] then
            Error('You cannot delete %1 %2', Rec."Document Type", Rec."No.");
    end;
    ...
    begin
        ...
        if rec."Document Type" = rec."Document Type"::"Purchase Requisition" then begin
            IF rec."No." = '' THEN BEGIN
                ...
                rec."No." := NoSeriesMgt.GetNextNo(PurchSetup."Purchase Req No", WorkDate(), true);
            END;
        ...
        if rec."Document Type" = rec."Document Type"::"Store Requisition" then begin
            IF rec."No." = '' THEN BEGIN
                ...
                rec."No." := NoSeriesMgt.GetNextNo(PurchSetup."Store Req No", WorkDate(), true);
            END;

        end;
        if rec."Document Type" = rec."Document Type"::"Loan Issue Requisition" then begin
            IF rec."No." = '' THEN BEGIN

                PurchSetup.GET;
                PurchSetup.TESTFIELD("Loan Issue Req. Nos");
                rec."No." := NoSeriesMgt.GetNextNo(PurchSetup."Loan Issue Req. Nos", WorkDate(), true);
            END;

        end;
        if rec."Document Type" = rec."Document Type"::"Loan Issue Surrender" then begin
            IF rec."No." = '' THEN BEGIN

                PurchSetup.GET;
                PurchSetup.TESTFIELD("Loan Issue Surrender Nos");
                rec."No." := NoSeriesMgt.GetNextNo(PurchSetup."Loan Issue Surrender Nos", WorkDate(), true);
            END;

        end;
        if rec."Document Type" = rec."Document Type"::"Item Rejection" then begin
            IF rec."No." = '' THEN BEGIN

                PurchSetup.GET;
                PurchSetup.TESTFIELD("Item Rejection Nos");
                rec."No." := NoSeriesMgt.GetNextNo(PurchSetup."Item Rejection Nos", WorkDate(), true);
            END;
        end;
        if rec."Document Type" = rec."Document Type"::"Meals Requisition" then Begin
            if Rec."No." = '' Then Begin
                PurchSetup.GET;
                PurchSetup.TESTFIELD("Meals Req. Nos");
                "No. Series" := PurchSetup."Meals Req. Nos";
                if NoSeries.AreRelated(PurchSetup."Meals Req. Nos", xRec."No. Series") then
                    "No. Series" := xRec."No. Series";
