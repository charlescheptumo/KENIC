...
TableExtension 50033 "tableextension50033" extends "Standard Purchase Line"
{
    ...
    fields
    {
        ...
        */
        ...
        field(50001; "Gen. Bus. Posting Group"; Code[20])
        {
        ...
        field(50003; "Tax Group Code"; Code[20])
        {
            Caption = 'Tax Group Code';
            DataClassification = ToBeClassified;
            TableRelation = "Tax Group";
        }
        field(50004; "VAT Bus. Posting Group"; Code[20])
        {
        ...
        field(50006; "Posting Group"; Code[20])
        {
        ...
        field(50007; "FA Posting Date"; Date)
        {
            Caption = 'FA Posting Date';
            DataClassification = ToBeClassified;
        }
        field(50008; "FA Posting Type"; Option)
        {
        ...
        field(50009; "Depreciation Book Code"; Code[10])
        {
        ...
        field(50010; "Maintenance Code"; Code[10])
        {
        ...
        field(70038; "Technical Specifications"; Text[300])
        {
            DataClassification = ToBeClassified;
        }
