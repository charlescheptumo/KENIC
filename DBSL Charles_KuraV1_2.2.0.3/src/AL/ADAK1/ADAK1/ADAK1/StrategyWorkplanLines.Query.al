...
Query 80004 "StrategyWorkplanLines"
{

    elements
    {
        dataitem(Strategy_Workplan_Lines; "Strategy Workplan Lines")
        {
            column(No; No)
            {
            }
            ...
            column(Activity_ID; "Activity ID")
            {
            }
            ...
            column(Imported_Annual_Budget_Est; "Imported Annual Budget Est.")
            {
            }
            ...
            column(Q1_Budget; "Q1 Budget")
            {
            }
            column(Q2_Target; "Q2 Target")
            {
            }
            column(Q2_Budget; "Q2 Budget")
            {
            }
            column(Q3_Target; "Q3 Target")
            {
            }
            column(Q3_Budget; "Q3 Budget")
            {
            }
            column(Q4_Target; "Q4 Target")
            {
            }
            column(Q4_Budget; "Q4 Budget")
            {
            }
