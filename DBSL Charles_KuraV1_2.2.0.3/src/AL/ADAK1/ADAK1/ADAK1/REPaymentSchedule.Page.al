...
Page 72684 "RE Payment Schedule"
{
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Contractor Email field.';
                }
                field("Contractor Phone No"; Rec."Contractor Phone No")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Contractor Phone No field.';
                }
            ...
            part(Control19; "RE Payment Schedule Lines")
            {
        ...
        //                     Message('Payment Schedule for the Month of'+' '+"Payment Month"+' '+'successfully sent to'+' '+"Contractor Name");
        //                 end;
        //             }
