...
Table 80055 "Perfomance Contract Header"
{
    ...
    fields
    {
        ...
        field(2; "Document Type"; Option)
        {
            ...
            OptionCaption = 'Board/Executive PC,CEO/Corporate PC,Functional/Operational PC,Individual Scorecard ,CEO/Corporate Awp,Individual Scorecard PC';
            OptionMembers = "Board/Executive PC","CEO/Corporate PC","Functional/Operational PC","Individual Scorecard","CEO/Corporate Awp","Individual Scorecard PC";
        }
        ...
        field(62; "Department Plan ID"; code[50])
        {
            TableRelation = "Annual Strategy Workplan".No;
        }
        field(63; "Do you have a senior?"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(64; Department; Code[30])
        {
        ...
        field(65; "Department Name"; Code[100])
        {

        }
        field(66; "Amended"; Boolean)
        {
            Editable = false;
        }
        field(67; "Amended to Document No"; Code[50])
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(68; "Amendment of Document No"; Code[50])
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(69; "Amendment Date"; Date)
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
    ...
    procedure ValidateMinimumObjectives()
    var
        PCObjective: Record "PC Objective";
        AdditionalPCObjective: Record "Additional PC Objective";
        CoreCount: Integer;
        DepartmentalCount: Integer;
        TotalCount: Integer;
    begin
        CoreCount := 0;
        DepartmentalCount := 0;
        ...
        PCObjective.Reset();
        PCObjective.SetRange("Workplan No.", Rec.No);
        CoreCount := PCObjective.Count;

        AdditionalPCObjective.Reset();
        AdditionalPCObjective.SetRange("Workplan No.", Rec.No);
        DepartmentalCount := AdditionalPCObjective.Count;

        TotalCount := CoreCount + DepartmentalCount;

        if TotalCount < 6 then
            Error('Total objectives must be at least 6. Current: Core Initiatives = %1, Departmental Objectives = %2, Total = %3',
                  CoreCount, DepartmentalCount, TotalCount);
    end;
}
