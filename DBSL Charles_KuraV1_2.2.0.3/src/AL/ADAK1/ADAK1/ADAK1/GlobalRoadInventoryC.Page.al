    ...
    layout
    {
        area(content)
        {
...

            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Start Chainage Name field.';
                }
                ...
                field("Paved Start Chainage(KM)"; Rec."Paved Start Chainage(KM)")
                {
                    ApplicationArea = basic;
                    ToolTip = 'Specifies the value of the Paved Start Chainage(KM) field.';
                }
                field("Paved End Chainage(KM)"; Rec."Paved End Chainage(KM)")
                {
                    ApplicationArea = basic;
                    ToolTip = 'Specifies the value of the Paved End Chainage(KM) field.';
                }
                ...
                field("UnPaved Start Chainage(KM)"; Rec."UnPaved Start Chainage(KM)")
                {
                    ApplicationArea = basic;
                    ToolTip = 'Specifies the value of the UnPaved Start Chainage(KM) field.';
                }
                field("UnPaved End Chainage(KM)"; Rec."UnPaved End Chainage(KM)")
                {
                    ApplicationArea = basic;
                    ToolTip = 'Specifies the value of the UnPaved End Chainage(KM) field.';
                }
            ...
            group("Asset Management Profile")
            {
                ...
                field("No. of Roadside Devpt Apps"; Rec."No. of Roadside Devpt Apps")
                {
                    ...
                    Editable = false;
                    ToolTip = 'Specifies the value of the No. Of Pending RoadSide Development Applications field.';
                }
                field("No. of App Roadside Devpt Apps"; Rec."No. of App Roadside Devpt Apps")
                {
                    ...
                    Editable = false;
                    ToolTip = 'Specifies the value of the No. of Approved Roadside Development Applications field.';
                }
                field("No. of Rej Roadside Devpt Apps"; Rec."No. of Rej Roadside Devpt Apps")
                {
                    ...
                    Editable = false;
                    ToolTip = 'Specifies the value of the No. of Rejected Roadside Development Applications field.';
                }
    ...
    actions
    {
        area(navigation)
        {
            group(ActionGroup28)
            {
                ...
                action("Road Reserve Widths")
                {
                    ...
                    ToolTip = 'Executes the Road Reserve Widths action.';
                }
        ...
        area(processing)
        {
            ...
            action("Conditions Surveys")
            {
                ...
                ToolTip = 'Executes the Conditions Surveys action.';
            }
            action("Design Works")
            {
                ApplicationArea = Basic;
