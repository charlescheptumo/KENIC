    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Order to Commence Reference field.';
                }
                ...
                field("Staff Appointment Voucher No."; Rec."Staff Appointment Voucher No.")
                {
                    ...
                    Visible = false;
                    ToolTip = 'Specifies the value of the Staff Appointment Requisition No. field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Commencement Period field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Time for Completion field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Possession of Site Issued field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the User Group field.';
                }
            }
            ...
            group("Possession of Site Details")
            {
                ...
                Rec."Possession of Site Reference")
                {
                    ...
                    ToolTip = 'Specifies the value of the Possession of Site Reference No field.';
                }
                field("Possession of Site Date"; Rec."Possession of Site Date")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Possession of Site Date field.';
                }
            }
            ...
            group("Acknowledgement Details")
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Representative ID field.';
                }
                ...
                field("Acknowledgement Status"; Rec."Acknowledgement Status")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    ToolTip = 'Specifies the value of the Acknowledgement Status field.';
                }
    ...
    actions
    {
        area(navigation)
        {
            action("Kick-Off Meeting")
            {
                ...
                ToolTip = 'Executes the Planned Meetings action.';
            ...
            action(Print)
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Print Order to Commence action.';
            ...
            action("Suggest Project Team")
            {
                ...
                PromotedOnly = true;
                Visible = false;
                ToolTip = 'Executes the Suggest Project Team action.';
            ...
            action("PCO Required Document")
            {
                ...
                RunPageLink = "Notice No." = field("Document No.");
                ToolTip = 'Executes the  Required Document action.';
            }
            ...
            action("Contract Securities")
            {
                ...
                RunPageMode = View;
                ToolTip = 'Executes the Filed Contract Security action.';
            }
            ...
            action("Possession of Site Sub Clauses")
            {
                ...
                ToolTip = 'Executes the Possession of Site Sub Clauses action.';
            }
            ...
            action("Issue Posession of Site Letter")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Issue Posession of Site Letter action.';
