...
Table 69619 "Recruitment Requisition Header"
{
    ...
    fields
    {
        ...
        field(5; "Position ID"; Code[30])
        {
            ...
            TableRelation = if ("Recruitment Plan Type" = const("Annual HR Plan")) "Recruitment Plan Position"."Position ID" where("Recruitment Plan ID" = field("Recruitment Plan ID"));
            ...
            begin
                ...
                if PlanningLine.FindSet then begin
                    "No of Openings" := PlanningLine."Total Planned New Hires";
                ...
                // RecruitmentReqResponsibility.SetRange("Document No.", "Document No.");
                // RecruitmentReqResponsibility.SetRange("Document Type", "Document Type");
                // if RecruitmentReqResponsibility.FindSet then begin
                //     repeat
                //         RecruitmentReqResponsibility."Line No." := RecruitmentReqResponsibility."Line No." + 10;
                //         PositionsResponsibility.Reset();
                //         PositionsResponsibility.SetRange("Position ID", "Position ID");
                //         if PositionsResponsibility.FindSet then begin
                //             RecruitmentReqResponsibility.Description := PositionsResponsibility.Description;
                //         end;
                //         RecruitmentReqResponsibility.Modify();
                //     until RecruitmentReqResponsibility.Next() = 0;
                // end else begin
                //     repeat
                //         RecruitmentReqResponsibility.Init();
                //         RecruitmentReqResponsibility."Line No." := RecruitmentReqResponsibility."Line No." + 10;
                //         RecruitmentReqResponsibility."Document No." := "Document No.";
                //         RecruitmentReqResponsibility."Document Type" := "Document Type";
                //         PositionsResponsibility.Reset();
                //         PositionsResponsibility.SetRange("Position ID", "Position ID");
                //         if PositionsResponsibility.FindSet then begin
                //             RecruitmentReqResponsibility.Description := PositionsResponsibility.Description;
                //         end;
                //         RecruitmentReqResponsibility.Insert();
                //     until RecruitmentReqResponsibility.Next() = 0;
                // end;
            end;
        }
...
;
    ...
    begin
        if "Document Type" = "Document Type"::"Job Vacancy" then begin
            ...
            if "Document No." = '' then begin
                "No. Series" := HumanResourcesSetup."Vacancy Nos.";
        ...
        if "Document Type" = "Document Type"::"Recruitment Requisition" then begin
            ...
            if "Document No." = '' then begin
                "No. Series" := HumanResourcesSetup."Recruitment Requsition Nos.";
                "Document No." := NoSeriesMgt.GetNextNo("No. Series", WorkDate(), true);
            end;
        end;
    ...
    var
        ...
        PlanningLine: Record "Recruitment Plan Position";
