...
/// <summary>
/// Page Procurement  Role Center (ID 65136).
/// </summary>
        ...
        area(sections)
        {
            group(Planning)
            {
                ...
                action("Vendor List ")
                {
                    ...
                    ToolTip = 'Executes the Suppliers action.';
                }
                action("Supplier Categories")
                {
                    ApplicationArea = Basic;
                    RunObject = Page "Fiscal Year Categories";
                    ToolTip = 'Executes the Supplier Categories action.';
                }
            ...
            group("Procurement Process")
            {
                ...
                action("Request For Proposal")
                {
                    ...
                    ToolTip = 'Executes the RFP List action.';
                }
                action("RFP -Pending CPO Approval")
                {
                    ...
                    ToolTip = 'Executes the RFP Pending Approval action.';
                }
                action("Approved RFP List")
                {
                    ...
                    ToolTip = 'Executes the Approved RFP List action.';
                }
            }
            group(Approvals)
            {
