...
TableExtension 50101 "tableextension50101" extends "Workflow User Group Member"
{
    fields
    {
        field(50000; "HR Position"; Code[50])
        {

            TableRelation = Positions."Position ID";
        }
        field(50001; "Region Code"; Code[50])
        {

            TableRelation = "Responsibility Center".Code where("Operating Unit Type" = filter(Region));
        }
        field(50002; "Alternative Station"; Code[50])
        {

            TableRelation = "Responsibility Center".Code where("Operating Unit Type" = filter(Region));
        }
        field(50003; "Project Role"; Code[20])
        {

            TableRelation = "Internal Project Resource"."Role Code" where("Project ID" = field("Project ID"));
        }
        field(50004; "Project ID"; Code[100])
        {

            Editable = false;
            TableRelation = Job."No.";
        }
        field(50005; "Project Based"; Boolean)
        {

        }
        field(50006; Delegation; Boolean)
        {
