        ...
        area(content)
        {
            group(General)
            {
                ...
                field("No of Quarters"; Rec."No of Quarters")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    ToolTip = 'Specifies the value of the No of Quarters field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Genererated Appraisal field.';
                }
            }
        }
    }
    ...
    actions
    {
        area(creation)
        {
            action("Quartely Review Periods")
            {
                ...
                ToolTip = 'Executes the Quartely Review Periods action.';
            }
        }
    }
}
