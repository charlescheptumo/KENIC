...
TableExtension 50122 "Human Resources Setup Ext" extends "Human Resources Setup"
{
    ...
    fields
    {
        ...
        field(69048; "Retirement Age"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(69646; "CEO Booking Nos"; Code[10])
        {
            TableRelation = "No. Series";
        }
        field(69647; "Meeting Nos."; code[20])
        {
            TableRelation = "No. Series";
            DataClassification = ToBeClassified;
        }
        field(69648; "CEO Task Assignment Nos"; Code[10])
        {
            TableRelation = "No. Series";
        }
        field(69649; "CEO Task Assignment Line Nos"; Code[10])
        {
            TableRelation = "No. Series";
        }
        field(69650; "Candidate Interview Nos"; Code[50])
        {
            TableRelation = "No. Series";
        }
        field(69651; "Consolidated Interview Nos"; Code[50])
        {
            TableRelation = "No. Series";
        }
        field(69652; "Project Team Nos"; Code[100])
        {
            TableRelation = "No. Series";
        }
        field(69653; "Suggestion Box Nos"; Code[100])
        {
            TableRelation = "No. Series";
        }
        field(69654; "Leave Plan Nos."; Code[20])
        {
            Caption = 'Leave Plan Nos.';
            TableRelation = "No. Series";
        }
        field(69655; "Leave Plan First Weekday"; Option)
        {
            Caption = 'Leave Plan First Weekday';
            OptionCaption = 'Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday';
            OptionMembers = Monday,Tuesday,Wednesday,Thursday,Friday,Saturday,Sunday;

            trigger OnValidate()
            begin
                if "Leave Plan First Weekday" <> xRec."Leave Plan First Weekday" then begin
                    LeavePlanHeader.Reset();
                    if not LeavePlanHeader.IsEmpty() then
                        Error(Text002, FieldCaption("Leave Plan First Weekday"));
                end;
            end;
        }
        // field(69656; "Leave Plan by Job Approval"; Option)
        // {
        //     Caption = 'Leave Plan by Job Approval';
        //     OptionCaption = 'Never,Machine Only,Always';
        //     OptionMembers = Never,"Machine Only",Always;

        //     trigger OnValidate()
        //     begin
        //         if "Leave Plan by Job Approval" <> xRec."Leave Plan by Job Approval" then begin
        //             LeavePlanLine.Reset();
        //             // LeavePlanLine.SetRange(Type, LeavePlanLine.Type::Job);
        //             LeavePlanLine.SetRange(Status, LeavePlanLine.Status::Submitted);
        //             if not LeavePlanLine.IsEmpty() then
        //                 Error(Text001, FieldCaption("Leave Plan by Job Approval"));
        //         end;
        //     end;
        // }
        field(69657; "Use New Leave Plan Experience"; Boolean)
        {
            Caption = 'Use New Leave Plan Experience';
            DataClassification = SystemMetadata;
            InitValue = true;
            ObsoleteReason = 'Replacement of NewLeavePlanExperience feature key until removal of old one.';
#if not CLEAN22
            ...
            begin
                if "Use New Leave Plan Experience" then begin
                    FeatureTelemetry.LogUptake('0000JQU', LeavePlanManagement.GetLeavePlanV2FeatureKey(), Enum::"Feature Uptake Status"::Discovered);
                    FeatureTelemetry.LogUptake('0000JQU', LeavePlanManagement.GetLeavePlanV2FeatureKey(), Enum::"Feature Uptake Status"::"Set up");
                end else
                    FeatureTelemetry.LogUptake('0000JQU', LeavePlanManagement.GetLeavePlanV2FeatureKey(), Enum::"Feature Uptake Status"::Undiscovered);
            end;
#endif
        }
        field(69658; "Exit Voucher Nos"; Code[100])
        {
            TableRelation = "No. Series";
        }
        field(69659; "Exit HandOver Nos"; Code[100])
        {
            TableRelation = "No. Series";
        }
        field(69660; "Exit Final Dues Nos"; Code[100])
        {
            TableRelation = "No. Series";
        }
        field(69661; "Staff Exit Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(69662; "Exit Qns Template"; Code[20])
        {
            TableRelation = "Exit Interview Qns Templates";
        }
        field(69663; "Committee Nos."; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(69664; "Training Courses Nos"; Code[520])
        {
            TableRelation = "No. Series";
        }
        field(69665; "General Correspondences Nos"; Code[250])
        {
            TableRelation = "No. Series";
        }
        field(69666; "Incoming Correspondence Nos"; Code[250])
        {
            TableRelation = "No. Series";
        }
        field(69667; "Correspondence Contact Nos"; Code[250])
        {
            TableRelation = "No. Series";
        }
        field(69668; "Board Member Nos"; Code[250])
        {
            TableRelation = "No. Series";
        }
        field(69669; "CEO Notification Email"; Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(69670; "Loan Rounding Precision"; Decimal)
        {
        }
        field(69671; "Loan Rounding Type"; Option)
        {
            OptionMembers = Nearest,Up,Down;
        }
        field(69672; "Special Duty Days"; Decimal)
        {

        }
        field(69673; "Loan No series"; Code[30])
        {
            TableRelation = "No. Series".Code;
        }
        field(69674; "Board meeting Nos"; Code[30])
        {
            TableRelation = "No. Series".Code;
        }
    ...
    var
        ...
        Text001: Label '%1 cannot be changed, because there is at least one submitted Leave Plan line with Type=Job.';
        Text002: Label '%1 cannot be changed, because there is at least one Leave Plan.';
}
