        ...
        modify("Job Task No.")
        {
            ...
            begin
                ...
                if JobPlanningLine.FindFirst() then
                    Rec."Job Planning Line No." := JobPlanningLine."Line No.";
            end;
        ...
        */
        ...
        field(50042; "Quantity Returned"; Decimal)
        {
            ...
            begin
              ...
              */
                "Loan Remaining Quantity" := "Quantity  issued" - "Quantity Returned";
        ...
        field(70234; Test; Code[10])
        {
            DataClassification = ToBeClassified;
        }
        field(70235; "Qty Approved"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(70236; "Labour %"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(70237; "Technology Code"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(70238; "Start Chainage(Km)"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(70239; "End Chainage(Km)"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        // field(70240; "Road Code."; code[50])
        // {
        //     DataClassification = ToBeClassified;
        // }
        field(70241; "Committed Amount"; Decimal)
        {

        }
        field(70242; "Budgeted Amount"; Decimal)
        {

        }
        field(70243; "Available Amount"; Decimal)
        {

        }
        field(70244; "Account Actual Spent"; Decimal)
        {

        }
        field(70245; "No. of Days"; Integer)
        {
            DataClassification = ToBeClassified;
        }
        field(70246; "No. of People"; Integer)
        {
            DataClassification = ToBeClassified;
        }
        field(70247; "Seial No."; Code[50])
        {
            DataClassification = ToBeClassified;
        }
        field(70248; "Vote Amount1"; Decimal)
        {
        ...
        field(70349; "Funds Available"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70350; "Loan Remaining Quantity"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(70351; Comments; Text[100])
        {
            DataClassification = ToBeClassified;
        }
    }
