        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Global Budget Book Id"; Rec."Global Budget Book Id")
                {
                    ...
                    Visible = true;
                    ToolTip = 'Specifies the value of the Cash Flow Projections Doc field.';
                }
                ...
                field("Total Cost"; Rec."Total Cost")
                {
                    ...
                    ToolTip = 'Specifies the value of the Total Budget Amount field.';
                }
    ...
    actions
    {
        area(navigation)
        {
            action("Suggest Projects")
            {
                ...
                PromotedOnly = false;
                Visible = false;
                ToolTip = 'Executes the Suggest Approved Projects action.';
            ...
            action("Suggest Lines")
            {
                ...
                PromotedOnly = true;
                Visible = True;
                ToolTip = 'Executes the Select Budget Lines action.';
            ...
            action("Suggest Bill Items From Template")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Generate Tender BOQ Items action.';
            ...
            action(Post)
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Create Project(s) action.';
            ...
            action("Print Schedule Of Project (s)")
            {
                ...
                PromotedOnly = true;
                Visible = false;
                ToolTip = 'Executes the Print Schedule Of Project (s) action.';
