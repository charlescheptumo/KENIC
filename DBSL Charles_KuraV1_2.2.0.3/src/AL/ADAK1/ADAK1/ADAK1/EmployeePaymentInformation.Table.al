...
{
    DrillDownPageId = "Employee Payment Informations";
    LookupPageId = "Employee Payment Informations";
    ...
    fields
    {
        ...
        field(12; "Imprest Account"; Boolean)
        {
    ...
    begin
        if "Document No" = '' then begin
            ...
            "Document No" := NoSeriesManagement.GetNextNo(HumanResourcesSetup."Employee Payment Info Nos", WorkDate(), true);
