...
Table 69078 "Employee Posting GroupX Temp"
{
    DataCaptionFields = "Code", Description;
    DrillDownPageID = "Employee Posting Group T List";
    LookupPageID = "Employee Posting Group T List";
    ...
    fields
    {
        ...
        field(11; "Pay Period Filter"; Date)
        {
            ...
            TableRelation = "Payroll PeriodXT" where("Responsibility Center" = field("Responsibility Center"),
                                                      Closed = const(false));
        }
