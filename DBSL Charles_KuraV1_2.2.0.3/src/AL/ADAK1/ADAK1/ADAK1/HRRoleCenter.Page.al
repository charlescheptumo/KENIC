    ...
    actions
    {
        ...
        area(Sections)
        {
            ...
            group("Onboarding")
            {
                ...
                group("Recruitment  & Selection")
                {
                    ...
                    group("Pre-Hire Preparation")
                    {
                        ...
                        action("Qualifications Inventory")
                        {
                            ApplicationArea = BasicHR;
                    ...
                    group("Application & Selection")
                    {
                        ...
                        group("Administration2121")
                        {
                            ...
                            action("Aptitude Question")
                            {
                                ApplicationArea = BasicHR;
                                Caption = 'Aptitude Question';
                                RunObject = page "Apptitude Question";
                                ToolTip = 'Executes the Aptitude Question action.';
                            }
                ...
                {
                    Caption = 'Appointment & Onboarding';
                    action("Employees23")
                    {
                        ApplicationArea = BasicHR;
                        Caption = 'Employees';
            ...
            group("Offboarding")
            {
                ...
                {
                    Caption = 'Separation & Transition Management';
                    action("Exit Methods")
                    {
                        ApplicationArea = Basic;
                    ...
                    {
                        ApplicationArea = Basic;
                        Caption = 'Posted Employee Exit Vouchers';
