    ...
    layout
    {
        ...
        addafter(Description)
        {
            field("Customer Class. Field"; Rec."Customer Class. Field")
            {
                ...
                ToolTip = 'Specifies the value of the Customer Class. Field field.';
            }
            field("Answer Option"; Rec."Answer Option")
            {
                ApplicationArea = Basic;
                ToolTip = 'Specifies the value of the Answer Option field.';
            }
        }
        addafter("Multiple Answers")
        {
            field("Answer Description"; Rec."Answer Description")
            {
                ApplicationArea = Basic;
                ToolTip = 'Specifies the value of the Answer Description field.';
            }
        }
    }
    actions
