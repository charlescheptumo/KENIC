    ...
    layout
    {
        addafter("Automatic Insurance Posting")
        {
            field("Insurance Expiry Period"; Rec."Insurance Expiry Period")
            {
                ...
                ToolTip = 'Specifies the value of the Insurance Expiry Period field.';
            }
        }
        addafter("Insurance Nos.")
        {
            field("Insurance Cover Nos."; Rec."Insurance Cover Nos.")
            {
                ApplicationArea = Basic;
                ToolTip = 'Specifies the value of the Insurance Cover Nos. field.';
            }
        }
    }
}
