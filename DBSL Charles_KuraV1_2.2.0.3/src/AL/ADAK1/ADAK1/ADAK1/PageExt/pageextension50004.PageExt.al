    ...
    actions
    {
        addafter(Action1900210206)
        {
            action("TB with Totals")
            {
                ...
                ToolTip = 'Executes the TB with Totals action.';
            }
        }
    }
    ...
    */
    ...
    begin
        ...
        if not UserSetup."Accounts User" then
            Error('Access denied: You are not authorized to open the Chart of Accounts page. Please contact the system administrator.');
    end;
