...
Table 59017 "Fleet Vehicles."
{
    ...
    fields
    {
        ...
        field(59003; "Last Service No."; Code[20])
        {
        }
        ...
        field(59014; "Ignition Key Code"; Code[20])
        {
        }
        field(59015; "Door Key Code"; Code[20])
        {
        }
        field(59016; "Body Color"; Code[30])
        {
        }
        field(59017; "Interior Color"; Code[20])
        {
        }
        ...
        field(59026; "FA Serial No"; Code[50])
        {
            NotBlank = false;
