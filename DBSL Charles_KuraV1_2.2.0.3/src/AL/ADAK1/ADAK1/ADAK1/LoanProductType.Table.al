...
Table 69010 "Loan Product Type"
{
    ...
    begin
        if Code = '' then begin
            ...
            Code := NoSeriesMgt.GetNextNo(HRsetup."Loan Product Type Nos.", WorkDate(), true);
        end;

        // HRsetup.Get;
        // HRsetup.TestField(HRsetup."Loan No series");
        // if "No Series" = '' then
        //     "No Series" := NoSeriesMgt.GetNextNo(HRsetup."Loan No series", WorkDate(), true);
    end;
