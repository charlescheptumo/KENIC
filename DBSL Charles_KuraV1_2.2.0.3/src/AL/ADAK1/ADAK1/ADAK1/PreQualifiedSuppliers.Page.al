        ...
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Director 1 Name"; Rec."Director 1 Name")
                {
                    ApplicationArea = Basic;
                    Editable = seetitbl;
                    ToolTip = 'Specifies the value of the Director 1 Name field.';
                }
                field("Director 2 Name"; Rec."Director 2 Name")
                {
                    ApplicationArea = Basic;
                    Editable = seetitbl;
                    ToolTip = 'Specifies the value of the Director 2 Name field.';
                }
                field("Director 3 Name"; Rec."Director 3 Name")
                {
                    ApplicationArea = Basic;
                    Editable = seetitbl;
                    ToolTip = 'Specifies the value of the Director 3 Name field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Pre Qualified field.';
                }
            }
        }
    }
    ...
    actions
    {
        area(processing)
        {
            action("Start Evaluation")
            {
                ...
                PromotedIsBig = true;
                Visible = seetit2;
                ToolTip = 'Executes the Start Evaluation action.';
            ...
            action("Load Prequalified Suppliers")
            {
                ...
                Image = Lock;
                Promoted = true;
                ToolTip = 'Executes the Load Prequalified Suppliers action.';
