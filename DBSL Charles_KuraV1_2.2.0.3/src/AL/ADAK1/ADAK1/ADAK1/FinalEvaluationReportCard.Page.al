...
Page 75275 "Final Evaluation Report Card"
{
        ...
        area(navigation)
        {
            group(IFP)
            {
                ...
                action("Print Final Evaluation Report")
                {
                    ...
                    ToolTip = 'Executes the Print Final Evaluation Report action.';
                    trigger OnAction()
                    var
                        FileName: Text;
                        FileDirectory: Text;
    ...
    begin
        ...
        ProcurementSetup.TestField("Procurement Officer License No");
        Rec."Procurement Officer License No" := ProcurementSetup."Procurement Officer License No";
    end;
