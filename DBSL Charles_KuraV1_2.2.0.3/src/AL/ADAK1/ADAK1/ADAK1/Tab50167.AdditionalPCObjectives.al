...
Table 50167 "Additional PC Objective"
{
    DrillDownPageID = "Additional DP Objectives";
    LookupPageID = "Additional DP Objectives";
    ...
    fields
    {
        ...
        {
            CalcFormula = sum("Strategy Sub_Activity Entry".Quantity where("CEO PC ID" = field("Department Plan ID"),
        ...
        field(72; "Activity Description"; Text[250])
        {

        }
        field(73; "Department Plan ID"; Code[50])
        {
            TableRelation = "Annual Strategy Workplan";

        }
        field(74; "OutCome"; Text[250])
        {

        }
        field(75; "Primary Division"; Code[100])
        {
        ...
        field(76; "Primary Division Name"; Text[2048])
        {
    ...
    begin
        ...
        if Rec."Workplan No." <> '' then begin
            if PerfomanceContractHeader.Get(Rec."Workplan No.") then begin
                if Rec."Start Date" = 0D then
                    Rec."Start Date" := PerfomanceContractHeader."Start Date";
                if Rec."Due Date" = 0D then
                    Rec."Due Date" := PerfomanceContractHeader."End Date";
            end;
        end;
    end;
