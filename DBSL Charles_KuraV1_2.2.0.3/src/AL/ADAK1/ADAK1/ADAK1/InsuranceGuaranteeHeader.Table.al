    ...
    begin
        if "Document No." = '' then begin
            if "Document Type" = "document type"::"Insurance Of Works" then begin
                ...
                "Document No.":=NoSeriesManagement.GetNextNo(RoadManagementSetup."Insurance Of Works Nos",WorkDate(),true);
        ...
        if "Document No." = '' then begin
            if "Document Type" = "document type"::"Advance Payment Guarantee" then begin
                ...
                RoadManagementSetup.TestField("Advance Guarantee Nos");
                 "Document No.":=NoSeriesManagement.GetNextNo(RoadManagementSetup."Advance Guarantee Nos",WorkDate(),true);
        ...
        if "Document No." = '' then begin
            if "Document Type" = "document type"::"Performance Guarantee" then begin
               ...
               "Document No.":=NoSeriesManagement.GetNextNo(RoadManagementSetup."Performance Guarantee Nos",WorkDate(),true);
        ...
        if "Document No." = '' then begin
            if "Document Type" = "document type"::"Professional Indemnity" then begin
              ...
              "Document No.":=NoSeriesManagement.GetNextNo(RoadManagementSetup."Professional Indemnity Nos",WorkDate(),true);
