...
Page 72557 "Request for Project Close-Out"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Taking Over Request No."; Rec."Taking Over Request No.")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Taking Over Request No. field.';
                }
                field("Close-Out Justification"; Rec."Close-Out Justification")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Close-Out Justification field.';
                }
                ...
                field("Taking Over Length (KM)"; Rec."Taking Over Length (KM)")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Taking Over Length (KM) field.';
                }
    ...
    actions
    {
        area(navigation)
        {
            action(Submit)
            {
                ...
                begin
                    ...
                    if ObjJob.FindSet then begin
                        ObjJob."Last Taking Over Request No." := Rec."Taking Over Request No." + 1;
                        ObjJob.Modify(true);
                    end;
            ...
            action("Snag List")
            {
                ...
                RunPageLink = "Inspection No" = field("Document No.");
                ToolTip = 'Executes the Snag List action.';
            }
        }
    }
    ...
    begin
        Rec."Document Type" := Rec."document type"::"Contractor Request for Taking Over";
    end;
