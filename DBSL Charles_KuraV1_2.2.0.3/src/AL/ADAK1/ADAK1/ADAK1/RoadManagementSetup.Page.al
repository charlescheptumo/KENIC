    ...
    layout
    {
        area(content)
        {
            ...
            group("RAC No. Series")
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Roadworks Budget Ceiling Nos field.';
                }
            ...
            group("RAM No. Series")
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Land Acquisition Workorder Nos field.';
                }
                field("GazettAcquisitionWorkorder Nos"; Rec."GazettAcquisitionWorkorder Nos")
                {
                    ApplicationArea = Basic;
                    Caption = 'Gazette Acquisition Workorder Nos';
                    ToolTip = 'Specifies the value of the Gazette Acquisition Workorder Nos field.';
                }
            }
        }
    }
