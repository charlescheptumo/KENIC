        ...
        area(content)
        {
            repeater(Group)
            {
                field("PIP Review ID"; Rec."PIP Review ID")
                {
                    ...
                    ToolTip = 'Specifies the value of the PIP Review ID field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the PIP Objective  ID field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Performance Notes field.';
                }
