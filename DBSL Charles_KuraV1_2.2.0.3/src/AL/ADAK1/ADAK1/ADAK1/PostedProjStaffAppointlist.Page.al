...
Page 72382 "PostedProj. Staff Appoint list"
{
    ApplicationArea = Basic;
    Caption = 'Posted Staff Appointment List';
    CardPageID = "Project Staff Appointment Card";
    PageType = List;
    SourceTable = "Project Staff Voucher";
    SourceTableView = where("Document Type" = const(Appointment),
                            Posted = filter(true));
