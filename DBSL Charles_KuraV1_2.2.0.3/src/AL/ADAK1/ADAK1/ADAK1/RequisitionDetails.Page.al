        ...
        area(processing)
        {
            group("Actions")
            {
                ...
                action("Generate RFQ")
                {
                    ...
                    ToolTip = 'Executes the Generate RFQ action.';
                ...
                action("Generate RFP")
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    ToolTip = 'Executes the Generate RFP action.';
                ...
                action("Generate Tender")
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    ToolTip = 'Executes the Generate Tender action.';
                ...
                action("Show Req Card")
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    ToolTip = 'Executes the Show Req Card action.';
