            ...
            group("WIP and Recognition")
            {
                ...
                group("Road Project Details")
                {
                    ...
                    field("Project Category"; Rec."Project Category")
                    {
                        ApplicationArea = Basic;
                        Editable = false;
                        ToolTip = 'Specifies the value of the Project Category field.';
                    }
                    field("Road Project Type"; Rec."Road Project Type")
                    {
                        ApplicationArea = Basic;
                        Editable = false;
                        ToolTip = 'Specifies the value of the Road Project Type field.';
                    }
                    field("Road Project Sub-Category"; Rec."Road Project Sub-Category")
                    {
                        ApplicationArea = Basic;
                        ToolTip = 'Specifies the value of the Road Project Sub-Category field.';
                    }
                }
                group(Posted)
                {
        ...
        area(navigation)
        {
            ...
            group("Research Project")
            {
                action("Notify Award")
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    ToolTip = 'Executes the Notify Award action.';
                ...
                action("Project Research Team List")
                {
                    ...
                    RunPageLink = "Job No" = field("No.");
                    ToolTip = 'Executes the Project Research Team action.';
                }
                ...
                action("Effort & Payroll Matrix list")
                {
                    ...
                    RunPageLink = "Project No" = field("No.");
                    ToolTip = 'Executes the Effort & Payroll Matrix action.';
                }
