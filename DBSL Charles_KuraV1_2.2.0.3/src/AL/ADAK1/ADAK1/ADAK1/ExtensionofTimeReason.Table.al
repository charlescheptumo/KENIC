...
Table 72325 "Extension of Time Reason"
{
    ...
    begin
        ...
        if ProjectVariationHeader.FindSet then begin
            ...
            "Original Project Starting Date" := ProjectVariationHeader."Original Project Starting Date";
            "Original Project Ending Date" := ProjectVariationHeader."Original Project Ending Date";
