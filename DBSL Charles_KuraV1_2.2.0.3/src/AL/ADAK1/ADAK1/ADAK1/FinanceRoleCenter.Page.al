#pragma warning disable AA0005, AA0008, AA0018, AA0021, AA0072, AA0137, AA0201, AA0206, AA0218, AA0228,AL0432, AL0254, AL0424, AW0006 // ForNAV settings
    ...
    actions
    {
        area(reporting)
        {
            ...
            group("Management Reports")
            {
                ...
                action("Detailed Institutional Report")
                {
                    ApplicationArea = Basic;
                    //Caption = 'ITax Generator';
                    Image = "Report";
                    RunObject = Report "Institutional Report_email";
                    ToolTip = 'Executes the Detailed Institutional Report action.';
                }
            }
            group(Statutory)
            {
        ...
        area(sections)
        {
            ...
            group("Cash Management")
            {
                ...
                action("Open Payment Vouchers")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Open Payment Vouchers';
                    RunObject = Page "Payments Vouchers";
                    ToolTip = 'Executes the Open Payment Vouchers action.';
                    // ToolTip = 'Record manual expenses, such as salaries, interest on credit, or planned investments to be used in cash flow forecasting.';
                ...
                action("Bank Transfer")
                {
                    ...
                    ToolTip = 'Executes the Bank Transfer action.';
                    // ToolTip = 'Record manual expenses, such as salaries, interest on credit, or planned investments to be used in cash flow forecasting.';
                ...
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Approved Bank Transfer';
                    RunObject = page "Approved Bank Transfers";
                    ToolTip = 'Executes the Approved Bank Transfer action.';
                    // ToolTip = 'Record manual expenses, such as salaries, interest on credit, or planned investments to be used in cash flow forecasting.';
            ...
            group("Fixed Assets")
            {
                ...
                action("Motor Vehicle Register")
                {
                    ...
                    RunObject = Report "Motor Vehicle Register";
                    ToolTip = 'Executes the Motor Vehicle Register action.';
                }
            }
            ...
            group("Posted Documents")
            {
                ...
                action("Posted Bank Transfers")
                {
                    ...
                    Caption = 'Posted Bank Transfers';
                    RunObject = Page "Posted Bank Transfers";
                    ToolTip = 'Executes the Posted Bank Transfers action.';
                    // ToolTip = 'Record manual expenses, such as salaries, interest on credit, or planned investments to be used in cash flow forecasting.';
                ...
                action("Posted Petty Cash Vouchers")
                {
                    ...
                    ToolTip = 'Executes the Posted Petty Cash Vouchers action.';
                    // ToolTip = 'Record manual expenses, such as salaries, interest on credit, or planned investments to be used in cash flow forecasting.';
