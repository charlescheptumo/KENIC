...
Table 56908 "PortalApproval Entry"
{
    Caption = 'Portal Approval Entry';
    ...
    fields
    {
        ...
        field(39; "Employee Number"; Code[100])
        {
            DataClassification = ToBeClassified;
            ...
            begin
                Employee.Reset;
                if Employee.Get("Employee Number") then begin
