    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Vendor Contact field.';
                }
                field("Vendor Phone"; Rec."Vendor Phone")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Vendor Phone field.';
                }
                field("Vendor Email Address"; Rec."Vendor Email Address")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Vendor Email Address field.';
                }
        ...
        area(navigation)
        {
            group("Ins&urance")
            {
                ...
                action("Notify of Expiry")
                {
                    ...
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    ToolTip = 'Executes the Notify of Expiry action.';

                    trigger OnAction()
                    begin
                        if HRSetup.Get() then begin
                            Header := ' INSURANCE ' + Rec."No." + ' EXPIRY NOTIFICATION ';
                ...
                action(Print)
                {
                    ...
                    begin
                        Insurance.Reset;
                        Insurance.SetRange(Insurance."No.", Rec."No.");
...
//                 }
//             }
//             part(Control13; Rec."Vehicle Insurance Lines")
//             {
...
//                     trigger OnAction()
//                     var
//                         VehicleInsuranceLines1: Record "Vehicle Insurance Lines";
//                     begin
//                         Rec.TestField(Posted, false);
//                         VehicleInsuranceLines.RESET;
//                         VehicleInsuranceLines.SETRANGE(VehicleInsuranceLines."No.", Rec."Insurance No.");
//                         IF VehicleInsuranceLines.FINDSET THEN
//                             REPEAT
//                                 FleetVehicles.RESET;
//                                 FleetVehicles.SETRANGE(FleetVehicles."No.", VehicleInsuranceLines."FA No.");
//                                 FleetVehicles.SETRANGE(FleetVehicles."Registration No.", VehicleInsuranceLines."Registration No.");
//                                 IF FleetVehicles.FINDSET THEN BEGIN
//                                     FleetVehicles."Licensing Company" := Rec."Vendor Name";
//                                     FleetVehicles."Date of Last Insurance" := Rec."Effective Date";
//                                     FleetVehicles."Expiry Date" := Rec."Expiration Date";
//                                     FleetVehicles."Licensing Details" := Rec."Insurance Details";
//                                     //  IF NOT FleetVehicles.GET(FleetVehicles."No.",FleetVehicles."Registration No.") THEN
//                                     FleetVehicles.MODIFY;

//                                     VehicleInsuranceLines1.Reset();
//                                     VehicleInsuranceLines1.SETRANGE("FA No.", VehicleInsuranceLines."FA No.");
//                                     if not VehicleInsuranceLines1.FindSet() then begin
//                                         VehicleInsuranceLines1."No." := Rec."Insurance No.";
//                                         VehicleInsuranceLines1."FA No." := FleetVehicles."No.";
//                                         VehicleInsuranceLines1."Registration No." := FleetVehicles."Registration No.";
//                                         VehicleInsuranceLines1."Vehicle Description" := FleetVehicles.Description;
//                                         VehicleInsuranceLines1.Make := FleetVehicles.Make;
//                                         VehicleInsuranceLines1.Model := FleetVehicles.Model;
//                                         VehicleInsuranceLines1."Insurance Type" := Rec."Insurance Type";
//                                         VehicleInsuranceLines1."Vehicle Location" := FleetVehicles."Location Code";
//                                         VehicleInsuranceLines1."Effective Date" := Rec."Effective Date";
//                                         VehicleInsuranceLines1."Expiration Date" := Rec."Expiration Date";
//                                         VehicleInsuranceLines1."Insurance Vendor No." := Rec."Insurance Vendor No.";
//                                         VehicleInsuranceLines1."Insurance Vendor Name" := Rec."Vendor Name";
//                                         VehicleInsuranceLines1."Insuance Details" := Rec."Insurance Details";
//                                         // VehicleInsuranceLines1. := Rec.;
//                                     end
//                                 END;
//                             UNTIL VehicleInsuranceLines.NEXT = 0;
//                         Rec.Posted := true;
...
//                     begin
//                         if HRSetup.Get() then begin
//                             Header := ' INSURANCE ' + Rec."Insurance No." + ' EXPIRY NOTIFICATION ';
...
//                     begin
//                         Insurance.Reset;
//                         Insurance.SetRange(Insurance."No.", Rec."Insurance No.");
//                         Report.Run(59014, true, true, Insurance);
//                     end;
//                 }
//                 action("Total Value Ins&ured per FA")
...
//     begin
//         Rec."FA Cover Type" := Rec."FA Cover Type"::Vehicles;
//     end;
