...
TableExtension 50071 "tableextension50071" extends "Analysis View Budget Entry"
{
    fields
    {

        //Unsupported feature: Property Modification (Data type) on ""Dimension 1 Value Code"(Field 5)".


        //Unsupported feature: Property Modification (Data type) on ""Dimension 2 Value Code"(Field 6)".


        //Unsupported feature: Property Modification (Data type) on ""Dimension 3 Value Code"(Field 7)".


        //Unsupported feature: Property Modification (Data type) on ""Dimension 4 Value Code"(Field 8)".
        ...
        field(50002; "External Document No."; Code[2048])
        {
