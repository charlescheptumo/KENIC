...
Table 72259 "Project Variation Header"
{
    DrillDownPageId = "Cost Claims";
    LookupPageId = "cost claims";
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = "Purchase Header"."No." where("Contract Type" = filter("Original Contract"), "Document Type" = filter("Blanket Order"));
            ...
            begin
                ...
                PurchaseHeader.SetRange("No.", "Project ID");
                if PurchaseHeader.FindFirst() then begin
                    "External Contract Reference" := PurchaseHeader."IFS Code";
                    "Contractor No." := PurchaseHeader."Buy-from Vendor No.";
                    "Contractor Name" := PurchaseHeader."Buy-from Vendor Name";
                    "Original Project Starting Date" := PurchaseHeader."Contract Start Date";
                    "Original Project Ending Date" := PurchaseHeader."Contract End Date";
                    "Project Name" := PurchaseHeader.Description;
                    "Original Value of Work (LCY)" := PurchaseHeader."Bid Sum 2";
                end;
        ...
        {
            CalcFormula = sum("Project Variation Line"."Original Total Cost (LCY)" where("Document Type" = field("Document Type"),
        ...
        {
            CalcFormula = sum("Project Variation Line"."New Total Cost (LCY)" where("Document Type" = field("Document Type"),
                                                                                     "Document No." = field("Document No.")));
            Editable = false;
            FieldClass = FlowField;
        ...
        {
            CalcFormula = sum("Project Variation Line"."Net Change (Total Cost LCY)" where("Document Type" = field("Document Type"),
                                                                                            "Document No." = field("Document No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        field(18; "Purchase Contract ID"; Code[20])
        {
            ...
            begin
                ...
                if PurchaseHeader.FindSet then begin
                    ...
                    "Maximum Allowed Variation %" := PurchaseHeader."Variation of Works %";
                    "Maximum Variation Of Works" := PurchaseHeader."Variation of Works Amount";
                end;
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = if ("Document Type" = filter("Project Variation Order")) "Project Variation Header"."Document No." where("Document Type" = filter("Contractor Variation Request"));
        ...
        field(53; "Evaluation Committee No"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "IFS Tender Committee"."Document No.";
        }
        field(54; "Cost Claim Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(55; "Cost Claim Requested Amount"; Decimal)
        {
            CalcFormula = sum("Cost Claim Lines"."Cost Claim Requested Amount" where("Document No." = field("Document No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        field(56; "Cost Claim Approved Amount"; Decimal)
        {
            CalcFormula = sum("Cost Claim Lines"."Cost Claim Approved Amount" where("Document No." = field("Document No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        field(57; "Cost Claim Reason"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Project Variation Header"."Document No." where("Document Type" = filter("Contractor Variation Request" | "Engineer Variation Request" | "Extension of Time Request"),
        ...
        field(60; "Maximum Allowed Variation %"; Decimal)
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(61; "Maximum Variation Of Works"; Decimal)
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(62; "Rejection Remarks"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(63; "Rejected By"; Code[100])
        {
            DataClassification = ToBeClassified;
        }
    ...
    begin
        ...
        if "Document No." = '' then begin
            ...
            case "Document Type" of
                "document type"::"Project Variation Order":
                    begin
                        RoadManagementSetup.TestField("Project Variation Order Nos");
                    //    NoSeriesManagement.InitSeries(RoadManagementSetup."Project Variation Order Nos", xRec."No. Series", Today, "Document No.", "No. Series");
                    end;

                "document type"::"Contractor Variation Request":
                    begin
                ...
                "document type"::"Extension of Time Request":
                    begin
                        RoadManagementSetup.TestField("EOT Request Nos");
                       // NoSeriesManagement.InitSeries(RoadManagementSetup."EOT Request Nos", xRec."No. Series", Today, "Document No.", "No. Series");
                    end;
                "document type"::"Budget Reallocation Voucher":
                    begin
                ...
                "document type"::"Engineer Variation Request":
                    begin
                ...
                "document type"::"Cost Claim":
                    begin
                        RoadManagementSetup.TestField("Cost Claim Nos");
                     //   NoSeriesManagement.InitSeries(RoadManagementSetup."Cost Claim Nos", xRec."No. Series", Today, "Document No.", "No. Series");
                    end;
            end;
        end;
    end;
