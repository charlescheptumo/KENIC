...
Page 69231 "Leave Planner Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            {
                // SubPageLink = "Application Code" = field("Application Code"), "Shortcut Dimension 1 Code" = field("Shortcut Dimension 1 Code");
        ...
        area(navigation)
        {
            ...
            action(Print)
            {
                ...
                begin
                    ...
                    Report.Run(Report::"Leave Planner", true, true, Rec);
                    // Rec.SetRange("Application Code",Rec."Application Code");
                end;
            }
            group(Approval)
