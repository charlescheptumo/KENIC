...
Table 69237 "HR Shortlisted Applicants"
{
    ...
    fields
    {
        ...
        field(5; "Qualified for Written Intervie"; Boolean)
        {
        }
        ...
        field(13; Qualified; Boolean)
        {
            ...
            trigger OnValidate()
            begin
                TestField("Stage Score");
                if "Stage Score" <= 0 then
                    Error('You cannot qualify an applicant with 0 score');
                /*
        ...
        field(17; "Qualified for Oral Interview"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(18; "Interview Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(19; "Interview Time"; Time)
        {
            DataClassification = ToBeClassified;
        }
        field(20; "Interview Venue"; Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(21; Email; Text[50])
        {
            DataClassification = ToBeClassified;
        }
        field(22; "Interviewee Notified"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(23; "Candidate Qualified"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(24; Initials; Text[30])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    var
        ...
        RNeeds: Record "Employee Requisitions";
}
