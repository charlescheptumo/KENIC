...
TableExtension 50079 "tableextension50079" extends "Approval Entry"
{
    fields
    {
        ...
        field(50003; "Approval Stage"; Code[50])
        {

        }
        field(50004; "Region ID"; Code[100])
        {

            Description = '//Custom for ADAK/ADAK';
        }
        field(50005; "Department ID"; Code[100])
        {

            Description = '//Custom for ADAK/ADAK';
        }
        field(50006; "Approver Position"; Code[100])
        {
        ...
        case RecRef.Number of
            ...
            Database::Payments:
                begin
                    ...
                    Pv.CalcFields("Imprest Amount");
                    if PV."Document Type" = PV."Document Type"::Imprest then
                      Details := StrSubstNo('%1 ; %2:,%3', PV.Payee, 'Amount', PV."Imprest Amount")
                    else
