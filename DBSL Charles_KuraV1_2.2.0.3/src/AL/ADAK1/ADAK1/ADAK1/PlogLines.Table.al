...
Table 80191 "Plog Lines"
{
    ...
    fields
    {
            ...
            begin
                if "Activity Type" = "activity type"::"Primary Activity" then begin
                    ...
                    if StrategicInitiative.Find('-') then begin
                        ...
                        "Activity Decription" := StrategicInitiative."Activity Description";
                        "Key Performance Indicator" := StrategicInitiative."Key Performance Indicator";
        ...
        field(42; "Department Plan ID"; Code[100])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Annual Strategy Workplan";
        }
        field(43; "Activity Decription"; Text[250])
        {
            DataClassification = ToBeClassified;

        }
        field(44; "Outcome"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
