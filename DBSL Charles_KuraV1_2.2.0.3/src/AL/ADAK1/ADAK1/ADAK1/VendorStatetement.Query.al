...
Query 56027 "VendorStatetement"
{
    ...
    elements
    {
        dataitem(Vendor_Ledger_Entry; "Vendor Ledger Entry")
        {
            ...
            column(Purchase_LCY; "Purchase (LCY)")
            {
            }
            column(Inv_Discount_LCY; "Inv. Discount (LCY)")
            {
            }
            ...
            column(Pmt_Disc_Rcd_LCY; "Pmt. Disc. Rcd.(LCY)")
            {
            }
            ...
            column(Closed_by_Amount_LCY; "Closed by Amount (LCY)")
            {
            }
            ...
            column(Creditor_No; "Creditor No.")
            {
            }
            ...
            column(Applies_to_Ext_Doc_No; "Applies-to Ext. Doc. No.")
            {
            }
