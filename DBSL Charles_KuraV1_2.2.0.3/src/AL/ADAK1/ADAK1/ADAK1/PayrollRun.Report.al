            ...
            begin
                ...
                if Deductions.Find('-') then begin
                    ...
                    if Assignmatrix.Find('-') then begin
                        ...
                        if Employee."Posting Group" <> 'AP' then begin
                            Assignmatrix.Init;
                ...
                */
                    ...
                    repeat
                        if Assignmatrix.Type = Assignmatrix.Type::Payment then begin
                            if Earnings.Get(Assignmatrix.Code) then begin
                                if (Earnings."Calculation Method" = Earnings."calculation method"::"% of Basic pay") OR (Earnings."Calculation Method" = Earnings."Calculation Method"::"% of SHIF")
                ...
                Assignmatrix.SetRange(Code, 'INS');
                ...
                Deductions.SetRange(Deductions."PAYE Code", true);
                if Deductions.Find('-') then begin
                    if Employee."Pays tax?" = true then begin////Added by Nehemia
                ...
                //Added to Validate Translated amounts and Computations depending on Basic
                Assignmatrix.RESET;
                Assignmatrix.SETRANGE(Assignmatrix."Employee No", Employee."No.");
                Assignmatrix.SETRANGE(Assignmatrix."Payroll Period", Month);
                IF Assignmatrix.FIND('-') THEN BEGIN
                    REPEAT
                        ...
                        IF Assignmatrix.Type = Assignmatrix.Type::Deduction THEN BEGIN
                            IF Deductions.GET(Assignmatrix.Code) THEN BEGIN
                                IF Deductions."Calculation Method" = Deductions."Calculation Method"::"% of Gross Pay"
                                THEN BEGIN
                                    Assignmatrix.Code := Deductions.Code;
                                    Assignmatrix.VALIDATE(Assignmatrix.Code);
                                    Assignmatrix.MODIFY;
