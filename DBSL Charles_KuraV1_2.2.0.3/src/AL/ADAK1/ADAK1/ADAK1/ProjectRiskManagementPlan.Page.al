...
Page 95098 "Project Risk Management Plan"
{
    ...
    actions
    {
        area(navigation)
        {
            ...
            action("Risk Mitigation Measures")
            {
                ApplicationArea = Basic;
                Image = Restore;
                Promoted = true;
                ...
                RunPageLink = "Document Type" = field("Document Type"),
                              "Document No" = field("Document No");
                ToolTip = 'Executes the Risk Mitigation Measures action.';
            }
            action(Dimensions)
            {
                ApplicationArea = Basic;
            ...
            action("Import Risks")
            {
                ...
                RunPageLink = Code = filter('01');
                RunPageView = where(Code = filter('01'));
                ToolTip = 'Executes the Import Risks action.';
            }
