#pragma warning disable AA0005, AA0008,AL0423,AL0432, AA0018, AA0021, AA0072, AA0137, AA0201, AA0206, AA0218, AA0228, AL0254, AL0424, AW0006 // ForNAV settings
Page 65131 "Manager's  Role Center"
{
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            {
                //  AccessByPermission = TableData "Assisted Setu = "=I;
                ApplicationArea = Basic, Suite;
                Caption = '';
