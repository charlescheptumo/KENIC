#pragma warning disable AA0005, AA0008, AA0018, AA0021,AL0432, AA0072, AA0137, AA0201, AA0206, AA0218, AA0228, AL0254, AL0424, AW0006 // ForNAV settings
Page 72325 "Regional Road Planners"
{
    AdditionalSearchTerms = 'capacity,job,project';
    ApplicationArea = Jobs;
    Caption = 'Regional Road Planners';
    CardPageID = "Regional Road Planner Card";
    Editable = false;
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,Resource,Navigate';
    SourceTable = Resource;
    SourceTableView = where("Road Planner" = filter(true),
                            "Planning Level" = filter(Regional));
    UsageCategory = Lists;
