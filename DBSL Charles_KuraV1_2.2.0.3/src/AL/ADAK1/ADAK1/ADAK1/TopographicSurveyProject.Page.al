    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Execution Approach"; Rec."Execution Approach")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Execution Approach field.';
                }
        ...
        area(navigation)
        {
            group("&Job")
            {
                ...
                action("List of Maps")
                {
                    ...
                    ToolTip = 'Executes the List of Maps action.';
                ...
                action("Technical Reports")
                {
                    ...
                    ToolTip = 'Executes the Technical Reports action.';
