...
TableExtension 50026 "tableextension50026" extends "Purch. Cr. Memo Line"
{
    fields
    {
        ...
        field(70248; "Routing No."; Code[20])
        {
            Caption = 'Routing No.';
            TableRelation = "Routing Header";
        }
        field(70249; "Operation No."; Code[10])
        {
        ...
        field(70250; "Work Center No."; Code[20])
        {
        ...
        field(70251; Finished; Boolean)
        {
            Caption = 'Finished';
        }
        field(70252; "Prod. Order Line No."; Integer)
        {
        ...
        field(70253; "Overhead Rate"; Decimal)
        {
        ...
        field(70254; "MPS Order"; Boolean)
        {
            Caption = 'MPS Order';
        }
        field(70255; "Planning Flexibility"; Option)
        {
        ...
        field(70256; "Safety Lead Time"; DateFormula)
        {
        ...
        field(70257; "Routing Reference No."; Integer)
        {
