...
Table 69075 "Payroll HeaderT"
{
    ...
    fields
    {
        ...
        field(3; "Payroll Period"; Date)
        {
            ...
            begin
                ...
                PayrollHeaderT.SetRange("Payroll Period", "Payroll Period");
                PayrollHeaderT.SetRange("Responsibility Center", "Responsibility Center");
                if PayrollHeaderT.FindFirst then
                    Error('There can only be one salary voucher per pay period %1 already exist...', PayrollHeaderT."No.");
            end;
        }
    ...
    begin
        ...
        if "No." = '' then begin
            ...
            "No." := NoSeriesMgt.GetNextNo(NoSetup."Temp Salary Voucher Nos.", WorkDate(), true);
        end;
