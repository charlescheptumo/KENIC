#pragma warning disable AA0005, AA0008, AA0018, AA0021, AA0072, AA0137, AA0201, AL0603,AA0206, AL0603,AA0218, AA0228, AL0254, AL0424, AW0006 // ForNAV settings
Page 72745 "Fee Note"
{
    DeleteAllowed = false;
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    Caption = 'Consultant No';
                    ToolTip = 'Specifies the value of the Consultant No field.';
                }
                field("Contractor Name"; Rec."Contractor Name")
                {
                    ApplicationArea = Basic;
                    Caption = 'Consultant Name';
                    ToolTip = 'Specifies the value of the Consultant Name field.';
                }
                ...
                field("Contractor Request Cert Amount"; Rec."Contractor Request Cert Amount")
                {
                    ...
                    ToolTip = 'Specifies the value of the Request Amount field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Date Sent for Approval field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Certified Amount field.';
                }
    ...
    actions
    {
        area(navigation)
        {
            ...
            {
                ToolTip = 'Executes the Export Template action.';
                // ApplicationArea = Basic;
                ...
                //     GenerateTemplate("Document No."+'_'+"Project Name", "Project ID", "Document No.","Contractor Name","Contract Sum",contractPeriod);


                //     TempFile.Open(FilePath+"Document No."+'_'+"Project Name"+'.xlsx');
                //     TempFile.CreateInstream(NewStream);

                //     ToFile:="Document No."+'_'+"Project Name"+'.xlsx';
            ...
            action("Import Template")
            {
                ...
                PromotedOnly = true;
                Visible = false;
                ToolTip = 'Executes the Import IPC action.';
            ...
            action("Print Request Summary")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Print Request Summary action.';
            ...
            action("Print Reconciliation Report")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Print Reconciliation Report action.';
            ...
            action("Attach Docs")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Attach Supporting Documents action.';
            ...
            action("Materials On site")
            {
                ...
                RunPageLink = "Document Type" = field("Document Type"),
                              "Document No." = field("Document No.");
                Visible = false;
                ToolTip = 'Executes the Materials On site action.';
            }
            action("Send Approval Request")
            {
                ...
                begin
                    ...
                    Rec.Modify(true);
                    EmailNotifications.FnSendApprovalsMailCustom(CustomApprovalEntry, Rec."Project ID");
                    Message(TXT0001);
                end;
            }
    ...
    begin
        Rec."Document Type" := Rec."document type"::"Fee Note";
        //"Payment Certificate Type":="Payment Certificate Type"::"Interim Payment";
    end;
