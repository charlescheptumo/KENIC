...
Page 99998 "Project Engineer Card"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the External Consultant field.';
                }
                field("Researcher's Major"; Rec."Researcher's Major")
                {
                    ApplicationArea = Basic;
                    MultiLine = true;
                    ToolTip = 'Specifies the value of the Researcher''s Major field.';
                }
                field("Researcher Biography"; Rec."Researcher Biography")
                {
                    ApplicationArea = Basic;
                    MultiLine = true;
                    ToolTip = 'Specifies the value of the Researcher Biography field.';
                }
            }
            group(Invoicing)
            {
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action("Researcher Output")
                {
                    ...
                    Visible = false;
                    ToolTip = 'Executes the Researcher Output action.';
                }
                action("Researcher Statistics")
                {
                    ...
                    RunPageLink = "No." = field("No.");
                    ToolTip = 'Executes the Researcher Statistics action.';
                }
            }
        }
    }
    ...
    begin
        ...
        // "Resource Type" := "resource type"::"Project Engineer";
    end;
