...
Query 60006 "JobApplicantsQualification"
{

    elements
    {
        dataitem(Job_Applicants_Qualification; "Job Applicants Qualification")
        {
            ...
            column(Job_Applicant_Status; "Job Applicant Status")
            {
            }
            ...
            column(Proffessional_Qualifications; "Proffessional Qualifications")
            {
            }
