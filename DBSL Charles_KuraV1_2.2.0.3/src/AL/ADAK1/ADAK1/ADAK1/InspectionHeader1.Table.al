...
Table 70036 "Inspection Header1"
{
    ...
    fields
    {
        ...
        field(19; "Creation Time"; Time)
        {
            DataClassification = ToBeClassified;
        }
        field(20; "Approved Purchase Requisition"; Code[200])
        {
            DataClassification = ToBeClassified;
        }
        field(21; Invoice; Code[150])
        {
            DataClassification = ToBeClassified;
        }
        field(22; "Delivery Note"; Code[150])
        {
            DataClassification = ToBeClassified;
        }
        field(23; "ETR Receipt"; Code[150])
        {
            DataClassification = ToBeClassified;
        }
        field(24; "LPO"; Code[150])
        {
            DataClassification = ToBeClassified;
        }
        field(25; "Delivery Note Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(26; "ETR Receipt Date"; Date)
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    begin
        ...
        "Inspection No" := NoSeriesMgt.GetNextNo(PurchSetup."Inspection Nos", WorkDate(), true);
