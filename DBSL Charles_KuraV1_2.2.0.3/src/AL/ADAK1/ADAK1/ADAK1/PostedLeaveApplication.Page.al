...
Page 69235 "Posted Leave Application"
{
            ...
            group(General)
            {
                ...
                field("Days Applied"; Rec."Days Applied")
                {
                    ...
                    begin
                        ...
                        if Rec."Leave Type" = 'TERMINAL' then begin
                            HRLeaveTypes.Reset;
                            HRLeaveTypes.SetRange(HRLeaveTypes.Code, Rec."Leave Type");
                            if HRLeaveTypes.Find('-') then begin
                                if Rec."Days Applied" < HRLeaveTypes.Days then
                                    Error(TEXT005, HRLeaveTypes.Days);
                            end;
                        end;
                ...
                field(Resumed; Rec.Resumed)
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies Boolean for Resumed';
                ...
                field(Recalled; Rec.Recalled)
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Indicates if employee was recalled from leave';
                }
            ...
            group("F&unctions")
            {
                ...
                action("&Approvals")
                {
                    ...
                    begin
                        ...
                        ApprovalsMgmt.OpenApprovalEntriesPage(Rec.RecordId);                        //ApprovalEntries.Setfilters(DATABASE::"HR Leave Application",DocumentType,"Application Code");
                ...
                //     end;
                // }
                action("Print Leave Resumption Form")
                {
                    ApplicationArea = Basic;
                    Caption = 'Print Leave Resumption Form';
                    Image = PrintReport;
                    Promoted = true;
                    PromotedCategory = Category4;
                    PromotedIsBig = true;
                    Visible = ShowLeaveResumptionAction;
                    ToolTip = 'Print the Leave Resumption Form';
                    ...
                    begin
                        ...
                        if HRLeaveApp.Find('-') then
                            Report.Run(50127, true, true, HRLeaveApp);
                    end;
                }
                ...
                action("Re-Open")
                {
                    ...
                    begin
                        ConfirmReopen := Confirm('Are you sure you want to re-open this leave application?\This will reverse all posted ledger entries and restore your leave balance.', false);

                        if not ConfirmReopen then
                            exit;
                        LeaveLedgerEntry.Reset();
                        LeaveLedgerEntry.SetRange("Document No.", Rec."Application Code");
                        ...
                        if LeaveLedgerEntry.FindSet() then begin
                            ...
                            Message('Ledger entries reversed. Leave balance has been restored.');
                        end;
                        ...
                        Message('Leave application re-opened successfully. You can now modify the details.');
                    end;
                }
                action(Print)
                {
                    ...
                    begin
                        ...
                        HRLeaveApp.SetRange(HRLeaveApp."Application Code", Rec."Application Code");
                        if HRLeaveApp.Find('-') then
                            Report.Run(99097, true, true, HRLeaveApp);
                    end;
                }
    ...
    var
      ...
      //  [InDataSet]
       ...
       // [InDataSet]
        ...
        ShowLeaveResumptionAction: Boolean;
        ...
        TEXT005: label 'You can not take Terminal Leave  More than once in a year';
        CummDays: Integer;
        dTaken1: Decimal;
    ...
    begin
        Rec.CalcFields(Recalled);
        ShowLeaveResumptionAction := Rec.Resumed or Rec.Recalled;
    end;
