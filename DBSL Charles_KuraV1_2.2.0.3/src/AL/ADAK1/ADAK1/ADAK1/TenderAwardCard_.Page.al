...
/// <summary>
/// Page Tender Award Card_ (ID 70101).
/// </summary>
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Successful Bidder"; Rec."Successful Bidder")
                {
                    ...
                    Editable = false;
                    Visible = true;
                    ToolTip = 'Specifies the value of the Successful Bidder field.';
                }
                field("Select Bidder Vendor No"; Rec."Select Bidder Vendor No")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Select Bidder Vendor No field.';
                }
                field("Selected Bidder Name"; Rec."Selected Bidder Name")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    ToolTip = 'Specifies the value of the Selected Bidder Name field.';
                }
            }
        }
    }
        ...
        area(navigation)
        {
            group("Request for Quotation")
            {
                ...
                action(Evaluators)
                {
                    ...
                    Visible = false;
                    ToolTip = 'Executes the Add Evaluators action.';
                }
                ...
                action("Start Mandatory Evaluation")
                {
                    ...
                    PromotedIsBig = true;
                    Visible = false;
                    ToolTip = 'Executes the Start Mandatory Evaluation action.';
                ...
                action("Mandatory Evaluation Window")
                {
                    ...
                    Visible = false;
                    ToolTip = 'Executes the Mandatory Evaluation Window action.';
                }
                action("Technical Evaluation Window")
                {
                    ...
                    RunPageLink = "Tender No" = field(No);
                    Visible = false;
                    ToolTip = 'Executes the Technical Evaluation Window action.';
                }
                ...
                action("Recommend Winner")
                {
                    ...
                    Visible = false;
                    ToolTip = 'Executes the Recommend Winner action.';
                }
                ...
                action("Attach Agenda/Minutes")
                {
                    ...
                    PromotedIsBig = true;
                    Visible = false;
                    ToolTip = 'Executes the Attach Agenda/Minutes action.';
                ...
                action("See All Bidders")
                {
                    ...
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    ToolTip = 'Executes the See All Bidders action.';
                ...
                action("Email Bidders")
                {
                    ...
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    ToolTip = 'Executes the Email Bidders action.';
                ...
                action("Generate LPO/ Contract")
                {
                    ...
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    ToolTip = 'Executes the Generate LPO/ Contract action.';
                    ...
                    begin
                        ...
                        if Format(conftxt) = 'Yes' then begin
                            ...
                            if optionselected = 2 then begin
                                ...
                                Contractrec.Code := NoSeriesMgt.GetNextNo(PSetup."Contract Nos", WorkDate(), true);
