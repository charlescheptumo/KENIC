...
/// <summary>
/// Page Purchase Requisition (ID 50071).
/// </summary>
...
Page 50071 "Purchase Requisition card"
{
            ...
            group(Print)
            {
                ...
                action(AttachDocuments)
                {
                    ...
                    begin
                        ...
                        DMSManagement.UploadReceiptsDocuments(Rec."No.", 'Imprest Surrender', Rec.RecordId, Rec."Shortcut Dimension 1 Code");
                    end;
                }
            }
        }
    ...
    begin
        ...
        EmailMsg.Create(TxtReceipientsList, 'This is a test', '', false, TxtDefaultCCMailList,
