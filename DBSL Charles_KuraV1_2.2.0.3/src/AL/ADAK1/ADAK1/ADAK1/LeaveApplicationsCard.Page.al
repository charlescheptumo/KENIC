#pragma warning disable AA0005, AA0008, AA0018, AA0021, AL0523,AA0072, AA0137, AA0201, AA0206, AA0218, AA0228, AL0254, AL0424, AW0006 // ForNAV settings
...
Page 69207 "Leave Applications Card"
{
    ...
    //  DeleteAllowed = false;
    PageType = Card;
    PromotedActionCategories = 'New,Process,Report,Functions,Comments,Attachments';
            ...
            group("F&unctions")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    var
                        ...
                        VarVariant: Variant;
                        Attachs: Record "Document Attachment";
                    // Not: Record RecordLinks;
                    begin
                        ...
                        if Rec."Leave Type" = 'MATERNITY' then begin
                            Attachs.TestField(ID);
                        end;
                        if Rec."Leave Type" = 'SICK' then begin
                            // Note.TestField();
    ...
    begin
        Rec."Document Type" := Rec."Document Type"::"Leave Application";
    end;
    ...
    var
        ...
        TEXT005: label 'You can not take Terminal Leave for less than %1 Days';
