...
Table 57012 "Other Costs"
{
    ...
    fields
    {
        ...
        field(69034; Rate; Decimal)
        {
            trigger OnValidate()
            begin
                //VALIDATE("Work Type");
                // Amount := "No. Required" * "No. of Days" * Rate;
                "Line Amount" := "No. of Days" * Rate;
            end;
        }
    }
    ...
    begin
        ...
        if ImprestMemo.findfirst() then begin
            ...
            if ReceiptAndPaymentTypes.FindFirst() then begin
                "Budgeted Amount" := CustomFunction.GetBudgtedAmount(ReceiptAndPaymentTypes."G/L Account", ImprestMemo."Shortcut Dimension 1 Code", ImprestMemo."Shortcut Dimension 2 Code", ImprestMemo."Shortcut Dimension 3 Code");
                "Account Actual Spent" := CustomFunction.GetActualSpent(ReceiptAndPaymentTypes."G/L Account", ImprestMemo."Shortcut Dimension 1 Code", ImprestMemo."Shortcut Dimension 2 Code", ImprestMemo."Shortcut Dimension 3 Code");
                "Committed Amount" := CustomFunction.GetCommittedAmount(ReceiptAndPaymentTypes."G/L Account", CustomFunction.GetBudgetYear(ImprestMemo.Date), ImprestMemo."Shortcut Dimension 1 Code", ImprestMemo."Shortcut Dimension 2 Code", ImprestMemo."Shortcut Dimension 3 Code");
