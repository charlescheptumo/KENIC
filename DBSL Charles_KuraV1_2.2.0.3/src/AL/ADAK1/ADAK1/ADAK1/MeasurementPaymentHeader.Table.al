...
Table 72188 "Measurement &  Payment Header"
{
    ...
    fields
    {
        field(1; "Document Type"; Option)
        {
            ...
            OptionCaption = ' ,Measurement Sheet,Contractor Notice of Works,Works Inspection,Payment Certificate,Contractor Payment Request,New Job Voucher,Contractor Request for Taking Over,Contractor Request for End of DLP Inspection,Fee Note';
            OptionMembers = " ","Measurement Sheet","Contractor Notice of Works","Works Inspection","Payment Certificate","Contractor Payment Request","New Job Voucher","Contractor Request for Taking Over","Contractor Request for End of DLP Inspection","Fee Note";
        }
    ...
    begin
        if "Document No." = '' then begin
            if "Document Type" = "document type"::"Measurement Sheet" then begin
                ...
                "Document No." := NoSeriesManagement.GetNextNo(RoadManagementSetup."Measurement Sheet Nos", WorkDate(), true);
