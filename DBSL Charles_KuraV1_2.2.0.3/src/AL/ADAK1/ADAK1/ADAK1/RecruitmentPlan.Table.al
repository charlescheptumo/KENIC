...
Table 69613 "Recruitment Plan"
{
    ...
    begin
        if "Recruitment Plan Type" = "recruitment plan type"::"Functional Plan" then begin
           ...
           "Document No.":= NoSeriesMgt.GetNextNo(HumanResourcesSetup."Functional Plan Nos.", WorkDate(), true);
            end;
            ...
            if "Recruitment Plan Type" = "recruitment plan type"::"Annual HR Plan" then begin
                if "Document No." = '' then begin
                  ...
                  "Document No.":= NoSeriesMgt.GetNextNo(HumanResourcesSetup."Recruitment Plan Nos.", WorkDate(), true);
                end;
            end;
        end;
        "Document Date" := Today;
