...
Page 65065 "Research Center Factbox"
{
    ...
    layout
    {
        area(content)
        {
            ...
            {
                ApplicationArea = Basic;
                ToolTip = 'Specifies the value of the No. of Research Programs field.';
            }
            field("No. of Awarded GFO"; Rec."No. of Awarded GFO")
            {
                ...
                StyleExpr = true;
                ToolTip = 'Specifies the value of the No. of Awarded Grant Funding Proposals field.';
            }
            field("No. of Lost Grant GFO"; Rec."No. of Lost Grant GFO")
            {
                ApplicationArea = Basic;
                Caption = 'No. of Lost Grant Grant Funding Proposals';
                ToolTip = 'Specifies the value of the No. of Lost Grant Grant Funding Proposals field.';
            }
