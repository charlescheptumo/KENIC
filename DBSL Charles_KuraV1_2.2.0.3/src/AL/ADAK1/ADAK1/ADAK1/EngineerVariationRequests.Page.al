...
Page 72602 "Engineer Variation Requests"
{
    ApplicationArea = Basic;
    CardPageID = "Engineer Variation Request";
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
    PageType = List;
    SourceTable = "Project Variation Header";
    SourceTableView = where("Document Type" = filter("Engineer Variation Request"));
    UsageCategory = Tasks;
    ...
    begin
        Rec."Document Type" := Rec."document type"::"Engineer Variation Request";
    end;
}
