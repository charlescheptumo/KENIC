    ...
    begin
        if "Document No" = '' then begin
            ...
            if "Document Type" = "document type"::"InterBank Requisition Voucher" then begin
               ...
               "Document No"  := NoSeriesMgt.GetNextNo(ObjCashSetup."AIE Requisition Nos", WorkDate(), true);
            end;
        end;
        ...
        if "Document No" = '' then begin
            ...
            if "Document Type" = "document type"::"AIE Funds Transfer" then begin
             ...
             "Document No"  := NoSeriesMgt.GetNextNo(ObjCashSetup."AIE Funds Transfer Nos", WorkDate(), true);
            end;
        end;
