    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Minimum Order Amount field.';
                }
    ...
    actions
    {
        area(processing)
        {
            ...
            action("View Technical Documents")
            {
                ...
                PromotedCategory = Process;
                PromotedIsBig = true;
                ToolTip = 'Executes the View Technical Documents action.';
            ...
            action("Proceed to Financial")
            {
                ...
                PromotedCategory = Process;
                PromotedIsBig = true;
                ToolTip = 'Executes the Proceed to Financial action.';
