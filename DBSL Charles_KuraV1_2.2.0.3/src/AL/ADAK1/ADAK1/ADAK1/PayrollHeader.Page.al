...
Page 69029 "Payroll Header"
{
        ...
        area(navigation)
        {
                ...
                action("Insert SV Lines")
                {
                    ...
                    begin
                        ...
                        */
                        ...
                        Report.Run(69007, true, true, PayrollHeaderT);
            ...
            group("Payroll Reconcilliation Reports")
            {
                ...
                action(" Child Support Schedule Report")
                {
                    ...
                    Image = "Report";
                    Promoted = false;
                    ToolTip = 'Executes the  Child Support Schedule Report action.';
                    //The property 'PromotedIsBig' can only be set if the property 'Promoted' is set to 'true'
                    //PromotedIsBig = false;
    ...
    begin
        ...
        if (not (UserSetup."Payroll View" or UserSetup."Accounts User")) then
            Error('You do not have sufficient rights to view Salary Voucher! Please contact the system administrator.');
