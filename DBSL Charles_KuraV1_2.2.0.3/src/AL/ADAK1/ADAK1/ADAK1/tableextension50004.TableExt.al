...
TableExtension 50004 "tableextension50004" extends Customer
{
    ...
    fields
    {
        ...
        field(56002; "Customer Type"; Enum "Customer Type")
        {
        ...
        field(69028; "Date of Birth"; Date)
        {
            DataClassification = CustomerContent;
        }
        field(69029; Sport; Code[50])
        {
            ...
            begin
                Sport.Reset();
                Sport.SetRange("Sport Code", Rec.Sport);
                if Sport.findfirst() then
                    "Sport Discipline" := Sport.Discipline;
            end;
        }
        field(69030; "Sport Discipline"; Code[50])
        {
            TableRelation = "Sport Discipline"."Discipline Code";
        }
        field(69031; Gender; Enum "Employee Gender")
        {
            DataClassification = CustomerContent;
            //  OptionMembers = Male,Female,Other;
        }
        field(69032; Signature; Media)
        {
        ...
        modify("Tax Liable")
        {
            ...
            var
                ...
                Err002: Label 'KRA Pin Attachment is required.';
    ...
    */
    ...
    procedure IsUnder18(CustNo: Code[20]): Boolean
    var
        Cust: Record Customer;
    begin
        if Cust.Get(CustNo) then begin
            if Cust."Date of Birth" <> 0D then
                IF (Today - Cust."Date of Birth") < 6570 then
                    exit(true) else
                    exit(false);
        end;
    end;
