...
{
    Caption = 'Vendor Professional Staff';
    DrillDownPageID = "Vendor Professional Staff";
    LookupPageID = "Vendor Professional Staff";
    ...
    keys
    {
        key(Key1; "Staff Number", "Entry No.")
        {
            Clustered = true;
        }
        key(Key2; "Staff Name", "Current Designation", "Staff Category")
        {
        }
    }
    ...
    fieldgroups
    {
        fieldgroup(DropDown; "Staff Number", "Staff Name", "Current Designation", "Staff Category")
        {
        }
        fieldgroup(Brick; "Staff Number", "Staff Name", "Current Designation", "Staff Category")
        {
        }
    }
