...
/// <summary>
/// Page Retention Payment Request (ID 72778).
/// </summary>
Page 72778 "Retention Payment Request"
{
    DeleteAllowed = false;
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Contractor Request Cert Amount field.';
                }
    ...
    actions
    {
        area(navigation)
        {
            ...
            action("Export Template")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Generate Previous IPC action.';
            ...
            action("Variation of Price Indices")
            {
                ...
                ToolTip = 'Executes the VoP Indices action.';
            }
            action("Send Approval Request")
            {
                ...
                begin
                    ...
                    RecVariant := Rec;
                    RMSManagement.FnPopulateApprovalEntryCustomeWorkflow(RecVariant, Rec."Project ID", Documenttype::"Work Execution Plan", Rec."Project ID", CustApprovalEntry."document type"::PCO, 0, Rec.RecordId, FnGetTableNo());
    ...
    begin
        ...
        Rec."Payment Certificate Type" := Rec."payment certificate type"::"Retention Payment";
    end;
