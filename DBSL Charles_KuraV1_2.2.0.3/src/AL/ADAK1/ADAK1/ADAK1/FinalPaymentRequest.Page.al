...
Page 72777 "Final Payment Request"
{
    DeleteAllowed = false;
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Advance Payment Security ID field.';
                }
    ...
    begin
        ...
        Rec."Payment Certificate Type" := Rec."payment certificate type"::"Final Payment";
    end;
