...
Table 70227 "Vendor Company Shareholders"
{
    Caption = 'Contact';
    ...
    fields
    {
        field(1; "Entry No."; Integer)
        {
            ...
            //     {
            //         DataClassification = ToBeClassified;
            //         OptionCaption = 'ID,Passport';
            //         OptionMembers = ID,Passport;
            //     }
            //     field(28;"Registration No";Code[50])
            //     {
            //         DataClassification = ToBeClassified;
            //     }
            //     field(29;"Entity Type";Code[50])
            //     {
            //         DataClassification = ToBeClassified;
            //         TableRelation = "Business Types".Code;
            //     }
            //     field(30;"KRA PIN";Code[50])
            //     {
            //         DataClassification = ToBeClassified;
            //     }
            //     field(31;"Record ID";Integer)
            //     {
            //         DataClassification = ToBeClassified;
            //         TableRelation = "Vendor Business Owner"."Entry No.";
            //     }
            // }

            // keys
            // {
            //     key(Key1;"Entry No.","Record ID","Vendor No.")
            //     {
            //         Clustered = true;
            //     }
            // }
            ...
            // fieldgroups
            // {
            //     fieldgroup(DropDown;"Entry No.","Vendor No.",Field5050,City,Field91,"Phone No.")
            //     {
            //     }
            //     fieldgroup(Brick;"Entry No.","Vendor No.",Field5050,City,"Phone No.",Field140)
            //     {
            //     }
            // }
