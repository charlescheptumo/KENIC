...
Page 90002 "Approved PP Revision Vouchers"
{
    ApplicationArea = Basic;
    CardPageID = "Approved PP Revision Voucher";
    DeleteAllowed = false;
    Editable = false;
    PageType = List;
    SourceTable = "Procurement Plan";
    SourceTableView = where("Revision Voucher" = const(true), "Approval Status" = const(Released));
    UsageCategory = Tasks;
