...
Table 72118 "RICS Existing Road Link"
{
    ...
    fields
    {
        ...
        field(35; "RICS Type"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = ' ,Existing Road Network,New Road Links,Project-based';
            OptionMembers = " ","Existing Road Network","New Road Links","Project-based";
        }
    }
    ...
    begin
        if "RICS No." = '' then begin
            ...
            RoadsManagementSetup.TestField("RICS Existing Link No");
            "RICS No.":= NoSeriesManagement.GetNextNo(RoadsManagementSetup."RICS Existing Link No",WorkDate(),true);
           // NoSeriesManagement.InitSeries(RoadsManagementSetup."RICS Existing Link No", xRec."No. Series", Today, "RICS No.", Rec."No. Series");
        end;
