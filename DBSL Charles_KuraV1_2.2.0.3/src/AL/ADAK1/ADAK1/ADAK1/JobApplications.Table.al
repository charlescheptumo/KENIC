#pragma warning disable AA0005, AA0008, AA0018, AA0021, AA0072, AA0137, AA0201, AA0206, Al0523,AA0218, AA0228, AL0254, AL0424, AW0006 // ForNAV settings
Table 69646 "Job Applications"
{
    ...
    fields
    {
        ...
        field(70; Shortlist; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(71; Longlist; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(72; "Invite Written Assessment"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(73; "Invite interview"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(74; "Second interview"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(75; "Offer Employment"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
    ...
    begin
      ...
      "Application No.":= NoSeriesMgt.GetNextNo(HumanResourcesSetup."Job Application Nos", WorkDate(), true);
        end;
