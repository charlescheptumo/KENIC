    ...
    actions
    {
        ...
        area(embedding)
        {
            ...
            action("GlobalRoadInventory")
            {
                ...
                RunPageMode = Create;
                ToolTip = 'Executes the Global Road Inventory action.';
            ...
            action("RoadStructuresInventory")
            {
                ...
                RunPageMode = Create;
                ToolTip = 'Executes the Road Structures Inventory action.';
            ...
            action("Registered Road Environs")
            {
                ...
                RunPageMode = Create;
                ToolTip = 'Executes the Registered Road Environs action.';
        ...
        area(sections)
        {
            ...
            group(Projects)
            {
                ...
                action("Planned Projects")
                {
                    ...
                    ToolTip = 'Executes the Planned Projects action.';
                }
                ...
                action("Completed/Under DLP Projects")
                {
                    ...
                    ToolTip = 'Executes the Completed/Under DLP Projects action.';
            ...
            group(Setup)
            {
                ...
                action("Roads Management Setup Card")
                {
                    ...
                    ToolTip = 'Executes the Roads Management Setup Card action.';
                }
                ...
                action(Towns)
                {
                    ...
                    Caption = 'Towns';
                    Image = MapSetup;
                    RunObject = Page Towns;
                    ToolTip = 'Executes the Towns action.';
                }
                action(Regions)
                {
                    ApplicationArea = Basic, Suite;
                ...
                group("i-RMS Global Setups")
                {
                    ...
                    action("Roads Management Setup")
                    {
                        ...
                        Image = CompanyInformation;
                        RunObject = Page "Roads Management Setup";
                        ToolTip = 'Executes the Roads Management Setup action.';
                    }
                    action("Funding Year Codes")
                    {
                        ...
                        ToolTip = 'Executes the Funding Year Codes action.';
                    ...
                    action("Road Works Types")
                    {
                        ...
                        ToolTip = 'Executes the Road Works Types action.';
                    }
                    ...
                    action("Road Technologies")
                    {
                        ...
                        ToolTip = 'Executes the Road Technologies action.';
                    }
                    ...
                    action("Road Facility Types")
                    {
                        ...
                        ToolTip = 'Executes the Road Facility Types action.';
                    }
                    action("Road Environs Categories")
                    {
                        ...
                        ToolTip = 'Executes the Road Environs Categories action.';
                    }
                    action("Pavement Layers")
                    {
                        ...
                        ToolTip = 'Executes the Pavement Layers Setup action.';
                    }
                    action("Pavement Layer Test Setups")
                    {
                        ...
                        ToolTip = 'Executes the Pavement Layer Test Setups action.';
                    }
                    action("Materials On Site Setup")
                    {
                        ...
                        ToolTip = 'Executes the Materials On Site Setup action.';
                    }
                    action("Required Document Types")
                    {
                        ...
                        ToolTip = 'Executes the Required Document Types action.';
                    }
                    action("Consultacy Report Types")
                    {
                        ...
                        ToolTip = 'Executes the Consultacy Report Types action.';
                    }
                }
                group("i-RMS Default Template Setups")
                {
                    ...
                    action("Standard BoQ Templates")
                    {
                        ...
                        ToolTip = 'Executes the Standard BoQ Templates action.';
                    }
                    action("Project BoQs")
                    {
                        ApplicationArea = Basic, Suite;
                        ...
                        Image = NonStockItemSetup;
                        RunObject = Page "BoQ Requisition Template";
                        ToolTip = 'Executes the Project BoQs action.';
                        //ToolTip = 'Install Extensions for greater functionality of the system.';
                    }
                    action("Engineer's Estimates")
                    {
                        ...
                        Image = ServiceTasks;
                        RunObject = Page "BoQ Requisition Template";
                        ToolTip = 'Executes the Engineer''s Estimates action.';
                        // ToolTip = 'Enable and configure external services, such as exchange rate updates, Microsoft Social Engagement, and electronic bank integration.';
                    }
                    action("Project Staff Templates")
                    {
                        ...
                        ToolTip = 'Executes the Project Staff Templates action.';
                    }
                    ...
                    action("Required Document Templates")
                    {
                        ...
                        ToolTip = 'Executes the Required Document Templates action.';
                    }
                    action("Default Meeting Templates")
                    {
                        ...
                        ToolTip = 'Executes the Default Meeting Templates action.';
                    }
                    action("Checklist Templates")
                    {
                        ...
                        ToolTip = 'Executes the Checklist Templates action.';
                    }
                    action("Project Materials Templates")
                    {
                        ...
                        ToolTip = 'Executes the Project Materials Templates action.';
                    }
                }
            }
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            group("RMS Home")
            {
                ...
                action("Kenya Road Inventory")
                {
                    ...
                    RunObject = Page "Global Road Inventory";
                    ToolTip = 'Executes the Kenya Road Inventory action.';
                    //  ToolTip = 'Define a project activity by creating a job card with integrated job tasks and job planning lines, structured in two layers. The job task enables you to set up job planning lines and to post consumption to the job. The job planning lines specify the detailed use of resources, items, and various general ledger expenses.';
                }
                action("HNational Secondary Roads")
                {
                    ...
                    ToolTip = 'Executes the National Secondary Roads action.';
                    // RunPageView = WHERE(Status = FILTER(Open));
                    // ToolTip = 'Open the card for the selected record.';
                }
                action(HNationalTrunkRoads)
                {
                    ...
                    ToolTip = 'Executes the National Trunk Roads action.';
                ...
                action(HCountyRoads)
                {
                    ...
                    ToolTip = 'Executes the County Roads action.';
                    //RunPageView = WHERE(Status = FILTER(Completed));
                ...
                action(HKWSRoads)
                {
                    ...
                    ToolTip = 'Executes the KWS Roads action.';
                    // RunPageView = WHERE("Person Responsible" = FILTER(''));
                ...
                action(HSpecialPurposeRoads)
                {
                    ...
                    ToolTip = 'Executes the Special Purpose Roads action.';
                ...
                action("HUnclassified Roads")
                {
                    ...
                    ToolTip = 'Executes the Unclassified Roads action.';
                ...
                action("Road Facilities Inventory")
                {
                    ...
                    ToolTip = 'Executes the Road Facilities Inventory action.';
                ...
                action("Projects List")
                {
                    ...
                    RunObject = Page "Job List";
                    ToolTip = 'Executes the Projects List action.';
            ...
            group("Survey")
            {
                ...
                action("Urban Roads")
                {
                    ...
                    Caption = 'Urban Roads';
                    RunObject = Page "Urban Roads";
                    ToolTip = 'Executes the Urban Roads action.';
                    // RunPageView = WHERE("Person Responsible" = FILTER(''));
                    //ToolTip = 'Open the list of all unassigned jobs.';
                }
                action("KWSRoads")
            ...
            group("Budgeting&Workplanning")
            {
                ...
                action("Multi Year Financing Projections")
                {
                    ...
                    RunObject = Page "Multi Year Plan";
                    ToolTip = 'Executes the Multi Year Financing Projections action.';
                    //  ToolTip = 'Define a project activity by creating a job card with integrated job tasks and job planning lines, structured in two layers. The job task enables you to set up job planning lines and to post consumption to the job. The job planning lines specify the detailed use of resources, items, and various general ledger expenses.';
                }
                action("AnnualBudgetAllocationConstruction")
                {
                    ...
                    RunObject = Page "Global Construction Budgets";
                    ToolTip = 'Executes the Annual Budget Allocation Construction action.';
                    // RunPageView = WHERE(Status = FILTER(Open));
                    // ToolTip = 'Open the card for the selected record.';
                }
                action("AnnualBudgetAllocationMaintenance")
                {
                    ...
                    RunObject = Page "Global Maintenance Budget";
                    ToolTip = 'Executes the Annual Budget Allocation Maintenance action.';
                    // ToolTip = 'Open the list of all planned and quoted jobs.';
                }
                action("AnnualBudgetAllocationConsultancy")
                {
                    ...
                    RunObject = Page "Global Studies/Surveys Budgets";
                    ToolTip = 'Executes the Annual Budget Allocation Consultancy action.';
                    //RunPageView = WHERE(Status = FILTER(Completed));
                    //ToolTip = 'Open the list of all completed jobs.';
                }
                action("RoadWorkplansMaintenance12")
                {
                    ...
                    RunObject = Page "Regional Maintenance W_Plans";
                    ToolTip = 'Executes the Road Workplans Maintenance action.';
                    // RunPageView = WHERE("Person Responsible" = FILTER(''));
                    //ToolTip = 'Open the list of all unassigned jobs.';
                }
                action("ScheduleofDevelopment Projects")
                {
                    ...
                    RunObject = Page "Schedule Of Con Road Projects";
                    ToolTip = 'Executes the Schedule Of Planned Projects action.';
                    // ToolTip = 'Open the list of ongoing job tasks. Job tasks represent the actual work that is performed in a job, and they enable you to set up job planning lines and to post consumption to the job.';
                }
                action("Workplans For Consultancy Projects1")
                {
                    ...
                    Image = JobRegisters;
                    RunObject = Page "Workplans for Studies/Surveys";
                    ToolTip = 'Executes the Workplans For Consultancy Projects action.';
                    // ToolTip = 'View auditing details for all job ledger entries. Every time an entry is posted, a register is created in which you can see the first and last number of its entries in order to document when entries were posted.';
                }
                action("Roadworks Budget Ceiling")
                {
                    ...
                    ToolTip = 'Executes the Roadworks Budget Ceiling action.';
                }
                action("Town RAM workplans")
                {
                    Caption = 'Towns Workplans';
                    Image = Planning;
                    RunObject = page "Town Workplans";
                    ToolTip = 'Executes the Towns Workplans action.';
                }
                action("Regional RAM workplans")
                {
                    ...
                    ToolTip = 'Executes the Regional Workplans action.';
                }
                action("Submitted Regional RAM workplans")
                {
                    ...
                    ToolTip = 'Executes the Submitted Regional Workplans action.';
                }
                action("Consolidated Regional RAM workplans")
                {
                    ...
                    ToolTip = 'Executes the Consolidated Regional Workplans action.';
                }
            ...
            group("DevelopmentProjects")
            {
                ...
                action("ProjectsUnderPBRM")
                {
                    ...
                    ToolTip = 'Executes the Projects Under PBRM action.';
                ...
                action("CompletedProjects")
                {
                    ...
                    ToolTip = 'Executes the Completed Projects action.';
            ...
            group("ConsultancyProjects")
            {
                ...
                action("ESIA Studies")
                {
                    ...
                    ToolTip = 'Executes the ESIA Studies action.';
                ...
                action("Topographic Surveys")
                {
                    ...
                    ToolTip = 'Executes the Topographic Surveys action.';
                ...
                action("Traffic Census")
                {
                    ...
                    RunObject = Page "Job List";
                    RunPageView = WHERE(Status = FILTER("Completed"), "type of Project" = FILTER("Survey/Study"));
                    ToolTip = 'Executes the Traffic Census action.';
                ...
                action("Road Safety Audits")
                {
                    ...
                    RunObject = Page "Job List";
                    RunPageView = WHERE(Status = FILTER("Completed"), "type of Project" = FILTER("Survey/Study"));
                    ToolTip = 'Executes the Road Safety Audits action.';
                ...
                action("Environmental Audits")
                {
                    ...
                    RunObject = Page "Job List";
                    RunPageView = WHERE(Status = FILTER("Completed"), "type of Project" = FILTER("Survey/Study"));
                    ToolTip = 'Executes the Environmental Audits action.';
            ...
            group("ProcurementofWorks")
            {
                ...
                action("Works Purchase Requisitions")
                {
                    ...
                    ToolTip = 'Executes the Works Purchase Requisitions action.';
                    // RunPageView = WHERE(Status = FILTER("Planned"), "type of Project" = FILTER("Survey/Study"));
                ...
                action("Approved Works Requisitions")
                {
                    ...
                    ToolTip = 'Executes the Approved Works Requisitions action.';
                    // RunPageView = WHERE(Status = FILTER("Planned"), "type of Project" = FILTER("Survey/Study"));
                ...
                action("Awarded Works Contracts")
                {
                    ...
                    RunObject = Page "Signed Contract List";
                    ToolTip = 'Executes the Awarded Works Contracts action.';
                    // RunPageView = WHERE(Status = FILTER("Planned"), "type of Project" = FILTER("Survey/Study"));
                ...
                action("Requisitions for Consultancies")
                {
                    ...
                    RunObject = Page "Survey/Study/Design Requests";
                    ToolTip = 'Executes the Requisitions for Consultancies action.';
                    // RunPageView = WHERE(Status = FILTER("Planned"), "type of Project" = FILTER("Survey/Study"));
                }
            }
            ...
            group("ProjectMobilization1")
            {
                ...
                action("Project Mobilization")
                {
                    ApplicationArea = ProcurementofWorks;
                    Caption = 'Project Mobilization';
                    RunObject = Page "Project Commencement Orders";
                    RunPageView = WHERE(Status = FILTER("Open" | "Pending Approval"));
                    ToolTip = 'Executes the Project Mobilization action.';
                }
                ...
                action("AcknowledgedOrderstoCommence")
                {
                    ...
                    RunObject = Page "Posted Proj. Comence Oders";
                    ToolTip = 'Executes the Acknowledged Orders to Commence action.';
                ...
                action("Submitted Program of Works")
                {
                    ...
                    RunObject = Page "Work Execution Plans";
                    ToolTip = 'Executes the Submitted Program of Works action.';
                ...
                action("Approved Program of Works")
                {
                    ...
                    RunObject = Page "Released Work Execution Plans";
                    ToolTip = 'Executes the Approved Program of Works action.';
                ...
                action("Project Communication Plans")
                {
                    ...
                    RunObject = Page "Communication Plans";
                    ToolTip = 'Executes the Project Communication Plans action.';
                }
                action("Project Risk Management Plans")
                {
                    ApplicationArea = ProcurementofWorks;
                    Caption = 'Project Risk Management Plans';
                    RunObject = Page "StrategicRiskManagement Plans.";
                    ToolTip = 'Executes the Project Risk Management Plans action.';
                }
                action("ProjectQualityManagement Plans1")
                {
                    ApplicationArea = ProcurementofWorks;
                    Caption = 'Project Quality Management Plans';
                    RunObject = Page "Quality Management Plans";
                    ToolTip = 'Executes the Project Quality Management Plans action.';
                }
                ...
                action("Project Staff Appointments")
                {
                    ...
                    ToolTip = 'Executes the Project Implementation Team action.';
                }
                action("Approved Staff Appointments")
                {
                    ...
                    ToolTip = 'Executes the Approved Project Implementation Team action.';
                }
                action("Project Staff Disengagements")
                {
                    ApplicationArea = ProcurementofWorks;
                    Caption = 'Project Staff Disengagements';
                    RunObject = Page "Project Staff Terminations";
                    RunPageView = WHERE(Status = FILTER("Open" | "Pending Approval"));
                    ToolTip = 'Executes the Project Staff Disengagements action.';
                }
                action("Approved Staff Disengagements")
                {
                    ...
                    ToolTip = 'Executes the Approved Staff Disengagements action.';
                }
                action("Project Mobilization Checklist")
                {
                    ApplicationArea = ProcurementofWorks;
                    Caption = 'Project Mobilization Checklist';
                    RunObject = Page "Proj. Mobilization Checklist L";
                    ToolTip = 'Executes the Project Mobilization Checklist action.';
                ...
                action("Mobiliza Checklist Status Report")
                {
                    ...
                    RunObject = Page "Checklist Status Reports";
                    ToolTip = 'Executes the Mobiliza Checklist Status Report action.';
                }
                group("CIT Nomination")
                {
                    ...
                    action("CIT committee Appointments")
                    {
                        ...
                        ToolTip = 'Executes the CIT committee Appointments action.';
                    }
                    action("Evaluations For PC SumExpensing")
                    {
                        ...
                        ToolTip = 'Executes the Evaluations For PC SumExpensing action.';
                    }
                    action("Requests For PC Sum Expensing")
                    {
                        ...
                        ToolTip = 'Executes the Requests For PC Sum Expensing action.';
                    }
                    action("CIT Report")
                    {
                        ApplicationArea = ProcurementofWorks;
                        RunObject = Report "CIT RMLF";
                        ToolTip = 'Executes the CIT Report action.';
                    }
                }
            ...
            group("ContractorSubmissions")
            {
                ...
                action("Submitted Insurance of Works")
                {
                    ...
                    RunObject = Page "Insurance Of Works";
                    RunPageView = WHERE("Revision Type" = FILTER("Original"), Status = FILTER("Open" | "Pending Approval"));
                    ToolTip = 'Executes the Submitted Insurance of Works action.';
                ...
                action("Approved Advance Guarantees")
                {
                    ...
                    ToolTip = 'Executes the Approved Advance Guarantees action.';
                }
                action("Submitted Professional Indemnity")
                {
                    ...
                    RunObject = Page "Performance Guarantees";
                    RunPageView = WHERE(Status = FILTER("Open" | "Pending Approval"), "Revision Type" = FILTER(Original));
                    ToolTip = 'Executes the Submitted Professional Indemnity action.';
                }
                action("Approved Performance Guarantees")
                {
                    ...
                    ToolTip = 'Executes the Approved Performance Guarantees action.';
                }
                ...
                action("Approved Site Agent Nomination")
                {
                    ...
                    ToolTip = 'Executes the Approved Site Agent Nomination action.';
                }
                ...
                action("Submitted Contract Supervision Requirements")
                {
                    ...
                    RunObject = Page "Vehicle SuperV Requirements";
                    RunPageView = WHERE("Status" = FILTER("Pending Approval" | "Open"), "Rejection Remarks" = FILTER(1));
                    ToolTip = 'Executes the Submitted PC SUM expenditures action.';
                }
                ...
                action("Approved Contract Supervision Requirements")
                {
                    ...
                    RunObject = Page "Vehicle SuperV Requirements";
                    RunPageView = WHERE("Status" = FILTER("Released"));
                    ToolTip = 'Executes the Approved PC SUM expenditures action.';
                }
                ...
                action("Schedule of Equipment Delivery to Site")
                {
                    ...
                    RunObject = Page "Contractor Equipment List";
                    RunPageView = WHERE("Portal Status" = FILTER("Submitted"), "Status" = FILTER("Open" | "Pending Approval"));
                    ToolTip = 'Executes the Schedule of Equipment Delivery to Site action.';
                }
                action("Approved Schedule of Equipment Delivery to Site")
                {
                    ...
                    RunObject = Page "Contractor Equipment List";
                    RunPageView = WHERE("Status" = FILTER("Released"), "Portal Status" = FILTER("Submitted"));
                    ToolTip = 'Executes the Approved Schedule of Equipment Delivery to Site action.';
                }
                action("Contractor Key Staff Appointment")
                {
                    ApplicationArea = ContractorSubmissions;
                    Caption = 'Contractor Key Staff Appointment';
                    RunObject = Page "Contractor Personnel App List";
                    RunPageView = WHERE("Portal Status" = FILTER("Submitted"), "Status" = FILTER("Open" | "Pending Approval"));
                    ToolTip = 'Executes the Contractor Key Staff Appointment action.';
                }
                ...
                action("Approved Contractor Key Staff Appointment")
                {
                    ...
                    RunObject = Page "Contractor Personnel App List";
                    RunPageView = WHERE("Status" = FILTER("Released"), "Portal Status" = FILTER("Submitted"));
                    ToolTip = 'Executes the Approved Contractor Key Staff Appointment action.';
                }
            ...
            group("WorksImplementation")
            {
                ...
                action("Daily Work Records")
                {
                    ...
                    RunObject = Page "Daily Work Records";
                    RunPageView = WHERE("Status" = FILTER("Open" | "Pending Approval"), "Posted" = FILTER(FALSE));
                    ToolTip = 'Executes the Daily Work Records action.';
                }
                ...
                action("Approved Contractor Staff Disengagement")
                {
                    ...
                    ToolTip = 'Executes the Approved Contractor Staff Disengagement action.';
                }
            ...
            group("ContractVariations")
            {
                ...
                action("Extention of Time Requests")
                {
                    ...
                    RunObject = Page "EOT Requests";
                    RunPageView = WHERE("Status" = FILTER("Open" | "Pending Approval"), "Posted" = CONST(False));
                    ToolTip = 'Executes the Extention of Time Requests action.';
                ...
                action("Approved EoT Requests")
                {
                    ...
                    RunObject = Page "EOT Requests";
                    RunPageView = WHERE("Status" = FILTER("Released"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Approved EoT Requests action.';
                ...
                action("Contractor Variation Requests")
                {
                    ...
                    RunObject = Page "Contractor Variation Requests";
                ...
                action("Approved Contractor Variation")
                {
                    ...
                    RunObject = Page "App Contractor Variation Reqs";
                    RunPageView = WHERE("Posted" = CONST(False));
                    ToolTip = 'Executes the Approved Contractor Variation action.';
                }
                action("Engineer Variation Requests")
                {
                    ApplicationArea = ContractVariations;
                    Caption = 'Engineer Variation Requests';
                    RunObject = Page "Engineer Variation Requests";
                    RunPageView = WHERE("Status" = FILTER("Open" | "Pending Approval"), "Posted" = CONST(False));
                    ToolTip = 'Executes the Engineer Variation Requests action.';
                }
                action("Approved Engineer Variation Requests")
                {
                    ApplicationArea = ContractVariations;
                    Caption = 'Approved Engineer Variation Requests';
                    ToolTip = 'Executes the Approved Engineer Variation Requests action.';
                ...
                action("Approved Cost Claims")
                {
                    ...
                    RunObject = Page "Cost Claims";
                    RunPageView = WHERE("Status" = FILTER("Released"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Approved Cost Claims action.';
                }
                action("Subcontractor/Assignee Requests")
                {
                    ApplicationArea = ContractVariations;
                    Caption = 'Subcontractor/Assignee Requests';
                    RunObject = Page "Subcontractor Requests";
                    RunPageView = WHERE("Status" = FILTER("Open" | "Pending Approval"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Subcontractor/Assignee Requests action.';
                }
                action("Approved Subcontractor/Assignee Req")
                {
                    ...
                    RunObject = Page "Subcontractor Requests";
                    RunPageView = WHERE("Status" = FILTER("Released"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Approved Subcontractor/Assignee Req action.';
                }
                action("Evaluation Committee Appointment")
                {
                    ApplicationArea = ContractVariations;
                    Caption = 'Evaluation Committee Appointment';
                    RunObject = Page "RMS Inspection Committees";
                    RunPageView = WHERE("Approval Status" = FILTER("Open" | "Pending Approval"));
                    ToolTip = 'Executes the Evaluation Committee Appointment action.';
                }
                action("EoT Evaluation Reports")
                {
                    ApplicationArea = ContractVariations;
                    Caption = 'EoT Evaluation Reports';
                    RunObject = Page "Project Evaluation Reports";
                    RunPageView = WHERE("Status" = FILTER("Open" | "Pending Approval"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the EoT Evaluation Reports action.';
                }
                action("EoT Professional Opinions")
                {
                    ApplicationArea = ContractVariations;
                    Caption = 'EoT Professional Opinions';
                    RunObject = Page "Project Professional Opinions";
                    RunPageView = WHERE("Posted" = CONST(FALSE));
                    ToolTip = 'Executes the EoT Professional Opinions action.';
                }
                action("Contractor Variation Requests Evaluation Reports")
                {
                    ...
                    RunObject = Page "Project Evaluation Reports";
                    RunPageView = WHERE("Status" = FILTER("Open" | "Pending Approval"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Contractor Variation Requests Evaluation Reports action.';
                }
                action("CVR Professional Opinions")
                {
                    ...
                    RunObject = Page "Project Professional Opinions";
                    RunPageView = WHERE("Posted" = CONST(FALSE));
                    ToolTip = 'Executes the CVR Professional Opinions action.';
                }
                action("EVR Evaluation Reports")
                {
                    ...
                    RunObject = Page "Project Evaluation Reports";
                    RunPageView = WHERE("Status" = FILTER("Open" | "Pending Approval"), "Posted" = CONST(False));
                    ToolTip = 'Executes the EVR Evaluation Reports action.';
                }
                action("EVR Professional Opinions")
                {
                    ...
                    RunObject = Page "Project Professional Opinions";
                    RunPageView = WHERE("Posted" = CONST(FALSE));
                    ToolTip = 'Executes the EVR Professional Opinions action.';
                }
                action("Subcontracting Evaluation Report")
                {
                    ...
                    RunObject = Page "Project Evaluation Reports";
                    RunPageView = WHERE("Status" = FILTER("Open" | "Pending Approval"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Subcontracting Evaluation Report action.';
                }
                action("Subcontracting Prof Opinion")
                {
                    ...
                    RunObject = Page "Project Professional Opinions";
                    RunPageView = WHERE("Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Subcontracting Prof Opinion action.';
                }
                action("Cost Claim Evaluation Reports")
                {
                    ...
                    ToolTip = 'Executes the Cost Claim Evaluation Reports action.';
                }
                action("Cost Claim Professional Opinions")
                {
                    ...
                    RunObject = Page "Project Professional Opinions";
                    RunPageView = WHERE("Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Cost Claim Professional Opinions action.';
                }
                action("Contract Variation Orders")
                {
                    ApplicationArea = ContractVariations;
                    Caption = 'Contract Variation Orders';
                    RunObject = Page "Project Variation Orders";
                    RunPageView = WHERE(Posted = CONST(False));
                    ToolTip = 'Executes the Contract Variation Orders action.';
                }
            }
            //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            group("QA and Control")
            {
                ...
                action("Quality Management Plans")
                {
                    ...
                    RunObject = Page "EOT Requests";
                    RunPageView = WHERE("Status" = FILTER("Open" | "Pending Approval"), "Posted" = CONST(False));
                    ToolTip = 'Executes the Quality Management Plans action.';
                ...
                action("Survey Quality Checks")
                {
                    ...
                    RunObject = Page "Survey Quality Checks";
                    ToolTip = 'Executes the Survey Quality Checks action.';
                }
                action("Material Test Records")
                {
                    ...
                    ToolTip = 'Executes the Material Test Records action.';
                }
                action("Material Test Cert Submission")
                {
                    ApplicationArea = QAandControl;
                    Caption = 'Material Test Cert Submission';
                    RunObject = Page "Material Test Cert Submissions";
                    RunPageView = WHERE("Portal Status" = FILTER("Draft"));
                    ToolTip = 'Executes the Material Test Cert Submission action.';
                }
                action("Pavement Lab Tests")
                {
                    ApplicationArea = QAandControl;
                    Caption = 'Pavement Lab Tests';
                    RunObject = Page "Pavement Lab Tests";
                    RunPageView = WHERE("Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Pavement Lab Tests action.';
                }
                action("Weekly Work Plans")
                {
                    ApplicationArea = QAandControl;
                    Caption = 'Weekly Work Plans';
                    RunObject = Page "Weekly Work Plans";
                    ToolTip = 'Executes the Weekly Work Plans action.';
                }
                action("Monthly Work Plans")
                {
                    ApplicationArea = QAandControl;
                    Caption = 'Monthly Work Plans';
                    RunObject = Page "Monthly Work Plans";
                    ToolTip = 'Executes the Monthly Work Plans action.';
                }
                action("Inspection and Test Requests")
                {
                    ApplicationArea = QAandControl;
                    Caption = 'Inspection and Test Requests';
                    RunObject = Page "Contractor Inspection Requests";
                    ToolTip = 'Executes the Inspection and Test Requests action.';
                }
                action("PC Targets & Outputs")
                {
                    ApplicationArea = QAandControl;
                    Caption = 'PC Targets & Outputs';
                    RunObject = Page "RMS PC Targets&Output List";
                    ToolTip = 'Executes the PC Targets & Outputs action.';
                }
            ...
            group("ProjectRiskManagement")
            {
                ...
                action("Project Risk Registers")
                {
                    ...
                    ToolTip = 'Executes the Project Risk Registers action.';
                }
                action("Risk Status Reports")
                {
                    ...
                    ToolTip = 'Executes the Risk Status Reportss action.';
                }
                ...
                action("New Risk Logs")
                {
                    ...
                    ToolTip = 'Executes the New Risk Logs action.';
                }
                action("RMF")
                {
                    ApplicationArea = ProjectRiskManagement;
                    Caption = 'Risk Management Frameworks';
                    RunObject = Page "Risk Management Frameworks.";
                    ToolTip = 'Executes the Risk Management Frameworks action.';
                }
            ...
            group("MeasurementsPayments")
            {
                ...
                action("Submitted Advance Payment Requests")
                {
                    ...
                    RunObject = Page "Contract Advance Payment Certs";
                    RunPageView = WHERE("Portal Status" = FILTER("Submitted"), Status = FILTER("Open" | "Pending Approval"));
                    ToolTip = 'Executes the Submitted Advance Payment Requests action.';
                }
                action("Approved Advance Payment Requests")
                {
                    ApplicationArea = MeasurementsPayments;
                    Caption = 'Approved Advance Payment Requests';
                    RunObject = Page "Approved Advance Payment Certs";
                    RunPageView = WHERE("Portal Status" = FILTER("Submitted"), "Status" = FILTER("Released"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Approved Advance Payment Requests action.';
                }
                action("Submitted Interim Payments Requests")
                {
                    ApplicationArea = MeasurementsPayments;
                    Caption = 'Submitted Interim Payments Requests';
                    RunObject = Page "Interim Payment Requests";
                    RunPageView = WHERE("Portal Status" = FILTER("Submitted"), "Status" = FILTER("Open" | "Pending Approval"));
                    ToolTip = 'Executes the Submitted Interim Payments Requests action.';
                }
                action("Approved Interim Payments Requests")
                {
                    ...
                    ToolTip = 'Executes the Approved Interim Payments Requests action.';
                ...
                action("Submitted Interest Payment Requests")
                {
                    ...
                    RunObject = Page "Interest Payment Requests";
                    RunPageView = WHERE("Portal Status" = FILTER("Submitted"), "Status" = FILTER("Open" | "Pending Approval"));
                    ToolTip = 'Executes the Submitted Interest Payment Requests action.';
                }
                action("Approved Interest Payment Requests")
                {
                    ...
                    RunObject = Page "Interest Payment Requests";
                    RunPageView = WHERE("Portal Status" = FILTER("Submitted"), "Status" = FILTER("Released"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Approved Interest Payment Requests action.';
                }
                action("Submitted Retention Payment Requests")
                {
                    ApplicationArea = MeasurementsPayments;
                    Caption = 'Submitted Retention Payment Requests';
                    RunObject = Page "Retention Payment Requests";
                    RunPageView = WHERE("Portal Status" = FILTER("Submitted"), "Status" = FILTER("Open" | "Pending Approval"));
                    ToolTip = 'Executes the Submitted Retention Payment Requests action.';
                }
                action("Approved Retention Payment Requests")
                {
                    ...
                    RunObject = Page "Retention Payment Requests";
                    RunPageView = WHERE("Portal Status" = FILTER("Submitted"), "Status" = FILTER("Released"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Approved Retention Payment Requests action.';
                }
                action("Submitted Final Payments Requests")
                {
                    ApplicationArea = MeasurementsPayments;
                    Caption = 'Submitted Final Payments Requests';
                    RunObject = Page "Final Payment Requests";
                    RunPageView = WHERE("Portal Status" = FILTER("Submitted"), "Status" = FILTER("Open" | "Pending Approval"));
                    ToolTip = 'Executes the Submitted Final Payments Requests action.';
                }
                action("Approved Final Payments Requests")
                {
                    ...
                    RunObject = Page "Final Payment Requests";
                    RunPageView = WHERE("Portal Status" = FILTER("Submitted"), "Status" = FILTER("Released"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Approved Final Payments Requests action.';
                }
                action("Submitted Fee Notes")
                {
                    ApplicationArea = MeasurementsPayments;
                    Caption = 'Submitted Fee Notes';
                    RunObject = Page "Final Payment Certificates";
                    ToolTip = 'Executes the Submitted Fee Notes action.';
                }
                action("Approved Fee Notes")
                {
                    ...
                    RunObject = Page "Final Payment Certificates";
                    ToolTip = 'Executes the Approved Fee Notes action.';
                }
            ...
            group("ProjectCompletion")
            {
                ...
                action("Submitted Reqs for Taking Over")
                {
                    ...
                    RunObject = Page "Requests for Project Close-Out";
                    RunPageView = WHERE("Portal Status" = FILTER(Submitted), Status = FILTER("Open" | "Pending Approval"));
                    ToolTip = 'Executes the Submitted Reqs for Taking Over action.';
                ...
                action("Approved Requests for Taking Over")
                {
                    ...
                    RunObject = Page "Approved Advance Payment Certs";
                    RunPageView = WHERE("Portal Status" = FILTER(Submitted), "Status" = FILTER("Released"), Posted = CONST(FALSE));
                    ToolTip = 'Executes the Approved Requests for Taking Over action.';
                ...
                action("Taking Over Inspections")
                {
                    ...
                    RunObject = Page "Taking Over Inspections";
                    RunPageView = WHERE("Status" = FILTER("Open" | "Pending Approval"));
                    ToolTip = 'Executes the Taking Over Inspections action.';
                }
                action("Approved Taking Over Inspections")
                {
                    ...
                    RunObject = Page "Taking Over Inspections";
                    RunPageView = WHERE("Status" = FILTER("Released"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Approved Taking Over Inspections action.';
                }
                action("Submitted Requests for End of DLP")
                {
                    ApplicationArea = ProjectCompletion;
                    Caption = 'Submitted Requests for End of DLP';
                    RunObject = Page "Requests for Post DLP Inspecti";
                    RunPageView = WHERE("Portal Status" = FILTER("Submitted"), "Status" = FILTER("Released"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Submitted Requests for End of DLP action.';
                }
                action("Approved Requests for End of DLP")
                {
                    ...
                    RunObject = Page "Requests for Post DLP Inspecti";
                    RunPageView = WHERE("Portal Status" = FILTER("Submitted"), "Status" = FILTER("Released"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Approved Requests for End of DLP action.';
                }
                action("End of DLP Inspections")
                {
                    ApplicationArea = ProjectCompletion;
                    Caption = 'End of DLP Inspections';
                    RunObject = Page "End of DLP Inspections";
                    RunPageView = WHERE("Status" = FILTER("Open" | "Pending Approval"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the End of DLP Inspections action.';
                }
                action("Approved End of DLP Inspections")
                {
                    ...
                    RunObject = Page "End of DLP Inspections";
                    RunPageView = WHERE("Status" = FILTER("Released"), "Posted" = CONST(FALSE));
                    ToolTip = 'Executes the Approved End of DLP Inspections action.';
                }
                action("Project Transition to PBRM")
                {
                    ApplicationArea = ProjectCompletion;
                    Caption = 'Project Transition to PBRM';
                    RunObject = Page "Project Transitions";
                    ToolTip = 'Executes the Project Transition to PBRM action.';
                }
                action("Final Accounts")
                {
                    ApplicationArea = ProjectCompletion;
                    Caption = 'Final Accounts';
                    RunObject = Page "Final Accounts List";
                    ToolTip = 'Executes the Final Accounts action.';
                }
                action("Inspection Commitee Appointment")
                {
                    ...
                    RunObject = Page "RMS Inspection Committees";
                    ToolTip = 'Executes the Inspection Commitee Appointment action.';
            ...
            group("iRMSReports")
            {
                ...
                group("i-RMS Reports")
                {
                    ...
                    action(Action82)
                    {
                        ...
                        Image = "Report";
                        ToolTip = 'Executes the Road Inventory action.';
                    ...
                    action("<Report Multi Year Projections")
                    {
                        ...
                        Image = "Report";
                        ToolTip = 'Executes the Multi Year Projections List action.';
                    ...
                    action("Annual Budget Allocations List")
                    {
                        ...
                        Image = "Report";
                        ToolTip = 'Executes the Annual Budget Allocations List action.';
                    ...
                    action("Road WorkPlan Summary")
                    {
                        ...
                        Image = "Report";
                        ToolTip = 'Executes the Road WorkPlan Summary action.';
                    ...
                    action("Project Mobilization Status")
                    {
                        ...
                        Image = "Report";
                        ToolTip = 'Executes the Project Mobilization Status Report action.';
                    ...
                    action("Insurance/Guarantee Report")
                    {
                        ApplicationArea = Basic;
                        Image = "Report";
                        ToolTip = 'Executes the Insurance/Guarantee Report action.';
                    ...
                    action("Project Meeting Registers")
                    {
                        ApplicationArea = Basic;
                        Image = "Report";
                        ToolTip = 'Executes the Project Meeting Registers action.';
                    ...
                    action("PC Targets and Output Report")
                    {
                        ApplicationArea = Basic;
                        Image = "Report";
                        ToolTip = 'Executes the PC Targets and Output Report action.';
                    ...
                    action("Advance Payment Requests")
                    {
                        ApplicationArea = Basic;
                        Image = "Report";
                        ToolTip = 'Executes the Advance Payment Requests action.';
                    ...
                    action("Contractor Payment Requests")
                    {
                        ApplicationArea = Basic;
                        Image = "Report";
                        ToolTip = 'Executes the Contractor Payment Requests action.';
                    ...
                    action("Taking Over Inspections List")
                    {
                        ApplicationArea = Basic;
                        Image = "Report";
                        ToolTip = 'Executes the Taking Over Inspections List action.';
                    ...
                    action("End of DLP Inspections List")
                    {
                        ApplicationArea = Basic;
                        Image = "Report";
                        ToolTip = 'Executes the End of DLP Inspections List action.';
                    ...
                    action("Pavement Record Chart")
                    {
                        ...
                        Image = "Report";
                        ToolTip = 'Executes the Pavement Record Chart action.';
                    ...
                    action("Final Account List")
                    {
                        ApplicationArea = Basic;
                        Image = "Report";
                        ToolTip = 'Executes the Final Account List action.';
                    ...
                    action("Project Status Report")
                    {
                        ApplicationArea = Basic;
                        Image = "Report";
                        ToolTip = 'Executes the Project Status Report action.';
                    ...
                    action("Project Progress Report")
                    {
                        ApplicationArea = Basic;
                        Image = "Report";
                        ToolTip = 'Executes the Project Progress Report action.';
        ...
        area(processing)
        {
            group(NewGroup)
            {
                ...
                action("Road Activities Categories")
                {
                    ...
                    RunPageMode = Create;
                    ToolTip = 'Executes the Road Activities Categories action.';
                    ///ToolTip = 'Create a new job.';
                }
                ...
                action("Road Asset")
                {
                    ...
                    RunPageMode = Create;
                    ToolTip = 'Executes the Road Asset action.';
                    ///ToolTip = 'Create a new job.';
                }
