...
Query 55014 "ImprestLines"
{

    elements
    {
        dataitem(Imprest_Lines; "Imprest Lines")
        {
            column(No; No)
            {
            }
            ...
            column(Advance_Type; "Advance Type")
            {
            }
            ...
            column(Imprest_Holder; "Imprest Holder")
            {
            }
            ...
            column(Budgetary_Control_A_C; "Budgetary Control A/C")
            {
            }
            ...
            column(Job_Quantity; "Job Quantity")
            {
            }
