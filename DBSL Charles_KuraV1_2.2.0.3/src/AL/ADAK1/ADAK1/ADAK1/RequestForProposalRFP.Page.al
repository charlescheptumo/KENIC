        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Submission End Date"; Rec."Submission End Date")
                {
                    ...
                    ToolTip = 'Specifies the value of the RFP Submission End Date field.';
                }
                field("Submission End Time"; Rec."Submission End Time")
                {
                    ApplicationArea = Basic;
                    Caption = 'RFP Submission End Time';
                    ToolTip = 'Specifies the value of the RFP Submission End Time field.';
                }
                field("Bid Opening Date"; Rec."Bid Opening Date")
                {
                    ApplicationArea = Basic;
                    Caption = 'RFP Opening Date';
                    ToolTip = 'Specifies the value of the RFP Opening Date field.';
                }
                field("Bid Opening Time"; Rec."Bid Opening Time")
                {
                    ApplicationArea = Basic;
                    Caption = 'RFP Opening Time';
                    ToolTip = 'Specifies the value of the RFP Opening Time field.';
                }
                ...
                field("Tender Validity Duration"; Rec."Tender Validity Duration")
                {
                    ...
                    ToolTip = 'Specifies the value of the RFP Validity Duration field.';
                }
                field("Tender Validity Expiry Date"; Rec."Tender Validity Expiry Date")
                {
                    ApplicationArea = Basic;
                    Caption = 'RFP Validity Expiry Date';
                    ToolTip = 'Specifies the value of the RFP Validity Expiry Date field.';
                }
                ...
                field("Bid Scoring Template"; Rec."Bid Scoring Template")
                {
                    ...
                    ToolTip = 'Specifies the value of the RFP Evaluation Criteria field.';
                }
