...
TableExtension 50018 "User Setup Ext" extends "User Setup"
{
    fields
    {
        ...
        field(70034; "System Admin"; Boolean)
        {
        }
        field(70035; "Authorize Tickets"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70036; "DCS Accreditation"; Boolean)
        {

            trigger OnValidate()
            begin
                if "DCS Accreditation" then begin
                    UserSetup.SetRange("DCS Accreditation", true);
                    if not UserSetup.IsEmpty then
                        FieldError("DCS Accreditation");
                end;
            end;
        }
        field(70037; "HOD Human Resource"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70038; "HOD Supply Chain"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70039; "HOD Legal"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70040; "Legal Officer"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70041; "Leave Plan Admin."; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70042; "Fuel Reminder"; Boolean)
        {

        }
        field(70043; "Corporate Affairs"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70044; "Secretary to Committee"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70045; "Update Memo Nos"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70046; "Receive Memo Email"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70047; "Blocked from ESS"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70048; "Allow Create Standing Imprest"; Boolean)
        {
            DataClassification = EndUserIdentifiableInformation;
        }
        field(70050; "Registrar Approval"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70051; "Payroll P&P"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70052; "payroll Contract"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(70053; "Payroll AP"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
    }
