        ...
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Technical Maximum Score"; Rec."Technical Maximum Score")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    ToolTip = 'Specifies the value of the Technical Maximum Score field.';
                }
                ...
                field("System Score"; Rec."System Score")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    ToolTip = 'Specifies the value of the System Score field.';
                }
            }
        }
    }
    ...
    actions
    {
        area(creation)
        {
            ...
            action("Proceed to Financial Evaluation")
            {
                ...
                ToolTip = 'Executes the Proceed to Financial Evaluation action.';
