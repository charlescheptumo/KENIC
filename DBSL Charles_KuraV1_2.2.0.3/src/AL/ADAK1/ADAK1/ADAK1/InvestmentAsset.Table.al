        ...
        */
        ...
        if "Asset Type" = "asset type"::" " then begin
            if "No." = '' then begin
                ...
                "No." := NoSeriesMgt.GetNextNo(FASetup."Fixed Asset Nos.", WorkDate(), true);
            end;
        end
        else begin
            ...
            if "Asset Type" = "asset type"::Property then begin
                if "No." = '' then begin
                    ...
                    "No." := NoSeriesMgt.GetNextNo(InvestmentSetup."Property Nos", WorkDate(), true);
                end;
            end;
            ...
            if "Asset Type" = "asset type"::"Money Market" then begin
                if "No." = '' then begin
                    ...
                    "No." := NoSeriesMgt.GetNextNo(InvestmentSetup."Money Market Nos", WorkDate(), true);
                end;
            end;
            ...
            if "Asset Type" = "asset type"::Equity then begin
                ...
                if Offshore = false then begin
                    if "No." = '' then begin
                        ...
                        "No." := NoSeriesMgt.GetNextNo(InvestmentSetup."Equity Nos", WorkDate(), true);
                    end;
                end else begin
                    if "No." = '' then begin
                        InvestmentSetup.Get;
                        InvestmentSetup.TestField(InvestmentSetup."Offshore Investment Nos.");
                        "No." := NoSeriesMgt.GetNextNo(InvestmentSetup."Offshore Investment Nos.", WorkDate(), true);
                    end;
            ...
            if "Asset Type" = "asset type"::Mortgage then begin
                if "No." = '' then begin
                    ...
                    "No." := NoSeriesMgt.GetNextNo(InvestmentSetup."Mortgages/Loans", WorkDate(), true);
                end;
            end;
            ...
            if "Asset Type" = "asset type"::"Unit Trust" then begin
                if "No." = '' then begin
                    ...
                    "No." := NoSeriesMgt.GetNextNo(InvestmentSetup."Unit Trust Nos", WorkDate(), true);
                end;
            end;
