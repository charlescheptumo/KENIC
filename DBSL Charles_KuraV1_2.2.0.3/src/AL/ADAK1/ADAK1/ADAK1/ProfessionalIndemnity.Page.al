...
Page 72738 "Professional Indemnity"
{
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Verified Insurer Email Address field.';
                }
                ...
                field("Amount Insured/Guaranteed"; Rec."Amount Insured/Guaranteed")
                {
                    ...
                    ToolTip = 'Specifies the value of the Amount Insured field.';
                }
                ...
                field("Email Notification"; Rec."Email Notification")
                {
                    ApplicationArea = Basic;
                    Enabled = false;
                    ToolTip = 'Specifies the value of the Email Notification field.';
                }
            }
            group(Control25)
            {
    ...
    begin
        Rec."Document Type" := Rec."document type"::"Professional Indemnity";
        Rec."Policy Cover Type" := Rec."policy cover type"::"Professional Indemnity Cover";
    end;
