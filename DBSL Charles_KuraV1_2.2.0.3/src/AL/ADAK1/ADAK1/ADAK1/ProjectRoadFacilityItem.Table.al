...
Table 72382 "Project Road Facility Item"
{
    ...
    fields
    {
        field(1; "Facility  No."; Code[40])
        {
            ...
            TableRelation = "Road Facility Item"."Facility  No.";

            trigger OnValidate()
            begin
                RoadFacilityItem.Reset;
                RoadFacilityItem.SetRange(RoadFacilityItem."Facility  No.", "Facility  No.");
                if RoadFacilityItem.FindSet then
                    Description := RoadFacilityItem.Description;
            end;
        }
        ...
        field(31; "Reference Doctum"; Code[50])
        {
            DataClassification = ToBeClassified;
        }
        field(32; "Global Budget Book Code"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
    ...
    keys
    {
        key(Key1; "Facility  No.", "Road Code", "Global Budget Book Code", "KeRRA Budget Code")
        {
            Clustered = true;
        }
    ...
    begin
        if "Road Facility Category" = "road facility category"::Structure then begin
            if "Facility  No." = '' then begin
                ...
                "Facility  No." := NoSeriesManagement.GetNextNo(RoadsManagementSetup."Facility Nos(Structure)", WorkDate(), true);
