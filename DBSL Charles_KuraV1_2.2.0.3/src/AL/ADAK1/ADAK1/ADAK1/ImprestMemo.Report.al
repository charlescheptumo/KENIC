...
Report 57001 "Imprest Memo"
{
    ...
    dataset
    {
        dataitem("Imprest Memo"; "Imprest Memo")
        {
            ...
            column(Total_Imprest_Cost; "Imprest Memo"."Total Imprest Cost")
            {
            }
            column(TotalImprest; TotalImprest)
            {
            }
            ...
            dataitem(ProjectTeam; "Project Members")
            {
                ...
                column(TotalperEmployee;ProjectTeam."Total per Employee")
                {
                ...
                begin
                    ...
                    ProjectTeam.CalcFields(ProjectTeam."Total otherCost");
                    ProjectTeam."Total per Employee" := ProjectTeam."Total Entitlement" + ProjectTeam."Total otherCost";
                end;
            }
            ...
            dataitem("Other Costs"; "Other Costs")
            {
                ...
                column(EmployeeNoToSurrender_OtherCosts; "Employee No To Surrender")
                {
                }
                column(EmployeeNameToSurender_OtherCosts; "Employee Name To Surender")
                {
                }
            }
            ...
            begin
                ...
                TotalImprest := 0;
                TotalImprest := "Imprest Memo"."Total Casuals Cost" + "Imprest Memo"."Total Fuel Costs" + "Imprest Memo"."Total Maintenance Costs" +
                 "Imprest Memo"."Total Other Costs" + "Imprest Memo"."Total Subsistence Allowance";
