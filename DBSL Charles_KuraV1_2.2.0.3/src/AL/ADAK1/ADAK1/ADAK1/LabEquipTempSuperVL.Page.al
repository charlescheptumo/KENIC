...
Page 72535 "Lab Equip Temp SuperV L"
{
    Caption = 'Lab Equipment Temporary Supervision Requirements';
    CardPageID = "Lab Equip Temp SuperV C";
    DeleteAllowed = false;
    PageType = List;
    SourceTable = "Temporary Supervision Requirem";
    SourceTableView = where("Document Type" = filter("Lab Equipment"));
    ApplicationArea = All;
