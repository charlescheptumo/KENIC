...
Page 72664 "Project Evaluation Report"
{
    DeleteAllowed = false;
    PageType = Card;
    ...
    begin
        ...
        CVRVisible := false;
        EOTVisible := false;
        case Rec."Variation Type" of
            Rec."variation type"::CC:
                begin
                    CCVisible := true;
                end;
            Rec."variation type"::CVR:
                begin
                    CVRVisible := true;
                end;
            Rec."variation type"::EOT:
                begin
                    EOTVisible := true;
                end;
            Rec."variation type"::EVR:
                begin
                    EVRVisible := true;
                end;
            Rec."variation type"::SUB:
                begin
                    SUBVsisble := true;
                end;
        end;
