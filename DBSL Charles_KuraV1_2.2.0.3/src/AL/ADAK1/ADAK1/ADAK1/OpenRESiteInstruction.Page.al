    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Site Instruction No field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Site Instruction Heading field.';
                }
                field("Works Instructions(Descriptio)"; Rec."Works Instructions(Descriptio)")
                {
                    ApplicationArea = Basic;
                    Caption = 'Works Instructions(Description)';
                    ToolTip = 'Specifies the value of the Works Instructions(Description) field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Acknowledment DateTime field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Date Time Rejected field.';
                }
            }
