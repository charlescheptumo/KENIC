...
Page 72544 "Quality Management Plan"
{
    ApplicationArea = All;
    // PageType = Card;
    ...
    //                 ApplicationArea = Basic;
    //             }
    //             field("Quality Mgt. Template ID";"Quality Mgt. Template ID")
    //             {
    //                 ApplicationArea = Basic;
    //                 Caption = 'Quality Management Plan Template ID';
    //             }
    ...
    //             {
    //                 ApplicationArea = Basic;
    //                 Caption = 'No. of Open Corrective Orders Issued';
    //                 Editable = false;
    //             }
    //             field("No. of Closed Correctiv Orders";"No. of Closed Correctiv Orders")
    //             {
    //                 ApplicationArea = Basic;
    //                 Caption = 'No. of Closed Corrective Orders';
    //                 Editable = false;
    //             }
    ...
    //             }
    //         }
    //         part(Control41;"QM  Plan Checklist Subpage")
    //         {
    //             Caption = 'Quality Management Plan Checklist';
    //             SubPageLink = "Document No"=field("Plan ID");
    //         }
    //         part(Control39;"Quality Management Plan Lines")
    //         {
    ...
    //     area(navigation)
    //     {
    //         action("Quality Management Roles")
    //         {
    //             ApplicationArea = Basic;
    //             Image = Resource;
    //             Promoted = true;
    ...
    //             PromotedIsBig = true;
    //             PromotedOnly = true;
    //             RunObject = Page "QMP Roles";
    //             RunPageLink = "Document No."=field("Plan ID");
    //         }
    //         action("QMP Project Milestones")
    //         {
    //             ApplicationArea = Basic;
    //             Caption = 'Quality Management Project Milestones';
    //             Image = Delivery;
    //             Promoted = true;
    //             PromotedCategory = Process;
    //             PromotedIsBig = true;
    ...
    //             RunPageLink = "Document Type"=filter("Blanket Order"),
    ...
    //             PromotedIsBig = true;
    //             PromotedOnly = true;
    //             RunObject = Page "Corrective Orders";
    //             RunPageLink = "Contractor No"=field("Contractor No");
    //         }
