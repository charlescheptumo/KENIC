...
Table 72157 "Project Mobilization Header"
{
    ...
    fields
    {
        ...
        field(77; "HSE Plan ID"; Code[20])
        {
            ...
            TableRelation = "HSE Plan"."Plan ID" where("Risk Management Plan ID" = field("Risk Management Plan ID"));
        }
    ...
    begin
        if "Document Type" = "document type"::"Order-To-Commence" then begin
            if "Document No." = '' then begin
                ...
                "Document No." := NoSeriesManagement.GetNextNo(RoadManagementSetup."Commencement Order Nos", WorkDate(), true);
