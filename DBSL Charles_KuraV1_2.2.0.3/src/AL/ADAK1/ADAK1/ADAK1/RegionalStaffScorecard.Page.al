        ...
        area(creation)
        {
            action("Suggest Objective Lines")
            {
                ...
                begin
                    ...
                    Rec.TestField("Regional PC ID");
                    Rec.TestField("Annual Reporting Code");
                    PCHeader.Reset;
                    PCHeader.SetRange(No, Rec."Regional PC ID");
                    if PCHeader.FindSet then begin
                        ...
                        if (SPMGeneralSetup."Allow Loading of  CSP" = true) then begin
                            ...
                            PcLinesN.SetRange("Workplan No.", Rec."Regional PC ID");
                            ...
                            if PcLinesN.Find('-') then begin
                                repeat
                                    ...
                                    OriginalSubActivities.SetRange("Workplan No.", Rec."Regional PC ID");
