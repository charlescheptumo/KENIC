    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = RelationshipMgmt;
                    ToolTip = 'Specifies the value of the Receive Reorder Notification field.';
                }
            }
            group(Invoicing)
            {
        ...
        area(navigation)
        {
            group("&Salesperson")
            {
                ...
                action("Assigned RFIs")
                {
                    ...
                    ToolTip = 'Executes the Assigned RFIs action.';
                }
                action("Assigned Invitation For Supply")
                {
                    ...
                    RunPageLink = "Assigned Procurement Officer" = field(Code);
                    ToolTip = 'Executes the Assigned Invitation For Supply action.';
                }
