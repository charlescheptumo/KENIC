...
Table 59003 "Transport Requisition"
{
    ...
    fields
    {
        ...
        {
            TableRelation = "Vehicle Drivers".Driver where(Active = filter(true), "Under Probation" = filter(false));
        ...
        field(72; "No of Days Requested"; Integer)
        {
            ...
            begin
                ...
                TravelRequisitionStaff.SetRange("Req No", "Transport Requisition No");
                if TravelRequisitionStaff.Findset then begin
                    TravelRequisitionStaff."Date of Trip" := "Date of Trip";
                    // TravelRequisitionStaff."Trip End Date" := "Trip End Date";
                    TravelRequisitionStaff."No of Days Requested" := "No of Days Requested";
                end;
                ...
                if VehicleDriverAllocation.Findset then begin
                    VehicleDriverAllocation."Number of days" := "No of Days Requested";
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = if ("Type of Trip" = const(Official)) "Project Members"."Imprest Memo No." where("No." = field("Employee No"),
        ...
        field(70032; "Type of Trip"; Option)
        {
            ...
            OptionMembers = Official,Local1,"Non Official";
        }
