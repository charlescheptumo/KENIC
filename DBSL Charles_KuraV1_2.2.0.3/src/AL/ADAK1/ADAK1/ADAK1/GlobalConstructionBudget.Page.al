...
Page 72316 "Global Construction Budget"
{
    Caption = 'Global Maintenance Budget Book';
    CardPageID = "Global Constructio Budget Card";
    DeleteAllowed = false;
    Editable = false;
    PageType = List;
    SourceTable = "Road Work Program";
    SourceTableView = where("Document Type" = filter("Multi-Year Programs"),
                            "Road Project Category" = const("Road Construction"));
    ApplicationArea = All;
