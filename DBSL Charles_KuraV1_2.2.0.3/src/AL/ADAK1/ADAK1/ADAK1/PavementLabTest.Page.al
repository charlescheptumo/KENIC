    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Authority ID field.';
                }
                field("Authority Name"; Rec."Authority Name")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Authority Name field.';
                }
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Project Engineer ID field.';
                }
