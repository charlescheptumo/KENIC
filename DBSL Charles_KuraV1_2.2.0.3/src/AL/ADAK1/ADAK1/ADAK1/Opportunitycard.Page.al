    ...
    layout
    {
        area(content)
        {
            ...
            group(Dates)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Next To-do Date field.';
                }
                field("Last Date Attempted"; Rec."Last Date Attempted")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Last Date Attempted field.';
                }
                field("Date of Last Interaction"; Rec."Date of Last Interaction")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Date of Last Interaction field.';
                }
            }
            group("Opportunity details")
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Lost Reasons field.';
                }
    ...
    actions
    {
        area(creation)
        {
            ...
            action("Create Opportunity")
            {
                ...
                ToolTip = 'Executes the Create Opportunity action.';
