#pragma warning disable AA0005, AA0008, AA0018, AA0021, AA0072, AA0137, AA0201, AA0206, AA0218, AA0228, AL0254, AL0603,AL0424, AW0006 // ForNAV settings
#pragma implicitwith disable
Page 72779 "Interest  Payment Request"
{
    DeleteAllowed = false;
    PageType = Card;
        ...
        area(navigation)
        {
                ...
                begin
                    ...
                    if ContractorRequestPlanLine.FindSet then begin
                        repeat
                            ...
                            // PurchaseLine."Job No." := "Project ID";
            ...
            action("Import Template")
            {
                ...
                begin
                    ...
                    // DMSManagement.UploadCPRExportedForImport(DMSDocuments."document type"::"Maintenance Requisition","Document No.",'Contractor Payment Request',RecordId,"Region ID");
    ...
    begin
        ...
        Rec."Payment Certificate Type" := Rec."payment certificate type"::Interest;
    end;
