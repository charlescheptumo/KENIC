    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Senior Officer PC ID field.';
                }
                field("Regional PC ID"; Rec."Regional PC ID")
                {
                    ApplicationArea = Basic;
                    Visible = false;
                    ToolTip = 'Specifies the value of the Regional PC ID field.';
                }
    ...
    actions
    {
        ...
        area(creation)
        {
            action("Suggest Objective Lines")
            {
                ...
                PromotedCategory = Process;
                PromotedIsBig = true;
                ToolTip = 'Executes the Cascade PC Activities action.';
            ...
            action("Suggest Job Description")
            {
                ...
                PromotedCategory = Process;
                PromotedIsBig = true;
                ToolTip = 'Executes the Suggest Job Description action.';
                ...
                begin
                    ...
                    if (SPMGeneralSetup."Allow Loading of JD" = true) then begin
                        ...
                        JobRes.Reset;
                        if Rec."Acting Job ID" <> '' then begin
                            JobRes.SetRange("Position ID", Rec."Acting Job ID");
                        end else begin
                            JobRes.SetRange("Position ID", Rec.Position);
            ...
            action("Board PC")
            {
                ...
                PromotedCategory = Category6;
                visible = false;
                ToolTip = 'Executes the Board PC action.';
