...
Table 69070 "Temporary Employee"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = lookup(Positions."Job Title" where("Position ID" = field("No.")));
            Caption = 'Job Title';
            Editable = true;
        ...
        {
            TableRelation = "Salary Scales".Scale where(Temporary = const(true));
    ...
    begin
        ...
        if "No." = '' then begin
            ...
            "No." := NoSeriesMgt.GetNextNo(HumanResSetup."Temporary Employee Nos", WorkDate(), true);
        end;
