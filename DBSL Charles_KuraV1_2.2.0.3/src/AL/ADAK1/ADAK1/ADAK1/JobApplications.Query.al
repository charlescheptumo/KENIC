...
Query 60013 "JobApplications"
{

    elements
    {
        dataitem(Job_Applications; "Job Applications")
        {
            ...
            column(Professional_Summary; "Professional Summary")
            {
            }
            ...
            column(Terms_of_Service_Code; "Terms of Service Code")
            {
            }
