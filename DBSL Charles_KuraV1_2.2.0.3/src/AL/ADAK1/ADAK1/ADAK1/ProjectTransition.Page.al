    ...
    actions
    {
        area(navigation)
        {
            action("Submit Perf Guarantee")
            {
                ...
                PromotedIsBig = true;
                ToolTip = 'Executes the Submit Performance Guarantee action.';
            ...
            action("Upload PBRM BoQ")
            {
                ...
                PromotedCategory = Process;
                PromotedIsBig = true;
                ToolTip = 'Executes the Upload PBRM BoQ action.';
            ...
            action("Upload Signed Copy")
            {
                ...
                PromotedCategory = Process;
                PromotedIsBig = true;
                ToolTip = 'Executes the Upload Signed Copy Of PBRM Contract action.';
