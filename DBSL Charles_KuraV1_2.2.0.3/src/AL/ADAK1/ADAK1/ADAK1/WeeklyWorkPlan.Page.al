        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Day/Week/Month From"; Rec."Day/Week/Month From")
                {
                    ApplicationArea = Basic;
                    Caption = 'Week From';
                    ToolTip = 'Specifies the value of the Week From field.';
                }
                field("Day/Week/Month To"; Rec."Day/Week/Month To")
                {
                    ApplicationArea = Basic;
                    Caption = 'Week To';
                    ToolTip = 'Specifies the value of the Week To field.';
                }
            ...
            part(Control25; "Weekly Work Plan Line Subpage")
            {
        ...
        area(navigation)
        {
            action(Submit)
            {
                ...
                begin
                    ...
                    Rec.Modify(true);
                    Dialog.Message('Your %1 has been submitted successfully', Format(Rec."Document Type"));
                end;
            }
            action(Approvals)
            {
            ...
            action("Recall Document")
            {
                ...
                PromotedIsBig = true;
                PromotedOnly = true;
                ToolTip = 'Executes the Recall Document action.';

                trigger OnAction()
                begin
                    Rec."Portal Status" := Rec."portal status"::Draft;
                    Rec.Modify(true);
                    Dialog.Message('Your %1 has been recalled successfully', Format(Rec."Document Type"));
                end;
            }
        }
    }
