table 50086 "Sharepoint Connector Setup"
{
    ...
    fields
    {
        ...
        field(65; Quote; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(66; Order; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(67; Invoice; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(68; "Credit Memo"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(69; "Blanket Order"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(70; "Return Order"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(71; Payment; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(72; "Imprest Memo"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(73; Surrender; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(74; Payroll; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(75; "Store Requisition"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(76; "AIE Funds Transfer"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(77; "Training Plan"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(78; "Training Application"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(79; "Bank Rec"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(80; "Asset Transfer"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(81; "Cash Request"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(82; "Bill Discounting"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }

        field(83; Maintenance; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(84; FuelReq; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(85; SAV; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(86; "Recruitment Header"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }

        field(87; "Driver Out Of Office Req"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(88; "Batch Payment"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(89; "Staff Appointment"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(90; Mobilization; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(91; Meeting; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(92; Payments; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(93; "Finance & Accounts Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(94; "Human Capital & Administration Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(95; "ICT Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(96; "Administration Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(97; "Legal Services Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(98; "Standards and Compliance Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(99; "Supply Chain Management Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(100; "Transport Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(101; "Finance & Accounts Documents"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(102; "Human Capital & Administration Documents"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(103; "ICT Documents"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(104; "Administration Documents"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(105; "Legal Documents"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(106; "Standards and Compliance Documents"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(107; "Supply Chain Management Documents"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(108; "Transport Documents"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(109; "Education & Research Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(110; "Standard & Compliance Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(111; "Research & Development Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(112; "Testing Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(113; "Compliance Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(114; "Internal Audit Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(115; "Anti-Doping Education Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(116; "Main Memo Directory"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(117; "Corporate Communication Memos"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
